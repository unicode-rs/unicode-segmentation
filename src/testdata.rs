...
pub const TEST_SAME: &'static [(&'static str, &'static [&'static str])] = &[
    ...
    ("\u{20}\u{261d}", &["\u{20}", "\u{261d}"]),
    ("\u{20}\u{308}\u{261d}", &["\u{20}\u{308}", "\u{261d}"]),
    ("\u{20}\u{1f3fb}", &["\u{20}", "\u{1f3fb}"]),
    ("\u{20}\u{308}\u{1f3fb}", &["\u{20}\u{308}", "\u{1f3fb}"]),
    ("\u{20}\u{200d}", &["\u{20}\u{200d}"]),
    ("\u{20}\u{308}\u{200d}", &["\u{20}\u{308}\u{200d}"]),
    ("\u{20}\u{2764}", &["\u{20}", "\u{2764}"]),
    ("\u{20}\u{308}\u{2764}", &["\u{20}\u{308}", "\u{2764}"]),
    ("\u{20}\u{1f466}", &["\u{20}", "\u{1f466}"]),
    ("\u{20}\u{308}\u{1f466}", &["\u{20}\u{308}", "\u{1f466}"]),
    ...
    ("\u{d}\u{261d}", &["\u{d}", "\u{261d}"]),
    ("\u{d}\u{308}\u{261d}", &["\u{d}", "\u{308}", "\u{261d}"]),
    ("\u{d}\u{1f3fb}", &["\u{d}", "\u{1f3fb}"]),
    ("\u{d}\u{308}\u{1f3fb}", &["\u{d}", "\u{308}", "\u{1f3fb}"]),
    ("\u{d}\u{200d}", &["\u{d}", "\u{200d}"]),
    ("\u{d}\u{308}\u{200d}", &["\u{d}", "\u{308}\u{200d}"]),
    ("\u{d}\u{2764}", &["\u{d}", "\u{2764}"]),
    ("\u{d}\u{308}\u{2764}", &["\u{d}", "\u{308}", "\u{2764}"]),
    ("\u{d}\u{1f466}", &["\u{d}", "\u{1f466}"]),
    ("\u{d}\u{308}\u{1f466}", &["\u{d}", "\u{308}", "\u{1f466}"]),
    ("\u{d}\u{378}", &["\u{d}", "\u{378}"]),
    ...
    ("\u{a}\u{261d}", &["\u{a}", "\u{261d}"]),
    ("\u{a}\u{308}\u{261d}", &["\u{a}", "\u{308}", "\u{261d}"]),
    ("\u{a}\u{1f3fb}", &["\u{a}", "\u{1f3fb}"]),
    ("\u{a}\u{308}\u{1f3fb}", &["\u{a}", "\u{308}", "\u{1f3fb}"]),
    ("\u{a}\u{200d}", &["\u{a}", "\u{200d}"]),
    ("\u{a}\u{308}\u{200d}", &["\u{a}", "\u{308}\u{200d}"]),
    ("\u{a}\u{2764}", &["\u{a}", "\u{2764}"]),
    ("\u{a}\u{308}\u{2764}", &["\u{a}", "\u{308}", "\u{2764}"]),
    ("\u{a}\u{1f466}", &["\u{a}", "\u{1f466}"]),
    ("\u{a}\u{308}\u{1f466}", &["\u{a}", "\u{308}", "\u{1f466}"]),
    ("\u{a}\u{378}", &["\u{a}", "\u{378}"]),
    ...
    ("\u{1}\u{261d}", &["\u{1}", "\u{261d}"]),
    ("\u{1}\u{308}\u{261d}", &["\u{1}", "\u{308}", "\u{261d}"]),
    ("\u{1}\u{1f3fb}", &["\u{1}", "\u{1f3fb}"]),
    ("\u{1}\u{308}\u{1f3fb}", &["\u{1}", "\u{308}", "\u{1f3fb}"]),
    ("\u{1}\u{200d}", &["\u{1}", "\u{200d}"]),
    ("\u{1}\u{308}\u{200d}", &["\u{1}", "\u{308}\u{200d}"]),
    ("\u{1}\u{2764}", &["\u{1}", "\u{2764}"]),
    ("\u{1}\u{308}\u{2764}", &["\u{1}", "\u{308}", "\u{2764}"]),
    ("\u{1}\u{1f466}", &["\u{1}", "\u{1f466}"]),
    ("\u{1}\u{308}\u{1f466}", &["\u{1}", "\u{308}", "\u{1f466}"]),
    ("\u{1}\u{378}", &["\u{1}", "\u{378}"]),
    ...
    ("\u{300}\u{261d}", &["\u{300}", "\u{261d}"]),
    ("\u{300}\u{308}\u{261d}", &["\u{300}\u{308}", "\u{261d}"]),
    ("\u{300}\u{1f3fb}", &["\u{300}", "\u{1f3fb}"]),
    ("\u{300}\u{308}\u{1f3fb}", &["\u{300}\u{308}", "\u{1f3fb}"]),
    ("\u{300}\u{200d}", &["\u{300}\u{200d}"]),
    ("\u{300}\u{308}\u{200d}", &["\u{300}\u{308}\u{200d}"]),
    ("\u{300}\u{2764}", &["\u{300}", "\u{2764}"]),
    ("\u{300}\u{308}\u{2764}", &["\u{300}\u{308}", "\u{2764}"]),
    ("\u{300}\u{1f466}", &["\u{300}", "\u{1f466}"]),
    ("\u{300}\u{308}\u{1f466}", &["\u{300}\u{308}", "\u{1f466}"]),
    ...
    ("\u{600}\u{308}\u{261d}", &["\u{600}\u{308}", "\u{261d}"]),
    ("\u{600}\u{308}\u{1f3fb}", &["\u{600}\u{308}", "\u{1f3fb}"]),
    ("\u{600}\u{200d}", &["\u{600}\u{200d}"]),
    ("\u{600}\u{308}\u{200d}", &["\u{600}\u{308}\u{200d}"]),
    ("\u{600}\u{308}\u{2764}", &["\u{600}\u{308}", "\u{2764}"]),
    ("\u{600}\u{308}\u{1f466}", &["\u{600}\u{308}", "\u{1f466}"]),
    ...
    ("\u{903}\u{261d}", &["\u{903}", "\u{261d}"]),
    ("\u{903}\u{308}\u{261d}", &["\u{903}\u{308}", "\u{261d}"]),
    ("\u{903}\u{1f3fb}", &["\u{903}", "\u{1f3fb}"]),
    ("\u{903}\u{308}\u{1f3fb}", &["\u{903}\u{308}", "\u{1f3fb}"]),
    ("\u{903}\u{200d}", &["\u{903}\u{200d}"]),
    ("\u{903}\u{308}\u{200d}", &["\u{903}\u{308}\u{200d}"]),
    ("\u{903}\u{2764}", &["\u{903}", "\u{2764}"]),
    ("\u{903}\u{308}\u{2764}", &["\u{903}\u{308}", "\u{2764}"]),
    ("\u{903}\u{1f466}", &["\u{903}", "\u{1f466}"]),
    ("\u{903}\u{308}\u{1f466}", &["\u{903}\u{308}", "\u{1f466}"]),
    ...
    ("\u{1100}\u{308}\u{261d}", &["\u{1100}\u{308}", "\u{261d}"]),
    ("\u{1100}\u{1f3fb}", &["\u{1100}", "\u{1f3fb}"]),
    (
        "\u{1100}\u{308}\u{1f3fb}",
        &["\u{1100}\u{308}", "\u{1f3fb}"],
    ),
    ("\u{1100}\u{200d}", &["\u{1100}\u{200d}"]),
    ("\u{1100}\u{308}\u{200d}", &["\u{1100}\u{308}\u{200d}"]),
    ("\u{1100}\u{2764}", &["\u{1100}", "\u{2764}"]),
    ("\u{1100}\u{308}\u{2764}", &["\u{1100}\u{308}", "\u{2764}"]),
    ("\u{1100}\u{1f466}", &["\u{1100}", "\u{1f466}"]),
    (
        "\u{1100}\u{308}\u{1f466}",
        &["\u{1100}\u{308}", "\u{1f466}"],
    ),
    ...
    ("\u{1160}\u{308}\u{261d}", &["\u{1160}\u{308}", "\u{261d}"]),
    ("\u{1160}\u{1f3fb}", &["\u{1160}", "\u{1f3fb}"]),
    (
        "\u{1160}\u{308}\u{1f3fb}",
        &["\u{1160}\u{308}", "\u{1f3fb}"],
    ),
    ("\u{1160}\u{200d}", &["\u{1160}\u{200d}"]),
    ("\u{1160}\u{308}\u{200d}", &["\u{1160}\u{308}\u{200d}"]),
    ("\u{1160}\u{2764}", &["\u{1160}", "\u{2764}"]),
    ("\u{1160}\u{308}\u{2764}", &["\u{1160}\u{308}", "\u{2764}"]),
    ("\u{1160}\u{1f466}", &["\u{1160}", "\u{1f466}"]),
    (
        "\u{1160}\u{308}\u{1f466}",
        &["\u{1160}\u{308}", "\u{1f466}"],
    ),
    ...
    ("\u{11a8}\u{308}\u{261d}", &["\u{11a8}\u{308}", "\u{261d}"]),
    ("\u{11a8}\u{1f3fb}", &["\u{11a8}", "\u{1f3fb}"]),
    (
        "\u{11a8}\u{308}\u{1f3fb}",
        &["\u{11a8}\u{308}", "\u{1f3fb}"],
    ),
    ("\u{11a8}\u{200d}", &["\u{11a8}\u{200d}"]),
    ("\u{11a8}\u{308}\u{200d}", &["\u{11a8}\u{308}\u{200d}"]),
    ("\u{11a8}\u{2764}", &["\u{11a8}", "\u{2764}"]),
    ("\u{11a8}\u{308}\u{2764}", &["\u{11a8}\u{308}", "\u{2764}"]),
    ("\u{11a8}\u{1f466}", &["\u{11a8}", "\u{1f466}"]),
    (
        "\u{11a8}\u{308}\u{1f466}",
        &["\u{11a8}\u{308}", "\u{1f466}"],
    ),
    ...
    ("\u{ac00}\u{308}\u{261d}", &["\u{ac00}\u{308}", "\u{261d}"]),
    ("\u{ac00}\u{1f3fb}", &["\u{ac00}", "\u{1f3fb}"]),
    (
        "\u{ac00}\u{308}\u{1f3fb}",
        &["\u{ac00}\u{308}", "\u{1f3fb}"],
    ),
    ("\u{ac00}\u{200d}", &["\u{ac00}\u{200d}"]),
    ("\u{ac00}\u{308}\u{200d}", &["\u{ac00}\u{308}\u{200d}"]),
    ("\u{ac00}\u{2764}", &["\u{ac00}", "\u{2764}"]),
    ("\u{ac00}\u{308}\u{2764}", &["\u{ac00}\u{308}", "\u{2764}"]),
    ("\u{ac00}\u{1f466}", &["\u{ac00}", "\u{1f466}"]),
    (
        "\u{ac00}\u{308}\u{1f466}",
        &["\u{ac00}\u{308}", "\u{1f466}"],
    ),
    ...
    ("\u{ac01}\u{308}\u{261d}", &["\u{ac01}\u{308}", "\u{261d}"]),
    ("\u{ac01}\u{1f3fb}", &["\u{ac01}", "\u{1f3fb}"]),
    (
        "\u{ac01}\u{308}\u{1f3fb}",
        &["\u{ac01}\u{308}", "\u{1f3fb}"],
    ),
    ("\u{ac01}\u{200d}", &["\u{ac01}\u{200d}"]),
    ("\u{ac01}\u{308}\u{200d}", &["\u{ac01}\u{308}\u{200d}"]),
    ("\u{ac01}\u{2764}", &["\u{ac01}", "\u{2764}"]),
    ("\u{ac01}\u{308}\u{2764}", &["\u{ac01}\u{308}", "\u{2764}"]),
    ("\u{ac01}\u{1f466}", &["\u{ac01}", "\u{1f466}"]),
    (
        "\u{ac01}\u{308}\u{1f466}",
        &["\u{ac01}\u{308}", "\u{1f466}"],
    ),
    ...
    (
        "\u{1f1e6}\u{308}\u{261d}",
        &["\u{1f1e6}\u{308}", "\u{261d}"],
    ),
    ("\u{1f1e6}\u{1f3fb}", &["\u{1f1e6}", "\u{1f3fb}"]),
    (
        "\u{1f1e6}\u{308}\u{1f3fb}",
        &["\u{1f1e6}\u{308}", "\u{1f3fb}"],
    ),
    ("\u{1f1e6}\u{200d}", &["\u{1f1e6}\u{200d}"]),
    ("\u{1f1e6}\u{308}\u{200d}", &["\u{1f1e6}\u{308}\u{200d}"]),
    ("\u{1f1e6}\u{2764}", &["\u{1f1e6}", "\u{2764}"]),
    (
        "\u{1f1e6}\u{308}\u{2764}",
        &["\u{1f1e6}\u{308}", "\u{2764}"],
    ),
    ("\u{1f1e6}\u{1f466}", &["\u{1f1e6}", "\u{1f466}"]),
    (
        "\u{1f1e6}\u{308}\u{1f466}",
        &["\u{1f1e6}\u{308}", "\u{1f466}"],
    ),
    ("\u{1f1e6}\u{378}", &["\u{1f1e6}", "\u{378}"]),
    ("\u{1f1e6}\u{308}\u{378}", &["\u{1f1e6}\u{308}", "\u{378}"]),
    ("\u{261d}\u{20}", &["\u{261d}", "\u{20}"]),
    ("\u{261d}\u{308}\u{20}", &["\u{261d}\u{308}", "\u{20}"]),
    ("\u{261d}\u{d}", &["\u{261d}", "\u{d}"]),
    ("\u{261d}\u{308}\u{d}", &["\u{261d}\u{308}", "\u{d}"]),
    ("\u{261d}\u{a}", &["\u{261d}", "\u{a}"]),
    ("\u{261d}\u{308}\u{a}", &["\u{261d}\u{308}", "\u{a}"]),
    ("\u{261d}\u{1}", &["\u{261d}", "\u{1}"]),
    ("\u{261d}\u{308}\u{1}", &["\u{261d}\u{308}", "\u{1}"]),
    ("\u{261d}\u{300}", &["\u{261d}\u{300}"]),
    ("\u{261d}\u{308}\u{300}", &["\u{261d}\u{308}\u{300}"]),
    ("\u{261d}\u{600}", &["\u{261d}", "\u{600}"]),
    ("\u{261d}\u{308}\u{600}", &["\u{261d}\u{308}", "\u{600}"]),
    ("\u{261d}\u{1100}", &["\u{261d}", "\u{1100}"]),
    ("\u{261d}\u{308}\u{1100}", &["\u{261d}\u{308}", "\u{1100}"]),
    ("\u{261d}\u{1160}", &["\u{261d}", "\u{1160}"]),
    ("\u{261d}\u{308}\u{1160}", &["\u{261d}\u{308}", "\u{1160}"]),
    ("\u{261d}\u{11a8}", &["\u{261d}", "\u{11a8}"]),
    ("\u{261d}\u{308}\u{11a8}", &["\u{261d}\u{308}", "\u{11a8}"]),
    ("\u{261d}\u{ac00}", &["\u{261d}", "\u{ac00}"]),
    ("\u{261d}\u{308}\u{ac00}", &["\u{261d}\u{308}", "\u{ac00}"]),
    ("\u{261d}\u{ac01}", &["\u{261d}", "\u{ac01}"]),
    ("\u{261d}\u{308}\u{ac01}", &["\u{261d}\u{308}", "\u{ac01}"]),
    ("\u{261d}\u{1f1e6}", &["\u{261d}", "\u{1f1e6}"]),
    (
        "\u{261d}\u{308}\u{1f1e6}",
        &["\u{261d}\u{308}", "\u{1f1e6}"],
    ),
    ("\u{261d}\u{261d}", &["\u{261d}", "\u{261d}"]),
    ("\u{261d}\u{308}\u{261d}", &["\u{261d}\u{308}", "\u{261d}"]),
    ("\u{261d}\u{1f3fb}", &["\u{261d}\u{1f3fb}"]),
    ("\u{261d}\u{308}\u{1f3fb}", &["\u{261d}\u{308}\u{1f3fb}"]),
    ("\u{261d}\u{200d}", &["\u{261d}\u{200d}"]),
    ("\u{261d}\u{308}\u{200d}", &["\u{261d}\u{308}\u{200d}"]),
    ("\u{261d}\u{2764}", &["\u{261d}", "\u{2764}"]),
    ("\u{261d}\u{308}\u{2764}", &["\u{261d}\u{308}", "\u{2764}"]),
    ("\u{261d}\u{1f466}", &["\u{261d}", "\u{1f466}"]),
    (
        "\u{261d}\u{308}\u{1f466}",
        &["\u{261d}\u{308}", "\u{1f466}"],
    ),
    ("\u{261d}\u{378}", &["\u{261d}", "\u{378}"]),
    ("\u{261d}\u{308}\u{378}", &["\u{261d}\u{308}", "\u{378}"]),
    ("\u{1f3fb}\u{20}", &["\u{1f3fb}", "\u{20}"]),
    ("\u{1f3fb}\u{308}\u{20}", &["\u{1f3fb}\u{308}", "\u{20}"]),
    ("\u{1f3fb}\u{d}", &["\u{1f3fb}", "\u{d}"]),
    ("\u{1f3fb}\u{308}\u{d}", &["\u{1f3fb}\u{308}", "\u{d}"]),
    ("\u{1f3fb}\u{a}", &["\u{1f3fb}", "\u{a}"]),
    ("\u{1f3fb}\u{308}\u{a}", &["\u{1f3fb}\u{308}", "\u{a}"]),
    ("\u{1f3fb}\u{1}", &["\u{1f3fb}", "\u{1}"]),
    ("\u{1f3fb}\u{308}\u{1}", &["\u{1f3fb}\u{308}", "\u{1}"]),
    ("\u{1f3fb}\u{300}", &["\u{1f3fb}\u{300}"]),
    ("\u{1f3fb}\u{308}\u{300}", &["\u{1f3fb}\u{308}\u{300}"]),
    ("\u{1f3fb}\u{600}", &["\u{1f3fb}", "\u{600}"]),
    ("\u{1f3fb}\u{308}\u{600}", &["\u{1f3fb}\u{308}", "\u{600}"]),
    ("\u{1f3fb}\u{1100}", &["\u{1f3fb}", "\u{1100}"]),
    (
        "\u{1f3fb}\u{308}\u{1100}",
        &["\u{1f3fb}\u{308}", "\u{1100}"],
    ),
    ("\u{1f3fb}\u{1160}", &["\u{1f3fb}", "\u{1160}"]),
    (
        "\u{1f3fb}\u{308}\u{1160}",
        &["\u{1f3fb}\u{308}", "\u{1160}"],
    ),
    ("\u{1f3fb}\u{11a8}", &["\u{1f3fb}", "\u{11a8}"]),
    (
        "\u{1f3fb}\u{308}\u{11a8}",
        &["\u{1f3fb}\u{308}", "\u{11a8}"],
    ),
    ("\u{1f3fb}\u{ac00}", &["\u{1f3fb}", "\u{ac00}"]),
    (
        "\u{1f3fb}\u{308}\u{ac00}",
        &["\u{1f3fb}\u{308}", "\u{ac00}"],
    ),
    ("\u{1f3fb}\u{ac01}", &["\u{1f3fb}", "\u{ac01}"]),
    (
        "\u{1f3fb}\u{308}\u{ac01}",
        &["\u{1f3fb}\u{308}", "\u{ac01}"],
    ),
    ("\u{1f3fb}\u{1f1e6}", &["\u{1f3fb}", "\u{1f1e6}"]),
    (
        "\u{1f3fb}\u{308}\u{1f1e6}",
        &["\u{1f3fb}\u{308}", "\u{1f1e6}"],
    ),
    ("\u{1f3fb}\u{261d}", &["\u{1f3fb}", "\u{261d}"]),
    (
        "\u{1f3fb}\u{308}\u{261d}",
        &["\u{1f3fb}\u{308}", "\u{261d}"],
    ),
    ("\u{1f3fb}\u{1f3fb}", &["\u{1f3fb}", "\u{1f3fb}"]),
    (
        "\u{1f3fb}\u{308}\u{1f3fb}",
        &["\u{1f3fb}\u{308}", "\u{1f3fb}"],
    ),
    ("\u{1f3fb}\u{200d}", &["\u{1f3fb}\u{200d}"]),
    ("\u{1f3fb}\u{308}\u{200d}", &["\u{1f3fb}\u{308}\u{200d}"]),
    ("\u{1f3fb}\u{2764}", &["\u{1f3fb}", "\u{2764}"]),
    (
        "\u{1f3fb}\u{308}\u{2764}",
        &["\u{1f3fb}\u{308}", "\u{2764}"],
    ),
    ("\u{1f3fb}\u{1f466}", &["\u{1f3fb}", "\u{1f466}"]),
    (
        "\u{1f3fb}\u{308}\u{1f466}",
        &["\u{1f3fb}\u{308}", "\u{1f466}"],
    ),
    ("\u{1f3fb}\u{378}", &["\u{1f3fb}", "\u{378}"]),
    ("\u{1f3fb}\u{308}\u{378}", &["\u{1f3fb}\u{308}", "\u{378}"]),
    ...
    ("\u{200d}\u{261d}", &["\u{200d}", "\u{261d}"]),
    ("\u{200d}\u{308}\u{261d}", &["\u{200d}\u{308}", "\u{261d}"]),
    ("\u{200d}\u{1f3fb}", &["\u{200d}", "\u{1f3fb}"]),
    (
        "\u{200d}\u{308}\u{1f3fb}",
        &["\u{200d}\u{308}", "\u{1f3fb}"],
    ),
    ("\u{200d}\u{200d}", &["\u{200d}\u{200d}"]),
    ("\u{200d}\u{308}\u{200d}", &["\u{200d}\u{308}\u{200d}"]),
    ("\u{200d}\u{2764}", &["\u{200d}\u{2764}"]),
    ("\u{200d}\u{308}\u{2764}", &["\u{200d}\u{308}", "\u{2764}"]),
    ("\u{200d}\u{1f466}", &["\u{200d}\u{1f466}"]),
    (
        "\u{200d}\u{308}\u{1f466}",
        &["\u{200d}\u{308}", "\u{1f466}"],
    ),
    ("\u{200d}\u{378}", &["\u{200d}", "\u{378}"]),
    ("\u{200d}\u{308}\u{378}", &["\u{200d}\u{308}", "\u{378}"]),
    ("\u{2764}\u{20}", &["\u{2764}", "\u{20}"]),
    ("\u{2764}\u{308}\u{20}", &["\u{2764}\u{308}", "\u{20}"]),
    ("\u{2764}\u{d}", &["\u{2764}", "\u{d}"]),
    ("\u{2764}\u{308}\u{d}", &["\u{2764}\u{308}", "\u{d}"]),
    ("\u{2764}\u{a}", &["\u{2764}", "\u{a}"]),
    ("\u{2764}\u{308}\u{a}", &["\u{2764}\u{308}", "\u{a}"]),
    ("\u{2764}\u{1}", &["\u{2764}", "\u{1}"]),
    ("\u{2764}\u{308}\u{1}", &["\u{2764}\u{308}", "\u{1}"]),
    ("\u{2764}\u{300}", &["\u{2764}\u{300}"]),
    ("\u{2764}\u{308}\u{300}", &["\u{2764}\u{308}\u{300}"]),
    ("\u{2764}\u{600}", &["\u{2764}", "\u{600}"]),
    ("\u{2764}\u{308}\u{600}", &["\u{2764}\u{308}", "\u{600}"]),
    ("\u{2764}\u{1100}", &["\u{2764}", "\u{1100}"]),
    ("\u{2764}\u{308}\u{1100}", &["\u{2764}\u{308}", "\u{1100}"]),
    ("\u{2764}\u{1160}", &["\u{2764}", "\u{1160}"]),
    ("\u{2764}\u{308}\u{1160}", &["\u{2764}\u{308}", "\u{1160}"]),
    ("\u{2764}\u{11a8}", &["\u{2764}", "\u{11a8}"]),
    ("\u{2764}\u{308}\u{11a8}", &["\u{2764}\u{308}", "\u{11a8}"]),
    ("\u{2764}\u{ac00}", &["\u{2764}", "\u{ac00}"]),
    ("\u{2764}\u{308}\u{ac00}", &["\u{2764}\u{308}", "\u{ac00}"]),
    ("\u{2764}\u{ac01}", &["\u{2764}", "\u{ac01}"]),
    ("\u{2764}\u{308}\u{ac01}", &["\u{2764}\u{308}", "\u{ac01}"]),
    ("\u{2764}\u{1f1e6}", &["\u{2764}", "\u{1f1e6}"]),
    (
        "\u{2764}\u{308}\u{1f1e6}",
        &["\u{2764}\u{308}", "\u{1f1e6}"],
    ),
    ("\u{2764}\u{261d}", &["\u{2764}", "\u{261d}"]),
    ("\u{2764}\u{308}\u{261d}", &["\u{2764}\u{308}", "\u{261d}"]),
    ("\u{2764}\u{1f3fb}", &["\u{2764}", "\u{1f3fb}"]),
    (
        "\u{2764}\u{308}\u{1f3fb}",
        &["\u{2764}\u{308}", "\u{1f3fb}"],
    ),
    ("\u{2764}\u{200d}", &["\u{2764}\u{200d}"]),
    ("\u{2764}\u{308}\u{200d}", &["\u{2764}\u{308}\u{200d}"]),
    ("\u{2764}\u{2764}", &["\u{2764}", "\u{2764}"]),
    ("\u{2764}\u{308}\u{2764}", &["\u{2764}\u{308}", "\u{2764}"]),
    ("\u{2764}\u{1f466}", &["\u{2764}", "\u{1f466}"]),
    (
        "\u{2764}\u{308}\u{1f466}",
        &["\u{2764}\u{308}", "\u{1f466}"],
    ),
    ("\u{2764}\u{378}", &["\u{2764}", "\u{378}"]),
    ("\u{2764}\u{308}\u{378}", &["\u{2764}\u{308}", "\u{378}"]),
    ("\u{1f466}\u{20}", &["\u{1f466}", "\u{20}"]),
    ("\u{1f466}\u{308}\u{20}", &["\u{1f466}\u{308}", "\u{20}"]),
    ("\u{1f466}\u{d}", &["\u{1f466}", "\u{d}"]),
    ("\u{1f466}\u{308}\u{d}", &["\u{1f466}\u{308}", "\u{d}"]),
    ("\u{1f466}\u{a}", &["\u{1f466}", "\u{a}"]),
    ("\u{1f466}\u{308}\u{a}", &["\u{1f466}\u{308}", "\u{a}"]),
    ("\u{1f466}\u{1}", &["\u{1f466}", "\u{1}"]),
    ("\u{1f466}\u{308}\u{1}", &["\u{1f466}\u{308}", "\u{1}"]),
    ("\u{1f466}\u{300}", &["\u{1f466}\u{300}"]),
    ("\u{1f466}\u{308}\u{300}", &["\u{1f466}\u{308}\u{300}"]),
    ("\u{1f466}\u{600}", &["\u{1f466}", "\u{600}"]),
    ("\u{1f466}\u{308}\u{600}", &["\u{1f466}\u{308}", "\u{600}"]),
    ("\u{1f466}\u{1100}", &["\u{1f466}", "\u{1100}"]),
    (
        "\u{1f466}\u{308}\u{1100}",
        &["\u{1f466}\u{308}", "\u{1100}"],
    ),
    ("\u{1f466}\u{1160}", &["\u{1f466}", "\u{1160}"]),
    (
        "\u{1f466}\u{308}\u{1160}",
        &["\u{1f466}\u{308}", "\u{1160}"],
    ),
    ("\u{1f466}\u{11a8}", &["\u{1f466}", "\u{11a8}"]),
    (
        "\u{1f466}\u{308}\u{11a8}",
        &["\u{1f466}\u{308}", "\u{11a8}"],
    ),
    ("\u{1f466}\u{ac00}", &["\u{1f466}", "\u{ac00}"]),
    (
        "\u{1f466}\u{308}\u{ac00}",
        &["\u{1f466}\u{308}", "\u{ac00}"],
    ),
    ("\u{1f466}\u{ac01}", &["\u{1f466}", "\u{ac01}"]),
    (
        "\u{1f466}\u{308}\u{ac01}",
        &["\u{1f466}\u{308}", "\u{ac01}"],
    ),
    ("\u{1f466}\u{1f1e6}", &["\u{1f466}", "\u{1f1e6}"]),
    (
        "\u{1f466}\u{308}\u{1f1e6}",
        &["\u{1f466}\u{308}", "\u{1f1e6}"],
    ),
    ("\u{1f466}\u{261d}", &["\u{1f466}", "\u{261d}"]),
    (
        "\u{1f466}\u{308}\u{261d}",
        &["\u{1f466}\u{308}", "\u{261d}"],
    ),
    ("\u{1f466}\u{1f3fb}", &["\u{1f466}\u{1f3fb}"]),
    ("\u{1f466}\u{308}\u{1f3fb}", &["\u{1f466}\u{308}\u{1f3fb}"]),
    ("\u{1f466}\u{200d}", &["\u{1f466}\u{200d}"]),
    ("\u{1f466}\u{308}\u{200d}", &["\u{1f466}\u{308}\u{200d}"]),
    ("\u{1f466}\u{2764}", &["\u{1f466}", "\u{2764}"]),
    (
        "\u{1f466}\u{308}\u{2764}",
        &["\u{1f466}\u{308}", "\u{2764}"],
    ),
    ("\u{1f466}\u{1f466}", &["\u{1f466}", "\u{1f466}"]),
    (
        "\u{1f466}\u{308}\u{1f466}",
        &["\u{1f466}\u{308}", "\u{1f466}"],
    ),
    ("\u{1f466}\u{378}", &["\u{1f466}", "\u{378}"]),
    ("\u{1f466}\u{308}\u{378}", &["\u{1f466}\u{308}", "\u{378}"]),
    ...
    ("\u{378}\u{261d}", &["\u{378}", "\u{261d}"]),
    ("\u{378}\u{308}\u{261d}", &["\u{378}\u{308}", "\u{261d}"]),
    ("\u{378}\u{1f3fb}", &["\u{378}", "\u{1f3fb}"]),
    ("\u{378}\u{308}\u{1f3fb}", &["\u{378}\u{308}", "\u{1f3fb}"]),
    ("\u{378}\u{200d}", &["\u{378}\u{200d}"]),
    ("\u{378}\u{308}\u{200d}", &["\u{378}\u{308}\u{200d}"]),
    ("\u{378}\u{2764}", &["\u{378}", "\u{2764}"]),
    ("\u{378}\u{308}\u{2764}", &["\u{378}\u{308}", "\u{2764}"]),
    ("\u{378}\u{1f466}", &["\u{378}", "\u{1f466}"]),
    ("\u{378}\u{308}\u{1f466}", &["\u{378}\u{308}", "\u{1f466}"]),
    ...
    (
        "\u{261d}\u{1f3fb}\u{261d}",
        &["\u{261d}\u{1f3fb}", "\u{261d}"],
    ),
    ("\u{1f466}\u{1f3fb}", &["\u{1f466}\u{1f3fb}"]),
    (
        "\u{200d}\u{1f466}\u{1f3fb}",
        &["\u{200d}\u{1f466}\u{1f3fb}"],
    ),
    ("\u{200d}\u{2764}", &["\u{200d}\u{2764}"]),
    ("\u{200d}\u{1f466}", &["\u{200d}\u{1f466}"]),
...
pub const TEST_WORD: &'static [(&'static str, &'static [&'static str])] = &[
    ...
    ("\u{b}\u{261d}", &["\u{b}", "\u{261d}"]),
    ("\u{b}\u{308}\u{261d}", &["\u{b}", "\u{308}", "\u{261d}"]),
    ("\u{b}\u{1f3fb}", &["\u{b}", "\u{1f3fb}"]),
    ("\u{b}\u{308}\u{1f3fb}", &["\u{b}", "\u{308}", "\u{1f3fb}"]),
    ("\u{b}\u{2764}", &["\u{b}", "\u{2764}"]),
    ("\u{b}\u{308}\u{2764}", &["\u{b}", "\u{308}", "\u{2764}"]),
    ("\u{b}\u{1f466}", &["\u{b}", "\u{1f466}"]),
    ("\u{b}\u{308}\u{1f466}", &["\u{b}", "\u{308}", "\u{1f466}"]),
    ("\u{b}\u{ad}", &["\u{b}", "\u{ad}"]),
    ...
    ("\u{3031}\u{261d}", &["\u{3031}", "\u{261d}"]),
    ("\u{3031}\u{308}\u{261d}", &["\u{3031}\u{308}", "\u{261d}"]),
    ("\u{3031}\u{1f3fb}", &["\u{3031}", "\u{1f3fb}"]),
    (
        "\u{3031}\u{308}\u{1f3fb}",
        &["\u{3031}\u{308}", "\u{1f3fb}"],
    ),
    ("\u{3031}\u{2764}", &["\u{3031}", "\u{2764}"]),
    ("\u{3031}\u{308}\u{2764}", &["\u{3031}\u{308}", "\u{2764}"]),
    ("\u{3031}\u{1f466}", &["\u{3031}", "\u{1f466}"]),
    (
        "\u{3031}\u{308}\u{1f466}",
        &["\u{3031}\u{308}", "\u{1f466}"],
    ),
    ...
    ("\u{41}\u{261d}", &["\u{41}", "\u{261d}"]),
    ("\u{41}\u{308}\u{261d}", &["\u{41}\u{308}", "\u{261d}"]),
    ("\u{41}\u{1f3fb}", &["\u{41}", "\u{1f3fb}"]),
    ("\u{41}\u{308}\u{1f3fb}", &["\u{41}\u{308}", "\u{1f3fb}"]),
    ("\u{41}\u{2764}", &["\u{41}", "\u{2764}"]),
    ("\u{41}\u{308}\u{2764}", &["\u{41}\u{308}", "\u{2764}"]),
    ("\u{41}\u{1f466}", &["\u{41}", "\u{1f466}"]),
    ("\u{41}\u{308}\u{1f466}", &["\u{41}\u{308}", "\u{1f466}"]),
    ("\u{41}\u{ad}", &["\u{41}\u{ad}"]),
    ...
    ("\u{3a}\u{261d}", &["\u{3a}", "\u{261d}"]),
    ("\u{3a}\u{308}\u{261d}", &["\u{3a}\u{308}", "\u{261d}"]),
    ("\u{3a}\u{1f3fb}", &["\u{3a}", "\u{1f3fb}"]),
    ("\u{3a}\u{308}\u{1f3fb}", &["\u{3a}\u{308}", "\u{1f3fb}"]),
    ("\u{3a}\u{2764}", &["\u{3a}", "\u{2764}"]),
    ("\u{3a}\u{308}\u{2764}", &["\u{3a}\u{308}", "\u{2764}"]),
    ("\u{3a}\u{1f466}", &["\u{3a}", "\u{1f466}"]),
    ("\u{3a}\u{308}\u{1f466}", &["\u{3a}\u{308}", "\u{1f466}"]),
    ("\u{3a}\u{ad}", &["\u{3a}\u{ad}"]),
    ...
    ("\u{2c}\u{261d}", &["\u{2c}", "\u{261d}"]),
    ("\u{2c}\u{308}\u{261d}", &["\u{2c}\u{308}", "\u{261d}"]),
    ("\u{2c}\u{1f3fb}", &["\u{2c}", "\u{1f3fb}"]),
    ("\u{2c}\u{308}\u{1f3fb}", &["\u{2c}\u{308}", "\u{1f3fb}"]),
    ("\u{2c}\u{2764}", &["\u{2c}", "\u{2764}"]),
    ("\u{2c}\u{308}\u{2764}", &["\u{2c}\u{308}", "\u{2764}"]),
    ("\u{2c}\u{1f466}", &["\u{2c}", "\u{1f466}"]),
    ("\u{2c}\u{308}\u{1f466}", &["\u{2c}\u{308}", "\u{1f466}"]),
    ("\u{2c}\u{ad}", &["\u{2c}\u{ad}"]),
    ...
    ("\u{2e}\u{261d}", &["\u{2e}", "\u{261d}"]),
    ("\u{2e}\u{308}\u{261d}", &["\u{2e}\u{308}", "\u{261d}"]),
    ("\u{2e}\u{1f3fb}", &["\u{2e}", "\u{1f3fb}"]),
    ("\u{2e}\u{308}\u{1f3fb}", &["\u{2e}\u{308}", "\u{1f3fb}"]),
    ("\u{2e}\u{2764}", &["\u{2e}", "\u{2764}"]),
    ("\u{2e}\u{308}\u{2764}", &["\u{2e}\u{308}", "\u{2764}"]),
    ("\u{2e}\u{1f466}", &["\u{2e}", "\u{1f466}"]),
    ("\u{2e}\u{308}\u{1f466}", &["\u{2e}\u{308}", "\u{1f466}"]),
    ("\u{2e}\u{ad}", &["\u{2e}\u{ad}"]),
    ...
    ("\u{30}\u{261d}", &["\u{30}", "\u{261d}"]),
    ("\u{30}\u{308}\u{261d}", &["\u{30}\u{308}", "\u{261d}"]),
    ("\u{30}\u{1f3fb}", &["\u{30}", "\u{1f3fb}"]),
    ("\u{30}\u{308}\u{1f3fb}", &["\u{30}\u{308}", "\u{1f3fb}"]),
    ("\u{30}\u{2764}", &["\u{30}", "\u{2764}"]),
    ("\u{30}\u{308}\u{2764}", &["\u{30}\u{308}", "\u{2764}"]),
    ("\u{30}\u{1f466}", &["\u{30}", "\u{1f466}"]),
    ("\u{30}\u{308}\u{1f466}", &["\u{30}\u{308}", "\u{1f466}"]),
    ("\u{30}\u{ad}", &["\u{30}\u{ad}"]),
    ...
    ("\u{5f}\u{261d}", &["\u{5f}", "\u{261d}"]),
    ("\u{5f}\u{308}\u{261d}", &["\u{5f}\u{308}", "\u{261d}"]),
    ("\u{5f}\u{1f3fb}", &["\u{5f}", "\u{1f3fb}"]),
    ("\u{5f}\u{308}\u{1f3fb}", &["\u{5f}\u{308}", "\u{1f3fb}"]),
    ("\u{5f}\u{2764}", &["\u{5f}", "\u{2764}"]),
    ("\u{5f}\u{308}\u{2764}", &["\u{5f}\u{308}", "\u{2764}"]),
    ("\u{5f}\u{1f466}", &["\u{5f}", "\u{1f466}"]),
    ("\u{5f}\u{308}\u{1f466}", &["\u{5f}\u{308}", "\u{1f466}"]),
    ("\u{5f}\u{ad}", &["\u{5f}\u{ad}"]),
    ...
    ("\u{5d0}\u{261d}", &["\u{5d0}", "\u{261d}"]),
    ("\u{5d0}\u{308}\u{261d}", &["\u{5d0}\u{308}", "\u{261d}"]),
    ("\u{5d0}\u{1f3fb}", &["\u{5d0}", "\u{1f3fb}"]),
    ("\u{5d0}\u{308}\u{1f3fb}", &["\u{5d0}\u{308}", "\u{1f3fb}"]),
    ("\u{5d0}\u{2764}", &["\u{5d0}", "\u{2764}"]),
    ("\u{5d0}\u{308}\u{2764}", &["\u{5d0}\u{308}", "\u{2764}"]),
    ("\u{5d0}\u{1f466}", &["\u{5d0}", "\u{1f466}"]),
    ("\u{5d0}\u{308}\u{1f466}", &["\u{5d0}\u{308}", "\u{1f466}"]),
    ...
    ("\u{22}\u{261d}", &["\u{22}", "\u{261d}"]),
    ("\u{22}\u{308}\u{261d}", &["\u{22}\u{308}", "\u{261d}"]),
    ("\u{22}\u{1f3fb}", &["\u{22}", "\u{1f3fb}"]),
    ("\u{22}\u{308}\u{1f3fb}", &["\u{22}\u{308}", "\u{1f3fb}"]),
    ("\u{22}\u{2764}", &["\u{22}", "\u{2764}"]),
    ("\u{22}\u{308}\u{2764}", &["\u{22}\u{308}", "\u{2764}"]),
    ("\u{22}\u{1f466}", &["\u{22}", "\u{1f466}"]),
    ("\u{22}\u{308}\u{1f466}", &["\u{22}\u{308}", "\u{1f466}"]),
    ("\u{22}\u{ad}", &["\u{22}\u{ad}"]),
    ...
    ("\u{27}\u{261d}", &["\u{27}", "\u{261d}"]),
    ("\u{27}\u{308}\u{261d}", &["\u{27}\u{308}", "\u{261d}"]),
    ("\u{27}\u{1f3fb}", &["\u{27}", "\u{1f3fb}"]),
    ("\u{27}\u{308}\u{1f3fb}", &["\u{27}\u{308}", "\u{1f3fb}"]),
    ("\u{27}\u{2764}", &["\u{27}", "\u{2764}"]),
    ("\u{27}\u{308}\u{2764}", &["\u{27}\u{308}", "\u{2764}"]),
    ("\u{27}\u{1f466}", &["\u{27}", "\u{1f466}"]),
    ("\u{27}\u{308}\u{1f466}", &["\u{27}\u{308}", "\u{1f466}"]),
    ("\u{27}\u{ad}", &["\u{27}\u{ad}"]),
    ...
    ("\u{261d}\u{a}", &["\u{261d}", "\u{a}"]),
    ("\u{261d}\u{308}\u{a}", &["\u{261d}\u{308}", "\u{a}"]),
    ("\u{261d}\u{b}", &["\u{261d}", "\u{b}"]),
    ("\u{261d}\u{308}\u{b}", &["\u{261d}\u{308}", "\u{b}"]),
    ("\u{261d}\u{3031}", &["\u{261d}", "\u{3031}"]),
    ("\u{261d}\u{308}\u{3031}", &["\u{261d}\u{308}", "\u{3031}"]),
    ("\u{261d}\u{41}", &["\u{261d}", "\u{41}"]),
    ("\u{261d}\u{308}\u{41}", &["\u{261d}\u{308}", "\u{41}"]),
    ("\u{261d}\u{3a}", &["\u{261d}", "\u{3a}"]),
    ("\u{261d}\u{308}\u{3a}", &["\u{261d}\u{308}", "\u{3a}"]),
    ("\u{261d}\u{2c}", &["\u{261d}", "\u{2c}"]),
    ("\u{261d}\u{308}\u{2c}", &["\u{261d}\u{308}", "\u{2c}"]),
    ("\u{261d}\u{2e}", &["\u{261d}", "\u{2e}"]),
    ("\u{261d}\u{308}\u{2e}", &["\u{261d}\u{308}", "\u{2e}"]),
    ("\u{261d}\u{30}", &["\u{261d}", "\u{30}"]),
    ("\u{261d}\u{308}\u{30}", &["\u{261d}\u{308}", "\u{30}"]),
    ("\u{261d}\u{5f}", &["\u{261d}", "\u{5f}"]),
    ("\u{261d}\u{308}\u{5f}", &["\u{261d}\u{308}", "\u{5f}"]),
    ("\u{261d}\u{1f1e6}", &["\u{261d}", "\u{1f1e6}"]),
    (
        "\u{261d}\u{308}\u{1f1e6}",
        &["\u{261d}\u{308}", "\u{1f1e6}"],
    ),
    ("\u{261d}\u{5d0}", &["\u{261d}", "\u{5d0}"]),
    ("\u{261d}\u{308}\u{5d0}", &["\u{261d}\u{308}", "\u{5d0}"]),
    ("\u{261d}\u{22}", &["\u{261d}", "\u{22}"]),
    ("\u{261d}\u{308}\u{22}", &["\u{261d}\u{308}", "\u{22}"]),
    ("\u{261d}\u{27}", &["\u{261d}", "\u{27}"]),
    ("\u{261d}\u{308}\u{27}", &["\u{261d}\u{308}", "\u{27}"]),
    ("\u{261d}\u{261d}", &["\u{261d}", "\u{261d}"]),
    ("\u{261d}\u{308}\u{261d}", &["\u{261d}\u{308}", "\u{261d}"]),
    ("\u{261d}\u{1f3fb}", &["\u{261d}\u{1f3fb}"]),
    ("\u{261d}\u{308}\u{1f3fb}", &["\u{261d}\u{308}\u{1f3fb}"]),
    ...
    ("\u{261d}\u{ad}", &["\u{261d}\u{ad}"]),
    ("\u{261d}\u{308}\u{ad}", &["\u{261d}\u{308}\u{ad}"]),
    ("\u{261d}\u{300}", &["\u{261d}\u{300}"]),
    ("\u{261d}\u{308}\u{300}", &["\u{261d}\u{308}\u{300}"]),
    ("\u{261d}\u{200d}", &["\u{261d}\u{200d}"]),
    ("\u{261d}\u{308}\u{200d}", &["\u{261d}\u{308}\u{200d}"]),
    ("\u{261d}\u{61}\u{2060}", &["\u{261d}", "\u{61}\u{2060}"]),
    (
        "\u{261d}\u{308}\u{61}\u{2060}",
        &["\u{261d}\u{308}", "\u{61}\u{2060}"],
    ),
    ("\u{261d}\u{61}\u{3a}", &["\u{261d}", "\u{61}", "\u{3a}"]),
    (
        "\u{261d}\u{308}\u{61}\u{3a}",
        &["\u{261d}\u{308}", "\u{61}", "\u{3a}"],
    ),
    ("\u{261d}\u{61}\u{27}", &["\u{261d}", "\u{61}", "\u{27}"]),
    (
        "\u{261d}\u{308}\u{61}\u{27}",
        &["\u{261d}\u{308}", "\u{61}", "\u{27}"],
    ),
    (
        "\u{261d}\u{61}\u{27}\u{2060}",
        &["\u{261d}", "\u{61}", "\u{27}\u{2060}"],
    ),
    (
        "\u{261d}\u{308}\u{61}\u{27}\u{2060}",
        &["\u{261d}\u{308}", "\u{61}", "\u{27}\u{2060}"],
    ),
    ("\u{261d}\u{61}\u{2c}", &["\u{261d}", "\u{61}", "\u{2c}"]),
    (
        "\u{261d}\u{308}\u{61}\u{2c}",
        &["\u{261d}\u{308}", "\u{61}", "\u{2c}"],
    ),
    ("\u{261d}\u{31}\u{3a}", &["\u{261d}", "\u{31}", "\u{3a}"]),
    (
        "\u{261d}\u{308}\u{31}\u{3a}",
        &["\u{261d}\u{308}", "\u{31}", "\u{3a}"],
    ),
    ("\u{261d}\u{31}\u{27}", &["\u{261d}", "\u{31}", "\u{27}"]),
    (
        "\u{261d}\u{308}\u{31}\u{27}",
        &["\u{261d}\u{308}", "\u{31}", "\u{27}"],
    ),
    ("\u{261d}\u{31}\u{2c}", &["\u{261d}", "\u{31}", "\u{2c}"]),
    (
        "\u{261d}\u{308}\u{31}\u{2c}",
        &["\u{261d}\u{308}", "\u{31}", "\u{2c}"],
    ),
    (
        "\u{261d}\u{31}\u{2e}\u{2060}",
        &["\u{261d}", "\u{31}", "\u{2e}\u{2060}"],
    ),
    (
        "\u{261d}\u{308}\u{31}\u{2e}\u{2060}",
        &["\u{261d}\u{308}", "\u{31}", "\u{2e}\u{2060}"],
    ),
    ("\u{1f3fb}\u{1}", &["\u{1f3fb}", "\u{1}"]),
    ("\u{1f3fb}\u{308}\u{1}", &["\u{1f3fb}\u{308}", "\u{1}"]),
    ...
    ("\u{1f3fb}\u{a}", &["\u{1f3fb}", "\u{a}"]),
    ("\u{1f3fb}\u{308}\u{a}", &["\u{1f3fb}\u{308}", "\u{a}"]),
    ("\u{1f3fb}\u{b}", &["\u{1f3fb}", "\u{b}"]),
    ("\u{1f3fb}\u{308}\u{b}", &["\u{1f3fb}\u{308}", "\u{b}"]),
    ("\u{1f3fb}\u{3031}", &["\u{1f3fb}", "\u{3031}"]),
    (
        "\u{1f3fb}\u{308}\u{3031}",
        &["\u{1f3fb}\u{308}", "\u{3031}"],
    ),
    ("\u{1f3fb}\u{41}", &["\u{1f3fb}", "\u{41}"]),
    ("\u{1f3fb}\u{308}\u{41}", &["\u{1f3fb}\u{308}", "\u{41}"]),
    ("\u{1f3fb}\u{3a}", &["\u{1f3fb}", "\u{3a}"]),
    ("\u{1f3fb}\u{308}\u{3a}", &["\u{1f3fb}\u{308}", "\u{3a}"]),
    ("\u{1f3fb}\u{2c}", &["\u{1f3fb}", "\u{2c}"]),
    ("\u{1f3fb}\u{308}\u{2c}", &["\u{1f3fb}\u{308}", "\u{2c}"]),
    ("\u{1f3fb}\u{2e}", &["\u{1f3fb}", "\u{2e}"]),
    ("\u{1f3fb}\u{308}\u{2e}", &["\u{1f3fb}\u{308}", "\u{2e}"]),
    ("\u{1f3fb}\u{30}", &["\u{1f3fb}", "\u{30}"]),
    ("\u{1f3fb}\u{308}\u{30}", &["\u{1f3fb}\u{308}", "\u{30}"]),
    ("\u{1f3fb}\u{5f}", &["\u{1f3fb}", "\u{5f}"]),
    ("\u{1f3fb}\u{308}\u{5f}", &["\u{1f3fb}\u{308}", "\u{5f}"]),
    ("\u{1f3fb}\u{1f1e6}", &["\u{1f3fb}", "\u{1f1e6}"]),
    (
        "\u{1f3fb}\u{308}\u{1f1e6}",
        &["\u{1f3fb}\u{308}", "\u{1f1e6}"],
    ),
    ("\u{1f3fb}\u{5d0}", &["\u{1f3fb}", "\u{5d0}"]),
    ("\u{1f3fb}\u{308}\u{5d0}", &["\u{1f3fb}\u{308}", "\u{5d0}"]),
    ("\u{1f3fb}\u{22}", &["\u{1f3fb}", "\u{22}"]),
    ("\u{1f3fb}\u{308}\u{22}", &["\u{1f3fb}\u{308}", "\u{22}"]),
    ("\u{1f3fb}\u{27}", &["\u{1f3fb}", "\u{27}"]),
    ("\u{1f3fb}\u{308}\u{27}", &["\u{1f3fb}\u{308}", "\u{27}"]),
    ("\u{1f3fb}\u{261d}", &["\u{1f3fb}", "\u{261d}"]),
    (
        "\u{1f3fb}\u{308}\u{261d}",
        &["\u{1f3fb}\u{308}", "\u{261d}"],
    ...
    ("\u{1f3fb}\u{ad}", &["\u{1f3fb}\u{ad}"]),
    ("\u{1f3fb}\u{308}\u{ad}", &["\u{1f3fb}\u{308}\u{ad}"]),
    ("\u{1f3fb}\u{300}", &["\u{1f3fb}\u{300}"]),
    ("\u{1f3fb}\u{308}\u{300}", &["\u{1f3fb}\u{308}\u{300}"]),
    ("\u{1f3fb}\u{200d}", &["\u{1f3fb}\u{200d}"]),
    ("\u{1f3fb}\u{308}\u{200d}", &["\u{1f3fb}\u{308}\u{200d}"]),
    ...
    (
        "\u{1f3fb}\u{308}\u{61}\u{2060}",
        &["\u{1f3fb}\u{308}", "\u{61}\u{2060}"],
    ),
    ("\u{1f3fb}\u{61}\u{3a}", &["\u{1f3fb}", "\u{61}", "\u{3a}"]),
    (
        "\u{1f3fb}\u{308}\u{61}\u{3a}",
        &["\u{1f3fb}\u{308}", "\u{61}", "\u{3a}"],
    ),
    ...
    (
        "\u{1f3fb}\u{61}\u{27}\u{2060}",
        &["\u{1f3fb}", "\u{61}", "\u{27}\u{2060}"],
    ),
    (
        "\u{1f3fb}\u{308}\u{61}\u{27}\u{2060}",
        &["\u{1f3fb}\u{308}", "\u{61}", "\u{27}\u{2060}"],
    ),
    ("\u{1f3fb}\u{61}\u{2c}", &["\u{1f3fb}", "\u{61}", "\u{2c}"]),
    (
        "\u{1f3fb}\u{308}\u{61}\u{2c}",
        &["\u{1f3fb}\u{308}", "\u{61}", "\u{2c}"],
    ),
    ("\u{1f3fb}\u{31}\u{3a}", &["\u{1f3fb}", "\u{31}", "\u{3a}"]),
    (
        "\u{1f3fb}\u{308}\u{31}\u{3a}",
        &["\u{1f3fb}\u{308}", "\u{31}", "\u{3a}"],
    ),
    ...
    (
        "\u{1f3fb}\u{308}\u{31}\u{2c}",
        &["\u{1f3fb}\u{308}", "\u{31}", "\u{2c}"],
    ),
    (
        "\u{1f3fb}\u{31}\u{2e}\u{2060}",
        &["\u{1f3fb}", "\u{31}", "\u{2e}\u{2060}"],
    ),
    (
        "\u{1f3fb}\u{308}\u{31}\u{2e}\u{2060}",
        &["\u{1f3fb}\u{308}", "\u{31}", "\u{2e}\u{2060}"],
    ),
    ("\u{2764}\u{1}", &["\u{2764}", "\u{1}"]),
    ("\u{2764}\u{308}\u{1}", &["\u{2764}\u{308}", "\u{1}"]),
    ...
    ("\u{2764}\u{a}", &["\u{2764}", "\u{a}"]),
    ("\u{2764}\u{308}\u{a}", &["\u{2764}\u{308}", "\u{a}"]),
    ("\u{2764}\u{b}", &["\u{2764}", "\u{b}"]),
    ("\u{2764}\u{308}\u{b}", &["\u{2764}\u{308}", "\u{b}"]),
    ("\u{2764}\u{3031}", &["\u{2764}", "\u{3031}"]),
    ("\u{2764}\u{308}\u{3031}", &["\u{2764}\u{308}", "\u{3031}"]),
    ("\u{2764}\u{41}", &["\u{2764}", "\u{41}"]),
    ("\u{2764}\u{308}\u{41}", &["\u{2764}\u{308}", "\u{41}"]),
    ("\u{2764}\u{3a}", &["\u{2764}", "\u{3a}"]),
    ("\u{2764}\u{308}\u{3a}", &["\u{2764}\u{308}", "\u{3a}"]),
    ("\u{2764}\u{2c}", &["\u{2764}", "\u{2c}"]),
    ("\u{2764}\u{308}\u{2c}", &["\u{2764}\u{308}", "\u{2c}"]),
    ("\u{2764}\u{2e}", &["\u{2764}", "\u{2e}"]),
    ("\u{2764}\u{308}\u{2e}", &["\u{2764}\u{308}", "\u{2e}"]),
    ("\u{2764}\u{30}", &["\u{2764}", "\u{30}"]),
    ("\u{2764}\u{308}\u{30}", &["\u{2764}\u{308}", "\u{30}"]),
    ("\u{2764}\u{5f}", &["\u{2764}", "\u{5f}"]),
    ("\u{2764}\u{308}\u{5f}", &["\u{2764}\u{308}", "\u{5f}"]),
    ("\u{2764}\u{1f1e6}", &["\u{2764}", "\u{1f1e6}"]),
    (
        "\u{2764}\u{308}\u{1f1e6}",
        &["\u{2764}\u{308}", "\u{1f1e6}"],
    ),
    ("\u{2764}\u{5d0}", &["\u{2764}", "\u{5d0}"]),
    ("\u{2764}\u{308}\u{5d0}", &["\u{2764}\u{308}", "\u{5d0}"]),
    ("\u{2764}\u{22}", &["\u{2764}", "\u{22}"]),
    ("\u{2764}\u{308}\u{22}", &["\u{2764}\u{308}", "\u{22}"]),
    ("\u{2764}\u{27}", &["\u{2764}", "\u{27}"]),
    ("\u{2764}\u{308}\u{27}", &["\u{2764}\u{308}", "\u{27}"]),
    ("\u{2764}\u{261d}", &["\u{2764}", "\u{261d}"]),
    ("\u{2764}\u{308}\u{261d}", &["\u{2764}\u{308}", "\u{261d}"]),
    ("\u{2764}\u{1f3fb}", &["\u{2764}", "\u{1f3fb}"]),
    (
    ...
    ("\u{2764}\u{ad}", &["\u{2764}\u{ad}"]),
    ("\u{2764}\u{308}\u{ad}", &["\u{2764}\u{308}\u{ad}"]),
    ("\u{2764}\u{300}", &["\u{2764}\u{300}"]),
    ("\u{2764}\u{308}\u{300}", &["\u{2764}\u{308}\u{300}"]),
    ("\u{2764}\u{200d}", &["\u{2764}\u{200d}"]),
    ("\u{2764}\u{308}\u{200d}", &["\u{2764}\u{308}\u{200d}"]),
    ("\u{2764}\u{61}\u{2060}", &["\u{2764}", "\u{61}\u{2060}"]),
    (
        "\u{2764}\u{308}\u{61}\u{2060}",
        &["\u{2764}\u{308}", "\u{61}\u{2060}"],
    ),
    ("\u{2764}\u{61}\u{3a}", &["\u{2764}", "\u{61}", "\u{3a}"]),
    (
        "\u{2764}\u{308}\u{61}\u{3a}",
        &["\u{2764}\u{308}", "\u{61}", "\u{3a}"],
    ),
    ("\u{2764}\u{61}\u{27}", &["\u{2764}", "\u{61}", "\u{27}"]),
    (
        "\u{2764}\u{308}\u{61}\u{27}",
        &["\u{2764}\u{308}", "\u{61}", "\u{27}"],
    ),
    (
        "\u{2764}\u{61}\u{27}\u{2060}",
        &["\u{2764}", "\u{61}", "\u{27}\u{2060}"],
    ),
    (
        "\u{2764}\u{308}\u{61}\u{27}\u{2060}",
        &["\u{2764}\u{308}", "\u{61}", "\u{27}\u{2060}"],
    ),
    ("\u{2764}\u{61}\u{2c}", &["\u{2764}", "\u{61}", "\u{2c}"]),
    (
        "\u{2764}\u{308}\u{61}\u{2c}",
        &["\u{2764}\u{308}", "\u{61}", "\u{2c}"],
    ),
    ("\u{2764}\u{31}\u{3a}", &["\u{2764}", "\u{31}", "\u{3a}"]),
    (
        "\u{2764}\u{308}\u{31}\u{3a}",
        &["\u{2764}\u{308}", "\u{31}", "\u{3a}"],
    ),
    ("\u{2764}\u{31}\u{27}", &["\u{2764}", "\u{31}", "\u{27}"]),
    (
        "\u{2764}\u{308}\u{31}\u{27}",
        &["\u{2764}\u{308}", "\u{31}", "\u{27}"],
    ),
    ("\u{2764}\u{31}\u{2c}", &["\u{2764}", "\u{31}", "\u{2c}"]),
    (
        "\u{2764}\u{308}\u{31}\u{2c}",
        &["\u{2764}\u{308}", "\u{31}", "\u{2c}"],
    ),
    (
        "\u{2764}\u{31}\u{2e}\u{2060}",
        &["\u{2764}", "\u{31}", "\u{2e}\u{2060}"],
    ),
    (
        "\u{2764}\u{308}\u{31}\u{2e}\u{2060}",
        &["\u{2764}\u{308}", "\u{31}", "\u{2e}\u{2060}"],
    ),
    ("\u{1f466}\u{1}", &["\u{1f466}", "\u{1}"]),
    ("\u{1f466}\u{308}\u{1}", &["\u{1f466}\u{308}", "\u{1}"]),
    ...
    ("\u{1f466}\u{a}", &["\u{1f466}", "\u{a}"]),
    ("\u{1f466}\u{308}\u{a}", &["\u{1f466}\u{308}", "\u{a}"]),
    ("\u{1f466}\u{b}", &["\u{1f466}", "\u{b}"]),
    ("\u{1f466}\u{308}\u{b}", &["\u{1f466}\u{308}", "\u{b}"]),
    ("\u{1f466}\u{3031}", &["\u{1f466}", "\u{3031}"]),
    (
        "\u{1f466}\u{308}\u{3031}",
        &["\u{1f466}\u{308}", "\u{3031}"],
    ),
    ("\u{1f466}\u{41}", &["\u{1f466}", "\u{41}"]),
    ("\u{1f466}\u{308}\u{41}", &["\u{1f466}\u{308}", "\u{41}"]),
    ("\u{1f466}\u{3a}", &["\u{1f466}", "\u{3a}"]),
    ("\u{1f466}\u{308}\u{3a}", &["\u{1f466}\u{308}", "\u{3a}"]),
    ("\u{1f466}\u{2c}", &["\u{1f466}", "\u{2c}"]),
    ("\u{1f466}\u{308}\u{2c}", &["\u{1f466}\u{308}", "\u{2c}"]),
    ("\u{1f466}\u{2e}", &["\u{1f466}", "\u{2e}"]),
    ("\u{1f466}\u{308}\u{2e}", &["\u{1f466}\u{308}", "\u{2e}"]),
    ("\u{1f466}\u{30}", &["\u{1f466}", "\u{30}"]),
    ("\u{1f466}\u{308}\u{30}", &["\u{1f466}\u{308}", "\u{30}"]),
    ("\u{1f466}\u{5f}", &["\u{1f466}", "\u{5f}"]),
    ("\u{1f466}\u{308}\u{5f}", &["\u{1f466}\u{308}", "\u{5f}"]),
    ("\u{1f466}\u{1f1e6}", &["\u{1f466}", "\u{1f1e6}"]),
    (
        "\u{1f466}\u{308}\u{1f1e6}",
        &["\u{1f466}\u{308}", "\u{1f1e6}"],
    ),
    ("\u{1f466}\u{5d0}", &["\u{1f466}", "\u{5d0}"]),
    ("\u{1f466}\u{308}\u{5d0}", &["\u{1f466}\u{308}", "\u{5d0}"]),
    ("\u{1f466}\u{22}", &["\u{1f466}", "\u{22}"]),
    ("\u{1f466}\u{308}\u{22}", &["\u{1f466}\u{308}", "\u{22}"]),
    ("\u{1f466}\u{27}", &["\u{1f466}", "\u{27}"]),
    ("\u{1f466}\u{308}\u{27}", &["\u{1f466}\u{308}", "\u{27}"]),
    ("\u{1f466}\u{261d}", &["\u{1f466}", "\u{261d}"]),
    (
        "\u{1f466}\u{308}\u{261d}",
        &["\u{1f466}\u{308}", "\u{261d}"],
    ...
    ("\u{1f466}\u{ad}", &["\u{1f466}\u{ad}"]),
    ("\u{1f466}\u{308}\u{ad}", &["\u{1f466}\u{308}\u{ad}"]),
    ("\u{1f466}\u{300}", &["\u{1f466}\u{300}"]),
    ("\u{1f466}\u{308}\u{300}", &["\u{1f466}\u{308}\u{300}"]),
    ("\u{1f466}\u{200d}", &["\u{1f466}\u{200d}"]),
    ("\u{1f466}\u{308}\u{200d}", &["\u{1f466}\u{308}\u{200d}"]),
    ("\u{1f466}\u{61}\u{2060}", &["\u{1f466}", "\u{61}\u{2060}"]),
    (
        "\u{1f466}\u{308}\u{61}\u{2060}",
        &["\u{1f466}\u{308}", "\u{61}\u{2060}"],
    ),
    ("\u{1f466}\u{61}\u{3a}", &["\u{1f466}", "\u{61}", "\u{3a}"]),
    (
        "\u{1f466}\u{308}\u{61}\u{3a}",
        &["\u{1f466}\u{308}", "\u{61}", "\u{3a}"],
    ),
    ...
    (
        "\u{1f466}\u{61}\u{27}\u{2060}",
        &["\u{1f466}", "\u{61}", "\u{27}\u{2060}"],
    ),
    (
        "\u{1f466}\u{308}\u{61}\u{27}\u{2060}",
        &["\u{1f466}\u{308}", "\u{61}", "\u{27}\u{2060}"],
    ),
    ("\u{1f466}\u{61}\u{2c}", &["\u{1f466}", "\u{61}", "\u{2c}"]),
    (
        "\u{1f466}\u{308}\u{61}\u{2c}",
        &["\u{1f466}\u{308}", "\u{61}", "\u{2c}"],
    ),
    ("\u{1f466}\u{31}\u{3a}", &["\u{1f466}", "\u{31}", "\u{3a}"]),
    (
        "\u{1f466}\u{308}\u{31}\u{3a}",
        &["\u{1f466}\u{308}", "\u{31}", "\u{3a}"],
    ),
    ...
    (
        "\u{1f466}\u{308}\u{31}\u{2c}",
        &["\u{1f466}\u{308}", "\u{31}", "\u{2c}"],
    ),
    (
        "\u{1f466}\u{31}\u{2e}\u{2060}",
        &["\u{1f466}", "\u{31}", "\u{2e}\u{2060}"],
    ),
    (
        "\u{1f466}\u{308}\u{31}\u{2e}\u{2060}",
        &["\u{1f466}\u{308}", "\u{31}", "\u{2e}\u{2060}"],
    ),
    ("\u{ad}\u{1}", &["\u{ad}", "\u{1}"]),
    ...
    ("\u{ad}\u{261d}", &["\u{ad}", "\u{261d}"]),
    ("\u{ad}\u{308}\u{261d}", &["\u{ad}\u{308}", "\u{261d}"]),
    ("\u{ad}\u{1f3fb}", &["\u{ad}", "\u{1f3fb}"]),
    ("\u{ad}\u{308}\u{1f3fb}", &["\u{ad}\u{308}", "\u{1f3fb}"]),
    ("\u{ad}\u{2764}", &["\u{ad}", "\u{2764}"]),
    ("\u{ad}\u{308}\u{2764}", &["\u{ad}\u{308}", "\u{2764}"]),
    ("\u{ad}\u{1f466}", &["\u{ad}", "\u{1f466}"]),
    ("\u{ad}\u{308}\u{1f466}", &["\u{ad}\u{308}", "\u{1f466}"]),
    ("\u{ad}\u{ad}", &["\u{ad}\u{ad}"]),
    ...
    ("\u{61}\u{2060}\u{261d}", &["\u{61}\u{2060}", "\u{261d}"]),
    (
        "\u{61}\u{2060}\u{308}\u{261d}",
        &["\u{61}\u{2060}\u{308}", "\u{261d}"],
    ),
    ("\u{61}\u{2060}\u{1f3fb}", &["\u{61}\u{2060}", "\u{1f3fb}"]),
    (
        "\u{61}\u{2060}\u{308}\u{1f3fb}",
        &["\u{61}\u{2060}\u{308}", "\u{1f3fb}"],
    ),
    ("\u{61}\u{2060}\u{2764}", &["\u{61}\u{2060}", "\u{2764}"]),
    (
        "\u{61}\u{2060}\u{308}\u{2764}",
        &["\u{61}\u{2060}\u{308}", "\u{2764}"],
    ),
    ("\u{61}\u{2060}\u{1f466}", &["\u{61}\u{2060}", "\u{1f466}"]),
    (
        "\u{61}\u{2060}\u{308}\u{1f466}",
        &["\u{61}\u{2060}\u{308}", "\u{1f466}"],
    ),
    ...
    ("\u{61}\u{3a}\u{261d}", &["\u{61}", "\u{3a}", "\u{261d}"]),
    (
        "\u{61}\u{3a}\u{308}\u{261d}",
        &["\u{61}", "\u{3a}\u{308}", "\u{261d}"],
    ),
    ("\u{61}\u{3a}\u{1f3fb}", &["\u{61}", "\u{3a}", "\u{1f3fb}"]),
    (
        "\u{61}\u{3a}\u{308}\u{1f3fb}",
        &["\u{61}", "\u{3a}\u{308}", "\u{1f3fb}"],
    ),
    ("\u{61}\u{3a}\u{2764}", &["\u{61}", "\u{3a}", "\u{2764}"]),
    (
        "\u{61}\u{3a}\u{308}\u{2764}",
        &["\u{61}", "\u{3a}\u{308}", "\u{2764}"],
    ),
    ("\u{61}\u{3a}\u{1f466}", &["\u{61}", "\u{3a}", "\u{1f466}"]),
    (
        "\u{61}\u{3a}\u{308}\u{1f466}",
        &["\u{61}", "\u{3a}\u{308}", "\u{1f466}"],
    ),
    ...
    ("\u{61}\u{27}\u{261d}", &["\u{61}", "\u{27}", "\u{261d}"]),
    (
        "\u{61}\u{27}\u{308}\u{261d}",
        &["\u{61}", "\u{27}\u{308}", "\u{261d}"],
    ),
    ("\u{61}\u{27}\u{1f3fb}", &["\u{61}", "\u{27}", "\u{1f3fb}"]),
    (
        "\u{61}\u{27}\u{308}\u{1f3fb}",
        &["\u{61}", "\u{27}\u{308}", "\u{1f3fb}"],
    ),
    ("\u{61}\u{27}\u{2764}", &["\u{61}", "\u{27}", "\u{2764}"]),
    (
        "\u{61}\u{27}\u{308}\u{2764}",
        &["\u{61}", "\u{27}\u{308}", "\u{2764}"],
    ),
    ("\u{61}\u{27}\u{1f466}", &["\u{61}", "\u{27}", "\u{1f466}"]),
    (
        "\u{61}\u{27}\u{308}\u{1f466}",
        &["\u{61}", "\u{27}\u{308}", "\u{1f466}"],
    ),
    ...
    (
        "\u{61}\u{27}\u{2060}\u{261d}",
        &["\u{61}", "\u{27}\u{2060}", "\u{261d}"],
    ),
    (
        "\u{61}\u{27}\u{2060}\u{308}\u{261d}",
        &["\u{61}", "\u{27}\u{2060}\u{308}", "\u{261d}"],
    ),
    (
        "\u{61}\u{27}\u{2060}\u{1f3fb}",
        &["\u{61}", "\u{27}\u{2060}", "\u{1f3fb}"],
    ),
    (
        "\u{61}\u{27}\u{2060}\u{308}\u{1f3fb}",
        &["\u{61}", "\u{27}\u{2060}\u{308}", "\u{1f3fb}"],
    ),
    (
        "\u{61}\u{27}\u{2060}\u{2764}",
        &["\u{61}", "\u{27}\u{2060}", "\u{2764}"],
    ),
    (
        "\u{61}\u{27}\u{2060}\u{308}\u{2764}",
        &["\u{61}", "\u{27}\u{2060}\u{308}", "\u{2764}"],
    ),
    (
        "\u{61}\u{27}\u{2060}\u{1f466}",
        &["\u{61}", "\u{27}\u{2060}", "\u{1f466}"],
    ),
    (
        "\u{61}\u{27}\u{2060}\u{308}\u{1f466}",
        &["\u{61}", "\u{27}\u{2060}\u{308}", "\u{1f466}"],
    ),
    (
    ...
    ("\u{61}\u{2c}\u{261d}", &["\u{61}", "\u{2c}", "\u{261d}"]),
    (
        "\u{61}\u{2c}\u{308}\u{261d}",
        &["\u{61}", "\u{2c}\u{308}", "\u{261d}"],
    ),
    ("\u{61}\u{2c}\u{1f3fb}", &["\u{61}", "\u{2c}", "\u{1f3fb}"]),
    (
        "\u{61}\u{2c}\u{308}\u{1f3fb}",
        &["\u{61}", "\u{2c}\u{308}", "\u{1f3fb}"],
    ),
    ("\u{61}\u{2c}\u{2764}", &["\u{61}", "\u{2c}", "\u{2764}"]),
    (
        "\u{61}\u{2c}\u{308}\u{2764}",
        &["\u{61}", "\u{2c}\u{308}", "\u{2764}"],
    ),
    ("\u{61}\u{2c}\u{1f466}", &["\u{61}", "\u{2c}", "\u{1f466}"]),
    (
        "\u{61}\u{2c}\u{308}\u{1f466}",
        &["\u{61}", "\u{2c}\u{308}", "\u{1f466}"],
    ),
    ...
    ("\u{31}\u{3a}\u{261d}", &["\u{31}", "\u{3a}", "\u{261d}"]),
    (
        "\u{31}\u{3a}\u{308}\u{261d}",
        &["\u{31}", "\u{3a}\u{308}", "\u{261d}"],
    ),
    ("\u{31}\u{3a}\u{1f3fb}", &["\u{31}", "\u{3a}", "\u{1f3fb}"]),
    (
        "\u{31}\u{3a}\u{308}\u{1f3fb}",
        &["\u{31}", "\u{3a}\u{308}", "\u{1f3fb}"],
    ),
    ("\u{31}\u{3a}\u{2764}", &["\u{31}", "\u{3a}", "\u{2764}"]),
    (
        "\u{31}\u{3a}\u{308}\u{2764}",
        &["\u{31}", "\u{3a}\u{308}", "\u{2764}"],
    ),
    ("\u{31}\u{3a}\u{1f466}", &["\u{31}", "\u{3a}", "\u{1f466}"]),
    (
        "\u{31}\u{3a}\u{308}\u{1f466}",
        &["\u{31}", "\u{3a}\u{308}", "\u{1f466}"],
    ),
    ...
    ("\u{31}\u{27}\u{261d}", &["\u{31}", "\u{27}", "\u{261d}"]),
    (
        "\u{31}\u{27}\u{308}\u{261d}",
        &["\u{31}", "\u{27}\u{308}", "\u{261d}"],
    ),
    ("\u{31}\u{27}\u{1f3fb}", &["\u{31}", "\u{27}", "\u{1f3fb}"]),
    (
        "\u{31}\u{27}\u{308}\u{1f3fb}",
        &["\u{31}", "\u{27}\u{308}", "\u{1f3fb}"],
    ),
    ("\u{31}\u{27}\u{2764}", &["\u{31}", "\u{27}", "\u{2764}"]),
    (
        "\u{31}\u{27}\u{308}\u{2764}",
        &["\u{31}", "\u{27}\u{308}", "\u{2764}"],
    ),
    ("\u{31}\u{27}\u{1f466}", &["\u{31}", "\u{27}", "\u{1f466}"]),
    (
        "\u{31}\u{27}\u{308}\u{1f466}",
        &["\u{31}", "\u{27}\u{308}", "\u{1f466}"],
    ),
    ...
    ("\u{31}\u{2c}\u{261d}", &["\u{31}", "\u{2c}", "\u{261d}"]),
    (
        "\u{31}\u{2c}\u{308}\u{261d}",
        &["\u{31}", "\u{2c}\u{308}", "\u{261d}"],
    ),
    ("\u{31}\u{2c}\u{1f3fb}", &["\u{31}", "\u{2c}", "\u{1f3fb}"]),
    (
        "\u{31}\u{2c}\u{308}\u{1f3fb}",
        &["\u{31}", "\u{2c}\u{308}", "\u{1f3fb}"],
    ),
    ("\u{31}\u{2c}\u{2764}", &["\u{31}", "\u{2c}", "\u{2764}"]),
    (
        "\u{31}\u{2c}\u{308}\u{2764}",
        &["\u{31}", "\u{2c}\u{308}", "\u{2764}"],
    ),
    ("\u{31}\u{2c}\u{1f466}", &["\u{31}", "\u{2c}", "\u{1f466}"]),
    (
        "\u{31}\u{2c}\u{308}\u{1f466}",
        &["\u{31}", "\u{2c}\u{308}", "\u{1f466}"],
    ),
    ...
    (
        "\u{31}\u{2e}\u{2060}\u{261d}",
        &["\u{31}", "\u{2e}\u{2060}", "\u{261d}"],
    ),
    (
        "\u{31}\u{2e}\u{2060}\u{308}\u{261d}",
        &["\u{31}", "\u{2e}\u{2060}\u{308}", "\u{261d}"],
    ),
    (
        "\u{31}\u{2e}\u{2060}\u{1f3fb}",
        &["\u{31}", "\u{2e}\u{2060}", "\u{1f3fb}"],
    ),
    (
        "\u{31}\u{2e}\u{2060}\u{308}\u{1f3fb}",
        &["\u{31}", "\u{2e}\u{2060}\u{308}", "\u{1f3fb}"],
    ),
    (
        "\u{31}\u{2e}\u{2060}\u{2764}",
        &["\u{31}", "\u{2e}\u{2060}", "\u{2764}"],
    ),
    (
        "\u{31}\u{2e}\u{2060}\u{308}\u{2764}",
        &["\u{31}", "\u{2e}\u{2060}\u{308}", "\u{2764}"],
    ),
    (
        "\u{31}\u{2e}\u{2060}\u{1f466}",
        &["\u{31}", "\u{2e}\u{2060}", "\u{1f466}"],
    ),
    (
        "\u{31}\u{2e}\u{2060}\u{308}\u{1f466}",
        &["\u{31}", "\u{2e}\u{2060}\u{308}", "\u{1f466}"],
    ),
    (

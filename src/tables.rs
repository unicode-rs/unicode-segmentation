...
pub mod word {
    ...
    const word_cat_table: &'static [(char, char, WordCat)] = &[
        ...
        ('\u{f8}', '\u{1ba}', WC_ALetter), ('\u{1bb}', '\u{1bb}', WC_ALetter), ('\u{1bc}',
        '\u{1bf}', WC_ALetter), ('\u{1c0}', '\u{1c3}', WC_ALetter), ('\u{1c4}', '\u{293}',
        WC_ALetter), ('\u{294}', '\u{294}', WC_ALetter), ('\u{295}', '\u{2af}', WC_ALetter),
        ('\u{2b0}', '\u{2c1}', WC_ALetter), ('\u{2c6}', '\u{2d1}', WC_ALetter), ('\u{2d7}',
        '\u{2d7}', WC_MidLetter), ('\u{2e0}', '\u{2e4}', WC_ALetter), ('\u{2ec}', '\u{2ec}',
        WC_ALetter), ('\u{2ee}', '\u{2ee}', WC_ALetter), ('\u{300}', '\u{36f}', WC_Extend),
        ('\u{370}', '\u{373}', WC_ALetter), ('\u{374}', '\u{374}', WC_ALetter), ('\u{376}',
        '\u{377}', WC_ALetter), ('\u{37a}', '\u{37a}', WC_ALetter), ('\u{37b}', '\u{37d}',
        WC_ALetter), ('\u{37e}', '\u{37e}', WC_MidNum), ('\u{37f}', '\u{37f}', WC_ALetter),
        ('\u{386}', '\u{386}', WC_ALetter), ('\u{387}', '\u{387}', WC_MidLetter), ('\u{388}',
        '\u{38a}', WC_ALetter), ('\u{38c}', '\u{38c}', WC_ALetter), ('\u{38e}', '\u{3a1}',
        WC_ALetter), ('\u{3a3}', '\u{3f5}', WC_ALetter), ('\u{3f7}', '\u{481}', WC_ALetter),
        ('\u{483}', '\u{487}', WC_Extend), ('\u{488}', '\u{489}', WC_Extend), ('\u{48a}', '\u{52f}',
        WC_ALetter), ('\u{531}', '\u{556}', WC_ALetter), ('\u{559}', '\u{559}', WC_ALetter),
        ('\u{561}', '\u{587}', WC_ALetter), ('\u{589}', '\u{589}', WC_MidNum), ('\u{591}',
        '\u{5bd}', WC_Extend), ('\u{5bf}', '\u{5bf}', WC_Extend), ('\u{5c1}', '\u{5c2}', WC_Extend),
        ...
        WC_Format), ('\u{620}', '\u{63f}', WC_ALetter), ('\u{640}', '\u{640}', WC_ALetter),
        ('\u{641}', '\u{64a}', WC_ALetter), ('\u{64b}', '\u{65f}', WC_Extend), ('\u{660}',
        '\u{669}', WC_Numeric), ('\u{66b}', '\u{66b}', WC_Numeric), ('\u{66c}', '\u{66c}',
        WC_MidNum), ('\u{66e}', '\u{66f}', WC_ALetter), ('\u{670}', '\u{670}', WC_Extend),
        ('\u{671}', '\u{6d3}', WC_ALetter), ('\u{6d5}', '\u{6d5}', WC_ALetter), ('\u{6d6}',
        '\u{6dc}', WC_Extend), ('\u{6dd}', '\u{6dd}', WC_Format), ('\u{6df}', '\u{6e4}', WC_Extend),
        ('\u{6e5}', '\u{6e6}', WC_ALetter), ('\u{6e7}', '\u{6e8}', WC_Extend), ('\u{6ea}',
        '\u{6ed}', WC_Extend), ('\u{6ee}', '\u{6ef}', WC_ALetter), ('\u{6f0}', '\u{6f9}',
        WC_Numeric), ('\u{6fa}', '\u{6fc}', WC_ALetter), ('\u{6ff}', '\u{6ff}', WC_ALetter),
        ('\u{70f}', '\u{70f}', WC_Format), ('\u{710}', '\u{710}', WC_ALetter), ('\u{711}',
        '\u{711}', WC_Extend), ('\u{712}', '\u{72f}', WC_ALetter), ('\u{730}', '\u{74a}',
        WC_Extend), ('\u{74d}', '\u{7a5}', WC_ALetter), ('\u{7a6}', '\u{7b0}', WC_Extend),
        ('\u{7b1}', '\u{7b1}', WC_ALetter), ('\u{7c0}', '\u{7c9}', WC_Numeric), ('\u{7ca}',
        '\u{7ea}', WC_ALetter), ('\u{7eb}', '\u{7f3}', WC_Extend), ('\u{7f4}', '\u{7f5}',
        WC_ALetter), ('\u{7f8}', '\u{7f8}', WC_MidNum), ('\u{7fa}', '\u{7fa}', WC_ALetter),
        ('\u{800}', '\u{815}', WC_ALetter), ('\u{816}', '\u{819}', WC_Extend), ('\u{81a}',
        '\u{81a}', WC_ALetter), ('\u{81b}', '\u{823}', WC_Extend), ('\u{824}', '\u{824}',
        WC_ALetter), ('\u{825}', '\u{827}', WC_Extend), ('\u{828}', '\u{828}', WC_ALetter),
        ('\u{829}', '\u{82d}', WC_Extend), ('\u{840}', '\u{858}', WC_ALetter), ('\u{859}',
        '\u{85b}', WC_Extend), ('\u{8a0}', '\u{8b2}', WC_ALetter), ('\u{8e4}', '\u{902}',
        WC_Extend), ('\u{903}', '\u{903}', WC_Extend), ('\u{904}', '\u{939}', WC_ALetter),
        ('\u{93a}', '\u{93a}', WC_Extend), ('\u{93b}', '\u{93b}', WC_Extend), ('\u{93c}', '\u{93c}',
        WC_Extend), ('\u{93d}', '\u{93d}', WC_ALetter), ('\u{93e}', '\u{940}', WC_Extend),
        ('\u{941}', '\u{948}', WC_Extend), ('\u{949}', '\u{94c}', WC_Extend), ('\u{94d}', '\u{94d}',
        WC_Extend), ('\u{94e}', '\u{94f}', WC_Extend), ('\u{950}', '\u{950}', WC_ALetter),
        ('\u{951}', '\u{957}', WC_Extend), ('\u{958}', '\u{961}', WC_ALetter), ('\u{962}',
        '\u{963}', WC_Extend), ('\u{966}', '\u{96f}', WC_Numeric), ('\u{971}', '\u{971}',
        WC_ALetter), ('\u{972}', '\u{980}', WC_ALetter), ('\u{981}', '\u{981}', WC_Extend),
        ('\u{982}', '\u{983}', WC_Extend), ('\u{985}', '\u{98c}', WC_ALetter), ('\u{98f}',
        ...
        '\u{9c0}', WC_Extend), ('\u{9c1}', '\u{9c4}', WC_Extend), ('\u{9c7}', '\u{9c8}', WC_Extend),
        ('\u{9cb}', '\u{9cc}', WC_Extend), ('\u{9cd}', '\u{9cd}', WC_Extend), ('\u{9ce}', '\u{9ce}',
        WC_ALetter), ('\u{9d7}', '\u{9d7}', WC_Extend), ('\u{9dc}', '\u{9dd}', WC_ALetter),
        ('\u{9df}', '\u{9e1}', WC_ALetter), ('\u{9e2}', '\u{9e3}', WC_Extend), ('\u{9e6}',
        '\u{9ef}', WC_Numeric), ('\u{9f0}', '\u{9f1}', WC_ALetter), ('\u{a01}', '\u{a02}',
        WC_Extend), ('\u{a03}', '\u{a03}', WC_Extend), ('\u{a05}', '\u{a0a}', WC_ALetter),
        ('\u{a0f}', '\u{a10}', WC_ALetter), ('\u{a13}', '\u{a28}', WC_ALetter), ('\u{a2a}',
        '\u{a30}', WC_ALetter), ('\u{a32}', '\u{a33}', WC_ALetter), ('\u{a35}', '\u{a36}',
        WC_ALetter), ('\u{a38}', '\u{a39}', WC_ALetter), ('\u{a3c}', '\u{a3c}', WC_Extend),
        ('\u{a3e}', '\u{a40}', WC_Extend), ('\u{a41}', '\u{a42}', WC_Extend), ('\u{a47}', '\u{a48}',
        WC_Extend), ('\u{a4b}', '\u{a4d}', WC_Extend), ('\u{a51}', '\u{a51}', WC_Extend),
        ('\u{a59}', '\u{a5c}', WC_ALetter), ('\u{a5e}', '\u{a5e}', WC_ALetter), ('\u{a66}',
        '\u{a6f}', WC_Numeric), ('\u{a70}', '\u{a71}', WC_Extend), ('\u{a72}', '\u{a74}',
        WC_ALetter), ('\u{a75}', '\u{a75}', WC_Extend), ('\u{a81}', '\u{a82}', WC_Extend),
        ('\u{a83}', '\u{a83}', WC_Extend), ('\u{a85}', '\u{a8d}', WC_ALetter), ('\u{a8f}',
        ...
        '\u{ac0}', WC_Extend), ('\u{ac1}', '\u{ac5}', WC_Extend), ('\u{ac7}', '\u{ac8}', WC_Extend),
        ('\u{ac9}', '\u{ac9}', WC_Extend), ('\u{acb}', '\u{acc}', WC_Extend), ('\u{acd}', '\u{acd}',
        WC_Extend), ('\u{ad0}', '\u{ad0}', WC_ALetter), ('\u{ae0}', '\u{ae1}', WC_ALetter),
        ('\u{ae2}', '\u{ae3}', WC_Extend), ('\u{ae6}', '\u{aef}', WC_Numeric), ('\u{b01}',
        '\u{b01}', WC_Extend), ('\u{b02}', '\u{b03}', WC_Extend), ('\u{b05}', '\u{b0c}',
        WC_ALetter), ('\u{b0f}', '\u{b10}', WC_ALetter), ('\u{b13}', '\u{b28}', WC_ALetter),
        ('\u{b2a}', '\u{b30}', WC_ALetter), ('\u{b32}', '\u{b33}', WC_ALetter), ('\u{b35}',
        '\u{b39}', WC_ALetter), ('\u{b3c}', '\u{b3c}', WC_Extend), ('\u{b3d}', '\u{b3d}',
        WC_ALetter), ('\u{b3e}', '\u{b3e}', WC_Extend), ('\u{b3f}', '\u{b3f}', WC_Extend),
        ('\u{b40}', '\u{b40}', WC_Extend), ('\u{b41}', '\u{b44}', WC_Extend), ('\u{b47}', '\u{b48}',
        WC_Extend), ('\u{b4b}', '\u{b4c}', WC_Extend), ('\u{b4d}', '\u{b4d}', WC_Extend),
        ('\u{b56}', '\u{b56}', WC_Extend), ('\u{b57}', '\u{b57}', WC_Extend), ('\u{b5c}', '\u{b5d}',
        WC_ALetter), ('\u{b5f}', '\u{b61}', WC_ALetter), ('\u{b62}', '\u{b63}', WC_Extend),
        ('\u{b66}', '\u{b6f}', WC_Numeric), ('\u{b71}', '\u{b71}', WC_ALetter), ('\u{b82}',
        '\u{b82}', WC_Extend), ('\u{b83}', '\u{b83}', WC_ALetter), ('\u{b85}', '\u{b8a}',
        WC_ALetter), ('\u{b8e}', '\u{b90}', WC_ALetter), ('\u{b92}', '\u{b95}', WC_ALetter),
        ('\u{b99}', '\u{b9a}', WC_ALetter), ('\u{b9c}', '\u{b9c}', WC_ALetter), ('\u{b9e}',
        '\u{b9f}', WC_ALetter), ('\u{ba3}', '\u{ba4}', WC_ALetter), ('\u{ba8}', '\u{baa}',
        WC_ALetter), ('\u{bae}', '\u{bb9}', WC_ALetter), ('\u{bbe}', '\u{bbf}', WC_Extend),
        ('\u{bc0}', '\u{bc0}', WC_Extend), ('\u{bc1}', '\u{bc2}', WC_Extend), ('\u{bc6}', '\u{bc8}',
        WC_Extend), ('\u{bca}', '\u{bcc}', WC_Extend), ('\u{bcd}', '\u{bcd}', WC_Extend),
        ('\u{bd0}', '\u{bd0}', WC_ALetter), ('\u{bd7}', '\u{bd7}', WC_Extend), ('\u{be6}',
        '\u{bef}', WC_Numeric), ('\u{c00}', '\u{c00}', WC_Extend), ('\u{c01}', '\u{c03}',
        WC_Extend), ('\u{c05}', '\u{c0c}', WC_ALetter), ('\u{c0e}', '\u{c10}', WC_ALetter),
        ('\u{c12}', '\u{c28}', WC_ALetter), ('\u{c2a}', '\u{c39}', WC_ALetter), ('\u{c3d}',
        '\u{c3d}', WC_ALetter), ('\u{c3e}', '\u{c40}', WC_Extend), ('\u{c41}', '\u{c44}',
        WC_Extend), ('\u{c46}', '\u{c48}', WC_Extend), ('\u{c4a}', '\u{c4d}', WC_Extend),
        ('\u{c55}', '\u{c56}', WC_Extend), ('\u{c58}', '\u{c59}', WC_ALetter), ('\u{c60}',
        '\u{c61}', WC_ALetter), ('\u{c62}', '\u{c63}', WC_Extend), ('\u{c66}', '\u{c6f}',
        WC_Numeric), ('\u{c81}', '\u{c81}', WC_Extend), ('\u{c82}', '\u{c83}', WC_Extend),
        ...
        ('\u{cbe}', '\u{cbe}', WC_Extend), ('\u{cbf}', '\u{cbf}', WC_Extend), ('\u{cc0}', '\u{cc4}',
        WC_Extend), ('\u{cc6}', '\u{cc6}', WC_Extend), ('\u{cc7}', '\u{cc8}', WC_Extend),
        ('\u{cca}', '\u{ccb}', WC_Extend), ('\u{ccc}', '\u{ccd}', WC_Extend), ('\u{cd5}', '\u{cd6}',
        WC_Extend), ('\u{cde}', '\u{cde}', WC_ALetter), ('\u{ce0}', '\u{ce1}', WC_ALetter),
        ('\u{ce2}', '\u{ce3}', WC_Extend), ('\u{ce6}', '\u{cef}', WC_Numeric), ('\u{cf1}',
        '\u{cf2}', WC_ALetter), ('\u{d01}', '\u{d01}', WC_Extend), ('\u{d02}', '\u{d03}',
        WC_Extend), ('\u{d05}', '\u{d0c}', WC_ALetter), ('\u{d0e}', '\u{d10}', WC_ALetter),
        ('\u{d12}', '\u{d3a}', WC_ALetter), ('\u{d3d}', '\u{d3d}', WC_ALetter), ('\u{d3e}',
        '\u{d40}', WC_Extend), ('\u{d41}', '\u{d44}', WC_Extend), ('\u{d46}', '\u{d48}', WC_Extend),
        ('\u{d4a}', '\u{d4c}', WC_Extend), ('\u{d4d}', '\u{d4d}', WC_Extend), ('\u{d4e}', '\u{d4e}',
        WC_ALetter), ('\u{d57}', '\u{d57}', WC_Extend), ('\u{d60}', '\u{d61}', WC_ALetter),
        ('\u{d62}', '\u{d63}', WC_Extend), ('\u{d66}', '\u{d6f}', WC_Numeric), ('\u{d7a}',
        '\u{d7f}', WC_ALetter), ('\u{d82}', '\u{d83}', WC_Extend), ('\u{d85}', '\u{d96}',
        WC_ALetter), ('\u{d9a}', '\u{db1}', WC_ALetter), ('\u{db3}', '\u{dbb}', WC_ALetter),
        ('\u{dbd}', '\u{dbd}', WC_ALetter), ('\u{dc0}', '\u{dc6}', WC_ALetter), ('\u{dca}',
        '\u{dca}', WC_Extend), ('\u{dcf}', '\u{dd1}', WC_Extend), ('\u{dd2}', '\u{dd4}', WC_Extend),
        ...
        '\u{f7e}', WC_Extend), ('\u{f7f}', '\u{f7f}', WC_Extend), ('\u{f80}', '\u{f84}', WC_Extend),
        ('\u{f86}', '\u{f87}', WC_Extend), ('\u{f88}', '\u{f8c}', WC_ALetter), ('\u{f8d}',
        '\u{f97}', WC_Extend), ('\u{f99}', '\u{fbc}', WC_Extend), ('\u{fc6}', '\u{fc6}', WC_Extend),
        ('\u{102b}', '\u{102c}', WC_Extend), ('\u{102d}', '\u{1030}', WC_Extend), ('\u{1031}',
        '\u{1031}', WC_Extend), ('\u{1032}', '\u{1037}', WC_Extend), ('\u{1038}', '\u{1038}',
        WC_Extend), ('\u{1039}', '\u{103a}', WC_Extend), ('\u{103b}', '\u{103c}', WC_Extend),
        ('\u{103d}', '\u{103e}', WC_Extend), ('\u{1040}', '\u{1049}', WC_Numeric), ('\u{1056}',
        '\u{1057}', WC_Extend), ('\u{1058}', '\u{1059}', WC_Extend), ('\u{105e}', '\u{1060}',
        WC_Extend), ('\u{1062}', '\u{1064}', WC_Extend), ('\u{1067}', '\u{106d}', WC_Extend),
        ('\u{1071}', '\u{1074}', WC_Extend), ('\u{1082}', '\u{1082}', WC_Extend), ('\u{1083}',
        '\u{1084}', WC_Extend), ('\u{1085}', '\u{1086}', WC_Extend), ('\u{1087}', '\u{108c}',
        WC_Extend), ('\u{108d}', '\u{108d}', WC_Extend), ('\u{108f}', '\u{108f}', WC_Extend),
        ('\u{1090}', '\u{1099}', WC_Numeric), ('\u{109a}', '\u{109c}', WC_Extend), ('\u{109d}',
        '\u{109d}', WC_Extend), ('\u{10a0}', '\u{10c5}', WC_ALetter), ('\u{10c7}', '\u{10c7}',
        WC_ALetter), ('\u{10cd}', '\u{10cd}', WC_ALetter), ('\u{10d0}', '\u{10fa}', WC_ALetter),
        ('\u{10fc}', '\u{10fc}', WC_ALetter), ('\u{10fd}', '\u{1248}', WC_ALetter), ('\u{124a}',
        ...
        WC_ALetter), ('\u{13a0}', '\u{13f4}', WC_ALetter), ('\u{1401}', '\u{166c}', WC_ALetter),
        ('\u{166f}', '\u{167f}', WC_ALetter), ('\u{1681}', '\u{169a}', WC_ALetter), ('\u{16a0}',
        '\u{16ea}', WC_ALetter), ('\u{16ee}', '\u{16f0}', WC_ALetter), ('\u{16f1}', '\u{16f8}',
        WC_ALetter), ('\u{1700}', '\u{170c}', WC_ALetter), ('\u{170e}', '\u{1711}', WC_ALetter),
        ('\u{1712}', '\u{1714}', WC_Extend), ('\u{1720}', '\u{1731}', WC_ALetter), ('\u{1732}',
        '\u{1734}', WC_Extend), ('\u{1740}', '\u{1751}', WC_ALetter), ('\u{1752}', '\u{1753}',
        WC_Extend), ('\u{1760}', '\u{176c}', WC_ALetter), ('\u{176e}', '\u{1770}', WC_ALetter),
        ('\u{1772}', '\u{1773}', WC_Extend), ('\u{17b4}', '\u{17b5}', WC_Extend), ('\u{17b6}',
        '\u{17b6}', WC_Extend), ('\u{17b7}', '\u{17bd}', WC_Extend), ('\u{17be}', '\u{17c5}',
        WC_Extend), ('\u{17c6}', '\u{17c6}', WC_Extend), ('\u{17c7}', '\u{17c8}', WC_Extend),
        ('\u{17c9}', '\u{17d3}', WC_Extend), ('\u{17dd}', '\u{17dd}', WC_Extend), ('\u{17e0}',
        '\u{17e9}', WC_Numeric), ('\u{180b}', '\u{180d}', WC_Extend), ('\u{180e}', '\u{180e}',
        WC_Format), ('\u{1810}', '\u{1819}', WC_Numeric), ('\u{1820}', '\u{1842}', WC_ALetter),
        ('\u{1843}', '\u{1843}', WC_ALetter), ('\u{1844}', '\u{1877}', WC_ALetter), ('\u{1880}',
        '\u{18a8}', WC_ALetter), ('\u{18a9}', '\u{18a9}', WC_Extend), ('\u{18aa}', '\u{18aa}',
        WC_ALetter), ('\u{18b0}', '\u{18f5}', WC_ALetter), ('\u{1900}', '\u{191e}', WC_ALetter),
        ('\u{1920}', '\u{1922}', WC_Extend), ('\u{1923}', '\u{1926}', WC_Extend), ('\u{1927}',
        '\u{1928}', WC_Extend), ('\u{1929}', '\u{192b}', WC_Extend), ('\u{1930}', '\u{1931}',
        WC_Extend), ('\u{1932}', '\u{1932}', WC_Extend), ('\u{1933}', '\u{1938}', WC_Extend),
        ('\u{1939}', '\u{193b}', WC_Extend), ('\u{1946}', '\u{194f}', WC_Numeric), ('\u{19b0}',
        '\u{19c0}', WC_Extend), ('\u{19c8}', '\u{19c9}', WC_Extend), ('\u{19d0}', '\u{19d9}',
        WC_Numeric), ('\u{1a00}', '\u{1a16}', WC_ALetter), ('\u{1a17}', '\u{1a18}', WC_Extend),
        ('\u{1a19}', '\u{1a1a}', WC_Extend), ('\u{1a1b}', '\u{1a1b}', WC_Extend), ('\u{1a55}',
        '\u{1a55}', WC_Extend), ('\u{1a56}', '\u{1a56}', WC_Extend), ('\u{1a57}', '\u{1a57}',
        WC_Extend), ('\u{1a58}', '\u{1a5e}', WC_Extend), ('\u{1a60}', '\u{1a60}', WC_Extend),
        ('\u{1a61}', '\u{1a61}', WC_Extend), ('\u{1a62}', '\u{1a62}', WC_Extend), ('\u{1a63}',
        '\u{1a64}', WC_Extend), ('\u{1a65}', '\u{1a6c}', WC_Extend), ('\u{1a6d}', '\u{1a72}',
        WC_Extend), ('\u{1a73}', '\u{1a7c}', WC_Extend), ('\u{1a7f}', '\u{1a7f}', WC_Extend),
        ('\u{1a80}', '\u{1a89}', WC_Numeric), ('\u{1a90}', '\u{1a99}', WC_Numeric), ('\u{1ab0}',
        '\u{1abd}', WC_Extend), ('\u{1abe}', '\u{1abe}', WC_Extend), ('\u{1b00}', '\u{1b03}',
        WC_Extend), ('\u{1b04}', '\u{1b04}', WC_Extend), ('\u{1b05}', '\u{1b33}', WC_ALetter),
        ('\u{1b34}', '\u{1b34}', WC_Extend), ('\u{1b35}', '\u{1b35}', WC_Extend), ('\u{1b36}',
        '\u{1b3a}', WC_Extend), ('\u{1b3b}', '\u{1b3b}', WC_Extend), ('\u{1b3c}', '\u{1b3c}',
        WC_Extend), ('\u{1b3d}', '\u{1b41}', WC_Extend), ('\u{1b42}', '\u{1b42}', WC_Extend),
        ('\u{1b43}', '\u{1b44}', WC_Extend), ('\u{1b45}', '\u{1b4b}', WC_ALetter), ('\u{1b50}',
        '\u{1b59}', WC_Numeric), ('\u{1b6b}', '\u{1b73}', WC_Extend), ('\u{1b80}', '\u{1b81}',
        WC_Extend), ('\u{1b82}', '\u{1b82}', WC_Extend), ('\u{1b83}', '\u{1ba0}', WC_ALetter),
        ('\u{1ba1}', '\u{1ba1}', WC_Extend), ('\u{1ba2}', '\u{1ba5}', WC_Extend), ('\u{1ba6}',
        '\u{1ba7}', WC_Extend), ('\u{1ba8}', '\u{1ba9}', WC_Extend), ('\u{1baa}', '\u{1baa}',
        WC_Extend), ('\u{1bab}', '\u{1bad}', WC_Extend), ('\u{1bae}', '\u{1baf}', WC_ALetter),
        ('\u{1bb0}', '\u{1bb9}', WC_Numeric), ('\u{1bba}', '\u{1be5}', WC_ALetter), ('\u{1be6}',
        '\u{1be6}', WC_Extend), ('\u{1be7}', '\u{1be7}', WC_Extend), ('\u{1be8}', '\u{1be9}',
        WC_Extend), ('\u{1bea}', '\u{1bec}', WC_Extend), ('\u{1bed}', '\u{1bed}', WC_Extend),
        ('\u{1bee}', '\u{1bee}', WC_Extend), ('\u{1bef}', '\u{1bf1}', WC_Extend), ('\u{1bf2}',
        '\u{1bf3}', WC_Extend), ('\u{1c00}', '\u{1c23}', WC_ALetter), ('\u{1c24}', '\u{1c2b}',
        WC_Extend), ('\u{1c2c}', '\u{1c33}', WC_Extend), ('\u{1c34}', '\u{1c35}', WC_Extend),
        ('\u{1c36}', '\u{1c37}', WC_Extend), ('\u{1c40}', '\u{1c49}', WC_Numeric), ('\u{1c4d}',
        '\u{1c4f}', WC_ALetter), ('\u{1c50}', '\u{1c59}', WC_Numeric), ('\u{1c5a}', '\u{1c77}',
        WC_ALetter), ('\u{1c78}', '\u{1c7d}', WC_ALetter), ('\u{1cd0}', '\u{1cd2}', WC_Extend),
        ('\u{1cd4}', '\u{1ce0}', WC_Extend), ('\u{1ce1}', '\u{1ce1}', WC_Extend), ('\u{1ce2}',
        '\u{1ce8}', WC_Extend), ('\u{1ce9}', '\u{1cec}', WC_ALetter), ('\u{1ced}', '\u{1ced}',
        WC_Extend), ('\u{1cee}', '\u{1cf1}', WC_ALetter), ('\u{1cf2}', '\u{1cf3}', WC_Extend),
        ('\u{1cf4}', '\u{1cf4}', WC_Extend), ('\u{1cf5}', '\u{1cf6}', WC_ALetter), ('\u{1cf8}',
        '\u{1cf9}', WC_Extend), ('\u{1d00}', '\u{1d2b}', WC_ALetter), ('\u{1d2c}', '\u{1d6a}',
        WC_ALetter), ('\u{1d6b}', '\u{1d77}', WC_ALetter), ('\u{1d78}', '\u{1d78}', WC_ALetter),
        ('\u{1d79}', '\u{1d9a}', WC_ALetter), ('\u{1d9b}', '\u{1dbf}', WC_ALetter), ('\u{1dc0}',
        '\u{1df5}', WC_Extend), ('\u{1dfc}', '\u{1dff}', WC_Extend), ('\u{1e00}', '\u{1f15}',
        ...
        '\u{200d}', WC_Extend), ('\u{200e}', '\u{200f}', WC_Format), ('\u{2018}', '\u{2018}',
        WC_MidNumLet), ('\u{2019}', '\u{2019}', WC_MidNumLet), ('\u{2024}', '\u{2024}',
        WC_MidNumLet), ('\u{2027}', '\u{2027}', WC_MidLetter), ('\u{2028}', '\u{2028}', WC_Newline),
        ('\u{2029}', '\u{2029}', WC_Newline), ('\u{202a}', '\u{202e}', WC_Format), ('\u{203f}',
        ...
        '\u{209c}', WC_ALetter), ('\u{20d0}', '\u{20dc}', WC_Extend), ('\u{20dd}', '\u{20e0}',
        WC_Extend), ('\u{20e1}', '\u{20e1}', WC_Extend), ('\u{20e2}', '\u{20e4}', WC_Extend),
        ('\u{20e5}', '\u{20f0}', WC_Extend), ('\u{2102}', '\u{2102}', WC_ALetter), ('\u{2107}',
        '\u{2107}', WC_ALetter), ('\u{210a}', '\u{2113}', WC_ALetter), ('\u{2115}', '\u{2115}',
        WC_ALetter), ('\u{2119}', '\u{211d}', WC_ALetter), ('\u{2124}', '\u{2124}', WC_ALetter),
        ('\u{2126}', '\u{2126}', WC_ALetter), ('\u{2128}', '\u{2128}', WC_ALetter), ('\u{212a}',
        '\u{212d}', WC_ALetter), ('\u{212f}', '\u{2134}', WC_ALetter), ('\u{2135}', '\u{2138}',
        WC_ALetter), ('\u{2139}', '\u{2139}', WC_ALetter), ('\u{213c}', '\u{213f}', WC_ALetter),
        ('\u{2145}', '\u{2149}', WC_ALetter), ('\u{214e}', '\u{214e}', WC_ALetter), ('\u{2160}',
        '\u{2182}', WC_ALetter), ('\u{2183}', '\u{2184}', WC_ALetter), ('\u{2185}', '\u{2188}',
        WC_ALetter), ('\u{24b6}', '\u{24e9}', WC_ALetter), ('\u{2c00}', '\u{2c2e}', WC_ALetter),
        ('\u{2c30}', '\u{2c5e}', WC_ALetter), ('\u{2c60}', '\u{2c7b}', WC_ALetter), ('\u{2c7c}',
        '\u{2c7d}', WC_ALetter), ('\u{2c7e}', '\u{2ce4}', WC_ALetter), ('\u{2ceb}', '\u{2cee}',
        ...
        '\u{2e2f}', WC_ALetter), ('\u{3005}', '\u{3005}', WC_ALetter), ('\u{302a}', '\u{302d}',
        WC_Extend), ('\u{302e}', '\u{302f}', WC_Extend), ('\u{3031}', '\u{3035}', WC_Katakana),
        ('\u{303b}', '\u{303b}', WC_ALetter), ('\u{303c}', '\u{303c}', WC_ALetter), ('\u{3099}',
        '\u{309a}', WC_Extend), ('\u{309b}', '\u{309c}', WC_Katakana), ('\u{30a0}', '\u{30a0}',
        WC_Katakana), ('\u{30a1}', '\u{30fa}', WC_Katakana), ('\u{30fc}', '\u{30fe}', WC_Katakana),
        ('\u{30ff}', '\u{30ff}', WC_Katakana), ('\u{3105}', '\u{312d}', WC_ALetter), ('\u{3131}',
        '\u{318e}', WC_ALetter), ('\u{31a0}', '\u{31ba}', WC_ALetter), ('\u{31f0}', '\u{31ff}',
        WC_Katakana), ('\u{32d0}', '\u{32fe}', WC_Katakana), ('\u{3300}', '\u{3357}', WC_Katakana),
        ('\u{a000}', '\u{a014}', WC_ALetter), ('\u{a015}', '\u{a015}', WC_ALetter), ('\u{a016}',
        '\u{a48c}', WC_ALetter), ('\u{a4d0}', '\u{a4f7}', WC_ALetter), ('\u{a4f8}', '\u{a4fd}',
        WC_ALetter), ('\u{a500}', '\u{a60b}', WC_ALetter), ('\u{a60c}', '\u{a60c}', WC_ALetter),
        ('\u{a610}', '\u{a61f}', WC_ALetter), ('\u{a620}', '\u{a629}', WC_Numeric), ('\u{a62a}',
        '\u{a62b}', WC_ALetter), ('\u{a640}', '\u{a66d}', WC_ALetter), ('\u{a66e}', '\u{a66e}',
        WC_ALetter), ('\u{a66f}', '\u{a66f}', WC_Extend), ('\u{a670}', '\u{a672}', WC_Extend),
        ('\u{a674}', '\u{a67d}', WC_Extend), ('\u{a67f}', '\u{a67f}', WC_ALetter), ('\u{a680}',
        '\u{a69b}', WC_ALetter), ('\u{a69c}', '\u{a69d}', WC_ALetter), ('\u{a69f}', '\u{a69f}',
        WC_Extend), ('\u{a6a0}', '\u{a6e5}', WC_ALetter), ('\u{a6e6}', '\u{a6ef}', WC_ALetter),
        ('\u{a6f0}', '\u{a6f1}', WC_Extend), ('\u{a717}', '\u{a71f}', WC_ALetter), ('\u{a722}',
        '\u{a76f}', WC_ALetter), ('\u{a770}', '\u{a770}', WC_ALetter), ('\u{a771}', '\u{a787}',
        WC_ALetter), ('\u{a788}', '\u{a788}', WC_ALetter), ('\u{a78b}', '\u{a78e}', WC_ALetter),
        ('\u{a790}', '\u{a7ad}', WC_ALetter), ('\u{a7b0}', '\u{a7b1}', WC_ALetter), ('\u{a7f7}',
        '\u{a7f7}', WC_ALetter), ('\u{a7f8}', '\u{a7f9}', WC_ALetter), ('\u{a7fa}', '\u{a7fa}',
        WC_ALetter), ('\u{a7fb}', '\u{a801}', WC_ALetter), ('\u{a802}', '\u{a802}', WC_Extend),
        ('\u{a803}', '\u{a805}', WC_ALetter), ('\u{a806}', '\u{a806}', WC_Extend), ('\u{a807}',
        '\u{a80a}', WC_ALetter), ('\u{a80b}', '\u{a80b}', WC_Extend), ('\u{a80c}', '\u{a822}',
        WC_ALetter), ('\u{a823}', '\u{a824}', WC_Extend), ('\u{a825}', '\u{a826}', WC_Extend),
        ('\u{a827}', '\u{a827}', WC_Extend), ('\u{a840}', '\u{a873}', WC_ALetter), ('\u{a880}',
        '\u{a881}', WC_Extend), ('\u{a882}', '\u{a8b3}', WC_ALetter), ('\u{a8b4}', '\u{a8c3}',
        WC_Extend), ('\u{a8c4}', '\u{a8c4}', WC_Extend), ('\u{a8d0}', '\u{a8d9}', WC_Numeric),
        ('\u{a8e0}', '\u{a8f1}', WC_Extend), ('\u{a8f2}', '\u{a8f7}', WC_ALetter), ('\u{a8fb}',
        '\u{a8fb}', WC_ALetter), ('\u{a900}', '\u{a909}', WC_Numeric), ('\u{a90a}', '\u{a925}',
        WC_ALetter), ('\u{a926}', '\u{a92d}', WC_Extend), ('\u{a930}', '\u{a946}', WC_ALetter),
        ('\u{a947}', '\u{a951}', WC_Extend), ('\u{a952}', '\u{a953}', WC_Extend), ('\u{a960}',
        '\u{a97c}', WC_ALetter), ('\u{a980}', '\u{a982}', WC_Extend), ('\u{a983}', '\u{a983}',
        WC_Extend), ('\u{a984}', '\u{a9b2}', WC_ALetter), ('\u{a9b3}', '\u{a9b3}', WC_Extend),
        ('\u{a9b4}', '\u{a9b5}', WC_Extend), ('\u{a9b6}', '\u{a9b9}', WC_Extend), ('\u{a9ba}',
        '\u{a9bb}', WC_Extend), ('\u{a9bc}', '\u{a9bc}', WC_Extend), ('\u{a9bd}', '\u{a9c0}',
        WC_Extend), ('\u{a9cf}', '\u{a9cf}', WC_ALetter), ('\u{a9d0}', '\u{a9d9}', WC_Numeric),
        ('\u{a9e5}', '\u{a9e5}', WC_Extend), ('\u{a9f0}', '\u{a9f9}', WC_Numeric), ('\u{aa00}',
        '\u{aa28}', WC_ALetter), ('\u{aa29}', '\u{aa2e}', WC_Extend), ('\u{aa2f}', '\u{aa30}',
        WC_Extend), ('\u{aa31}', '\u{aa32}', WC_Extend), ('\u{aa33}', '\u{aa34}', WC_Extend),
        ('\u{aa35}', '\u{aa36}', WC_Extend), ('\u{aa40}', '\u{aa42}', WC_ALetter), ('\u{aa43}',
        '\u{aa43}', WC_Extend), ('\u{aa44}', '\u{aa4b}', WC_ALetter), ('\u{aa4c}', '\u{aa4c}',
        WC_Extend), ('\u{aa4d}', '\u{aa4d}', WC_Extend), ('\u{aa50}', '\u{aa59}', WC_Numeric),
        ('\u{aa7b}', '\u{aa7b}', WC_Extend), ('\u{aa7c}', '\u{aa7c}', WC_Extend), ('\u{aa7d}',
        ...
        '\u{aaeb}', WC_Extend), ('\u{aaec}', '\u{aaed}', WC_Extend), ('\u{aaee}', '\u{aaef}',
        WC_Extend), ('\u{aaf2}', '\u{aaf2}', WC_ALetter), ('\u{aaf3}', '\u{aaf4}', WC_ALetter),
        ('\u{aaf5}', '\u{aaf5}', WC_Extend), ('\u{aaf6}', '\u{aaf6}', WC_Extend), ('\u{ab01}',
        '\u{ab06}', WC_ALetter), ('\u{ab09}', '\u{ab0e}', WC_ALetter), ('\u{ab11}', '\u{ab16}',
        WC_ALetter), ('\u{ab20}', '\u{ab26}', WC_ALetter), ('\u{ab28}', '\u{ab2e}', WC_ALetter),
        ('\u{ab30}', '\u{ab5a}', WC_ALetter), ('\u{ab5c}', '\u{ab5f}', WC_ALetter), ('\u{ab64}',
        '\u{ab65}', WC_ALetter), ('\u{abc0}', '\u{abe2}', WC_ALetter), ('\u{abe3}', '\u{abe4}',
        WC_Extend), ('\u{abe5}', '\u{abe5}', WC_Extend), ('\u{abe6}', '\u{abe7}', WC_Extend),
        ('\u{abe8}', '\u{abe8}', WC_Extend), ('\u{abe9}', '\u{abea}', WC_Extend), ('\u{abec}',
        '\u{abec}', WC_Extend), ('\u{abed}', '\u{abed}', WC_Extend), ('\u{abf0}', '\u{abf9}',
        WC_Numeric), ('\u{ac00}', '\u{d7a3}', WC_ALetter), ('\u{d7b0}', '\u{d7c6}', WC_ALetter),
        ('\u{d7cb}', '\u{d7fb}', WC_ALetter), ('\u{fb00}', '\u{fb06}', WC_ALetter), ('\u{fb13}',
        '\u{fb17}', WC_ALetter), ('\u{fb1d}', '\u{fb1d}', WC_Hebrew_Letter), ('\u{fb1e}',
        '\u{fb1e}', WC_Extend), ('\u{fb1f}', '\u{fb28}', WC_Hebrew_Letter), ('\u{fb2a}', '\u{fb36}',
        ...
        WC_MidLetter), ('\u{fe14}', '\u{fe14}', WC_MidNum), ('\u{fe20}', '\u{fe2d}', WC_Extend),
        ...
        ('\u{ff41}', '\u{ff5a}', WC_ALetter), ('\u{ff66}', '\u{ff6f}', WC_Katakana), ('\u{ff70}',
        '\u{ff70}', WC_Katakana), ('\u{ff71}', '\u{ff9d}', WC_Katakana), ('\u{ff9e}', '\u{ff9f}',
        WC_Extend), ('\u{ffa0}', '\u{ffbe}', WC_ALetter), ('\u{ffc2}', '\u{ffc7}', WC_ALetter),
        ('\u{ffca}', '\u{ffcf}', WC_ALetter), ('\u{ffd2}', '\u{ffd7}', WC_ALetter), ('\u{ffda}',
        '\u{ffdc}', WC_ALetter), ('\u{fff9}', '\u{fffb}', WC_Format), ('\u{10000}', '\u{1000b}',
        WC_ALetter), ('\u{1000d}', '\u{10026}', WC_ALetter), ('\u{10028}', '\u{1003a}', WC_ALetter),
        ...
        WC_Extend), ('\u{10300}', '\u{1031f}', WC_ALetter), ('\u{10330}', '\u{10340}', WC_ALetter),
        ('\u{10341}', '\u{10341}', WC_ALetter), ('\u{10342}', '\u{10349}', WC_ALetter),
        ('\u{1034a}', '\u{1034a}', WC_ALetter), ('\u{10350}', '\u{10375}', WC_ALetter),
        ...
        WC_ALetter), ('\u{10400}', '\u{1044f}', WC_ALetter), ('\u{10450}', '\u{1049d}', WC_ALetter),
        ('\u{104a0}', '\u{104a9}', WC_Numeric), ('\u{10500}', '\u{10527}', WC_ALetter),
        ...
        ('\u{10c00}', '\u{10c48}', WC_ALetter), ('\u{11000}', '\u{11000}', WC_Extend), ('\u{11001}',
        '\u{11001}', WC_Extend), ('\u{11002}', '\u{11002}', WC_Extend), ('\u{11003}', '\u{11037}',
        WC_ALetter), ('\u{11038}', '\u{11046}', WC_Extend), ('\u{11066}', '\u{1106f}', WC_Numeric),
        ('\u{1107f}', '\u{11081}', WC_Extend), ('\u{11082}', '\u{11082}', WC_Extend), ('\u{11083}',
        '\u{110af}', WC_ALetter), ('\u{110b0}', '\u{110b2}', WC_Extend), ('\u{110b3}', '\u{110b6}',
        WC_Extend), ('\u{110b7}', '\u{110b8}', WC_Extend), ('\u{110b9}', '\u{110ba}', WC_Extend),
        ('\u{110bd}', '\u{110bd}', WC_Format), ('\u{110d0}', '\u{110e8}', WC_ALetter), ('\u{110f0}',
        '\u{110f9}', WC_Numeric), ('\u{11100}', '\u{11102}', WC_Extend), ('\u{11103}', '\u{11126}',
        WC_ALetter), ('\u{11127}', '\u{1112b}', WC_Extend), ('\u{1112c}', '\u{1112c}', WC_Extend),
        ('\u{1112d}', '\u{11134}', WC_Extend), ('\u{11136}', '\u{1113f}', WC_Numeric), ('\u{11150}',
        '\u{11172}', WC_ALetter), ('\u{11173}', '\u{11173}', WC_Extend), ('\u{11176}', '\u{11176}',
        WC_ALetter), ('\u{11180}', '\u{11181}', WC_Extend), ('\u{11182}', '\u{11182}', WC_Extend),
        ('\u{11183}', '\u{111b2}', WC_ALetter), ('\u{111b3}', '\u{111b5}', WC_Extend), ('\u{111b6}',
        '\u{111be}', WC_Extend), ('\u{111bf}', '\u{111c0}', WC_Extend), ('\u{111c1}', '\u{111c4}',
        WC_ALetter), ('\u{111d0}', '\u{111d9}', WC_Numeric), ('\u{111da}', '\u{111da}', WC_ALetter),
        ('\u{11200}', '\u{11211}', WC_ALetter), ('\u{11213}', '\u{1122b}', WC_ALetter),
        ('\u{1122c}', '\u{1122e}', WC_Extend), ('\u{1122f}', '\u{11231}', WC_Extend), ('\u{11232}',
        '\u{11233}', WC_Extend), ('\u{11234}', '\u{11234}', WC_Extend), ('\u{11235}', '\u{11235}',
        WC_Extend), ('\u{11236}', '\u{11237}', WC_Extend), ('\u{112b0}', '\u{112de}', WC_ALetter),
        ('\u{112df}', '\u{112df}', WC_Extend), ('\u{112e0}', '\u{112e2}', WC_Extend), ('\u{112e3}',
        '\u{112ea}', WC_Extend), ('\u{112f0}', '\u{112f9}', WC_Numeric), ('\u{11301}', '\u{11301}',
        WC_Extend), ('\u{11302}', '\u{11303}', WC_Extend), ('\u{11305}', '\u{1130c}', WC_ALetter),
        ('\u{1130f}', '\u{11310}', WC_ALetter), ('\u{11313}', '\u{11328}', WC_ALetter),
        ('\u{1132a}', '\u{11330}', WC_ALetter), ('\u{11332}', '\u{11333}', WC_ALetter),
        ('\u{11335}', '\u{11339}', WC_ALetter), ('\u{1133c}', '\u{1133c}', WC_Extend), ('\u{1133d}',
        '\u{1133d}', WC_ALetter), ('\u{1133e}', '\u{1133f}', WC_Extend), ('\u{11340}', '\u{11340}',
        WC_Extend), ('\u{11341}', '\u{11344}', WC_Extend), ('\u{11347}', '\u{11348}', WC_Extend),
        ('\u{1134b}', '\u{1134d}', WC_Extend), ('\u{11357}', '\u{11357}', WC_Extend), ('\u{1135d}',
        '\u{11361}', WC_ALetter), ('\u{11362}', '\u{11363}', WC_Extend), ('\u{11366}', '\u{1136c}',
        WC_Extend), ('\u{11370}', '\u{11374}', WC_Extend), ('\u{11480}', '\u{114af}', WC_ALetter),
        ('\u{114b0}', '\u{114b2}', WC_Extend), ('\u{114b3}', '\u{114b8}', WC_Extend), ('\u{114b9}',
        '\u{114b9}', WC_Extend), ('\u{114ba}', '\u{114ba}', WC_Extend), ('\u{114bb}', '\u{114be}',
        WC_Extend), ('\u{114bf}', '\u{114c0}', WC_Extend), ('\u{114c1}', '\u{114c1}', WC_Extend),
        ('\u{114c2}', '\u{114c3}', WC_Extend), ('\u{114c4}', '\u{114c5}', WC_ALetter), ('\u{114c7}',
        '\u{114c7}', WC_ALetter), ('\u{114d0}', '\u{114d9}', WC_Numeric), ('\u{11580}', '\u{115ae}',
        WC_ALetter), ('\u{115af}', '\u{115b1}', WC_Extend), ('\u{115b2}', '\u{115b5}', WC_Extend),
        ('\u{115b8}', '\u{115bb}', WC_Extend), ('\u{115bc}', '\u{115bd}', WC_Extend), ('\u{115be}',
        '\u{115be}', WC_Extend), ('\u{115bf}', '\u{115c0}', WC_Extend), ('\u{11600}', '\u{1162f}',
        WC_ALetter), ('\u{11630}', '\u{11632}', WC_Extend), ('\u{11633}', '\u{1163a}', WC_Extend),
        ('\u{1163b}', '\u{1163c}', WC_Extend), ('\u{1163d}', '\u{1163d}', WC_Extend), ('\u{1163e}',
        '\u{1163e}', WC_Extend), ('\u{1163f}', '\u{11640}', WC_Extend), ('\u{11644}', '\u{11644}',
        WC_ALetter), ('\u{11650}', '\u{11659}', WC_Numeric), ('\u{11680}', '\u{116aa}', WC_ALetter),
        ('\u{116ab}', '\u{116ab}', WC_Extend), ('\u{116ac}', '\u{116ac}', WC_Extend), ('\u{116ad}',
        '\u{116ad}', WC_Extend), ('\u{116ae}', '\u{116af}', WC_Extend), ('\u{116b0}', '\u{116b5}',
        WC_Extend), ('\u{116b6}', '\u{116b6}', WC_Extend), ('\u{116b7}', '\u{116b7}', WC_Extend),
        ('\u{116c0}', '\u{116c9}', WC_Numeric), ('\u{118a0}', '\u{118df}', WC_ALetter),
        ('\u{118e0}', '\u{118e9}', WC_Numeric), ('\u{118ff}', '\u{118ff}', WC_ALetter),
        ('\u{11ac0}', '\u{11af8}', WC_ALetter), ('\u{12000}', '\u{12398}', WC_ALetter),
        ('\u{12400}', '\u{1246e}', WC_ALetter), ('\u{13000}', '\u{1342e}', WC_ALetter),
        ...
        '\u{16f9f}', WC_ALetter), ('\u{1b000}', '\u{1b000}', WC_Katakana), ('\u{1bc00}',
        ...
        ('\u{1bca0}', '\u{1bca3}', WC_Format), ('\u{1d165}', '\u{1d166}', WC_Extend), ('\u{1d167}',
        ...
        ('\u{1e800}', '\u{1e8c4}', WC_ALetter), ('\u{1e8d0}', '\u{1e8d6}', WC_Extend), ('\u{1ee00}',
        ...
        ('\u{e0001}', '\u{e0001}', WC_Format), ('\u{e0020}', '\u{e007f}', WC_Format), ('\u{e0100}',
        '\u{e01ef}', WC_Extend)
    ];

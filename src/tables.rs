...
pub mod sentence {
    ...
    const sentence_cat_table: &'static [(char, char, SentenceCat)] = &[
        ...
        ('\u{840}', '\u{858}', SC_OLetter), ('\u{859}', '\u{85b}', SC_Extend), ('\u{8a0}',
        '\u{8b4}', SC_OLetter), ('\u{8b6}', '\u{8bd}', SC_OLetter), ('\u{8d4}', '\u{8e1}',
        SC_Extend), ('\u{8e2}', '\u{8e2}', SC_Format), ('\u{8e3}', '\u{903}', SC_Extend),
        ...
        '\u{9ef}', SC_Numeric), ('\u{9f0}', '\u{9f1}', SC_OLetter), ('\u{a01}', '\u{a03}',
        SC_Extend), ('\u{a05}', '\u{a0a}', SC_OLetter), ('\u{a0f}', '\u{a10}', SC_OLetter),
        ('\u{a13}', '\u{a28}', SC_OLetter), ('\u{a2a}', '\u{a30}', SC_OLetter), ('\u{a32}',
        '\u{a33}', SC_OLetter), ('\u{a35}', '\u{a36}', SC_OLetter), ('\u{a38}', '\u{a39}',
        SC_OLetter), ('\u{a3c}', '\u{a3c}', SC_Extend), ('\u{a3e}', '\u{a42}', SC_Extend),
        ('\u{a47}', '\u{a48}', SC_Extend), ('\u{a4b}', '\u{a4d}', SC_Extend), ('\u{a51}', '\u{a51}',
        SC_Extend), ('\u{a59}', '\u{a5c}', SC_OLetter), ('\u{a5e}', '\u{a5e}', SC_OLetter),
        ('\u{a66}', '\u{a6f}', SC_Numeric), ('\u{a70}', '\u{a71}', SC_Extend), ('\u{a72}',
        '\u{a74}', SC_OLetter), ('\u{a75}', '\u{a75}', SC_Extend), ('\u{a81}', '\u{a83}',
        SC_Extend), ('\u{a85}', '\u{a8d}', SC_OLetter), ('\u{a8f}', '\u{a91}', SC_OLetter),
        ('\u{a93}', '\u{aa8}', SC_OLetter), ('\u{aaa}', '\u{ab0}', SC_OLetter), ('\u{ab2}',
        '\u{ab3}', SC_OLetter), ('\u{ab5}', '\u{ab9}', SC_OLetter), ('\u{abc}', '\u{abc}',
        SC_Extend), ('\u{abd}', '\u{abd}', SC_OLetter), ('\u{abe}', '\u{ac5}', SC_Extend),
        ('\u{ac7}', '\u{ac9}', SC_Extend), ('\u{acb}', '\u{acd}', SC_Extend), ('\u{ad0}', '\u{ad0}',
        SC_OLetter), ('\u{ae0}', '\u{ae1}', SC_OLetter), ('\u{ae2}', '\u{ae3}', SC_Extend),
        ('\u{ae6}', '\u{aef}', SC_Numeric), ('\u{af9}', '\u{af9}', SC_OLetter), ('\u{b01}',
        '\u{b03}', SC_Extend), ('\u{b05}', '\u{b0c}', SC_OLetter), ('\u{b0f}', '\u{b10}',
        SC_OLetter), ('\u{b13}', '\u{b28}', SC_OLetter), ('\u{b2a}', '\u{b30}', SC_OLetter),
        ('\u{b32}', '\u{b33}', SC_OLetter), ('\u{b35}', '\u{b39}', SC_OLetter), ('\u{b3c}',
        '\u{b3c}', SC_Extend), ('\u{b3d}', '\u{b3d}', SC_OLetter), ('\u{b3e}', '\u{b44}',
        SC_Extend), ('\u{b47}', '\u{b48}', SC_Extend), ('\u{b4b}', '\u{b4d}', SC_Extend),
        ...
        '\u{c03}', SC_Extend), ('\u{c05}', '\u{c0c}', SC_OLetter), ('\u{c0e}', '\u{c10}',
        ...
        '\u{cf2}', SC_OLetter), ('\u{d01}', '\u{d03}', SC_Extend), ('\u{d05}', '\u{d0c}',
        SC_OLetter), ('\u{d0e}', '\u{d10}', SC_OLetter), ('\u{d12}', '\u{d3a}', SC_OLetter),
        ('\u{d3d}', '\u{d3d}', SC_OLetter), ('\u{d3e}', '\u{d44}', SC_Extend), ('\u{d46}',
        '\u{d48}', SC_Extend), ('\u{d4a}', '\u{d4d}', SC_Extend), ('\u{d4e}', '\u{d4e}',
        SC_OLetter), ('\u{d54}', '\u{d56}', SC_OLetter), ('\u{d57}', '\u{d57}', SC_Extend),
        ('\u{d5f}', '\u{d61}', SC_OLetter), ('\u{d62}', '\u{d63}', SC_Extend), ('\u{d66}',
        '\u{d6f}', SC_Numeric), ('\u{d7a}', '\u{d7f}', SC_OLetter), ('\u{d82}', '\u{d83}',
        SC_Extend), ('\u{d85}', '\u{d96}', SC_OLetter), ('\u{d9a}', '\u{db1}', SC_OLetter),
        ('\u{db3}', '\u{dbb}', SC_OLetter), ('\u{dbd}', '\u{dbd}', SC_OLetter), ('\u{dc0}',
        '\u{dc6}', SC_OLetter), ('\u{dca}', '\u{dca}', SC_Extend), ('\u{dcf}', '\u{dd4}',
        SC_Extend), ('\u{dd6}', '\u{dd6}', SC_Extend), ('\u{dd8}', '\u{ddf}', SC_Extend),
        ('\u{de6}', '\u{def}', SC_Numeric), ('\u{df2}', '\u{df3}', SC_Extend), ('\u{e01}',
        '\u{e30}', SC_OLetter), ('\u{e31}', '\u{e31}', SC_Extend), ('\u{e32}', '\u{e33}',
        SC_OLetter), ('\u{e34}', '\u{e3a}', SC_Extend), ('\u{e40}', '\u{e46}', SC_OLetter),
        ('\u{e47}', '\u{e4e}', SC_Extend), ('\u{e50}', '\u{e59}', SC_Numeric), ('\u{e81}',
        '\u{e82}', SC_OLetter), ('\u{e84}', '\u{e84}', SC_OLetter), ('\u{e87}', '\u{e88}',
        SC_OLetter), ('\u{e8a}', '\u{e8a}', SC_OLetter), ('\u{e8d}', '\u{e8d}', SC_OLetter),
        ('\u{e94}', '\u{e97}', SC_OLetter), ('\u{e99}', '\u{e9f}', SC_OLetter), ('\u{ea1}',
        '\u{ea3}', SC_OLetter), ('\u{ea5}', '\u{ea5}', SC_OLetter), ('\u{ea7}', '\u{ea7}',
        SC_OLetter), ('\u{eaa}', '\u{eab}', SC_OLetter), ('\u{ead}', '\u{eb0}', SC_OLetter),
        ('\u{eb1}', '\u{eb1}', SC_Extend), ('\u{eb2}', '\u{eb3}', SC_OLetter), ('\u{eb4}',
        '\u{eb9}', SC_Extend), ('\u{ebb}', '\u{ebc}', SC_Extend), ('\u{ebd}', '\u{ebd}',
        ...
        '\u{1877}', SC_OLetter), ('\u{1880}', '\u{1884}', SC_OLetter), ('\u{1885}', '\u{1886}',
        ...
        SC_Lower), ('\u{1cd0}', '\u{1cd2}', SC_Extend), ('\u{1cd4}', '\u{1ce8}', SC_Extend),
        ('\u{1ce9}', '\u{1cec}', SC_OLetter), ('\u{1ced}', '\u{1ced}', SC_Extend), ('\u{1cee}',
        '\u{1cf1}', SC_OLetter), ('\u{1cf2}', '\u{1cf4}', SC_Extend), ('\u{1cf5}', '\u{1cf6}',
        SC_OLetter), ('\u{1cf8}', '\u{1cf9}', SC_Extend), ('\u{1d00}', '\u{1dbf}', SC_Lower),
        ('\u{1dc0}', '\u{1df5}', SC_Extend), ('\u{1dfb}', '\u{1dff}', SC_Extend), ('\u{1e00}',
        '\u{1e00}', SC_Upper), ('\u{1e01}', '\u{1e01}', SC_Lower), ('\u{1e02}', '\u{1e02}',
        SC_Upper), ('\u{1e03}', '\u{1e03}', SC_Lower), ('\u{1e04}', '\u{1e04}', SC_Upper),
        ('\u{1e05}', '\u{1e05}', SC_Lower), ('\u{1e06}', '\u{1e06}', SC_Upper), ('\u{1e07}',
        '\u{1e07}', SC_Lower), ('\u{1e08}', '\u{1e08}', SC_Upper), ('\u{1e09}', '\u{1e09}',
        SC_Lower), ('\u{1e0a}', '\u{1e0a}', SC_Upper), ('\u{1e0b}', '\u{1e0b}', SC_Lower),
        ('\u{1e0c}', '\u{1e0c}', SC_Upper), ('\u{1e0d}', '\u{1e0d}', SC_Lower), ('\u{1e0e}',
        '\u{1e0e}', SC_Upper), ('\u{1e0f}', '\u{1e0f}', SC_Lower), ('\u{1e10}', '\u{1e10}',
        SC_Upper), ('\u{1e11}', '\u{1e11}', SC_Lower), ('\u{1e12}', '\u{1e12}', SC_Upper),
        ('\u{1e13}', '\u{1e13}', SC_Lower), ('\u{1e14}', '\u{1e14}', SC_Upper), ('\u{1e15}',
        '\u{1e15}', SC_Lower), ('\u{1e16}', '\u{1e16}', SC_Upper), ('\u{1e17}', '\u{1e17}',
        SC_Lower), ('\u{1e18}', '\u{1e18}', SC_Upper), ('\u{1e19}', '\u{1e19}', SC_Lower),
        ('\u{1e1a}', '\u{1e1a}', SC_Upper), ('\u{1e1b}', '\u{1e1b}', SC_Lower), ('\u{1e1c}',
        '\u{1e1c}', SC_Upper), ('\u{1e1d}', '\u{1e1d}', SC_Lower), ('\u{1e1e}', '\u{1e1e}',
        SC_Upper), ('\u{1e1f}', '\u{1e1f}', SC_Lower), ('\u{1e20}', '\u{1e20}', SC_Upper),
        ('\u{1e21}', '\u{1e21}', SC_Lower), ('\u{1e22}', '\u{1e22}', SC_Upper), ('\u{1e23}',
        '\u{1e23}', SC_Lower), ('\u{1e24}', '\u{1e24}', SC_Upper), ('\u{1e25}', '\u{1e25}',
        SC_Lower), ('\u{1e26}', '\u{1e26}', SC_Upper), ('\u{1e27}', '\u{1e27}', SC_Lower),
        ('\u{1e28}', '\u{1e28}', SC_Upper), ('\u{1e29}', '\u{1e29}', SC_Lower), ('\u{1e2a}',
        '\u{1e2a}', SC_Upper), ('\u{1e2b}', '\u{1e2b}', SC_Lower), ('\u{1e2c}', '\u{1e2c}',
        SC_Upper), ('\u{1e2d}', '\u{1e2d}', SC_Lower), ('\u{1e2e}', '\u{1e2e}', SC_Upper),
        ('\u{1e2f}', '\u{1e2f}', SC_Lower), ('\u{1e30}', '\u{1e30}', SC_Upper), ('\u{1e31}',
        '\u{1e31}', SC_Lower), ('\u{1e32}', '\u{1e32}', SC_Upper), ('\u{1e33}', '\u{1e33}',
        SC_Lower), ('\u{1e34}', '\u{1e34}', SC_Upper), ('\u{1e35}', '\u{1e35}', SC_Lower),
        ('\u{1e36}', '\u{1e36}', SC_Upper), ('\u{1e37}', '\u{1e37}', SC_Lower), ('\u{1e38}',
        '\u{1e38}', SC_Upper), ('\u{1e39}', '\u{1e39}', SC_Lower), ('\u{1e3a}', '\u{1e3a}',
        SC_Upper), ('\u{1e3b}', '\u{1e3b}', SC_Lower), ('\u{1e3c}', '\u{1e3c}', SC_Upper),
        ('\u{1e3d}', '\u{1e3d}', SC_Lower), ('\u{1e3e}', '\u{1e3e}', SC_Upper), ('\u{1e3f}',
        '\u{1e3f}', SC_Lower), ('\u{1e40}', '\u{1e40}', SC_Upper), ('\u{1e41}', '\u{1e41}',
        SC_Lower), ('\u{1e42}', '\u{1e42}', SC_Upper), ('\u{1e43}', '\u{1e43}', SC_Lower),
        ('\u{1e44}', '\u{1e44}', SC_Upper), ('\u{1e45}', '\u{1e45}', SC_Lower), ('\u{1e46}',
        '\u{1e46}', SC_Upper), ('\u{1e47}', '\u{1e47}', SC_Lower), ('\u{1e48}', '\u{1e48}',
        SC_Upper), ('\u{1e49}', '\u{1e49}', SC_Lower), ('\u{1e4a}', '\u{1e4a}', SC_Upper),
        ('\u{1e4b}', '\u{1e4b}', SC_Lower), ('\u{1e4c}', '\u{1e4c}', SC_Upper), ('\u{1e4d}',
        '\u{1e4d}', SC_Lower), ('\u{1e4e}', '\u{1e4e}', SC_Upper), ('\u{1e4f}', '\u{1e4f}',
        SC_Lower), ('\u{1e50}', '\u{1e50}', SC_Upper), ('\u{1e51}', '\u{1e51}', SC_Lower),
        ('\u{1e52}', '\u{1e52}', SC_Upper), ('\u{1e53}', '\u{1e53}', SC_Lower), ('\u{1e54}',
        '\u{1e54}', SC_Upper), ('\u{1e55}', '\u{1e55}', SC_Lower), ('\u{1e56}', '\u{1e56}',
        SC_Upper), ('\u{1e57}', '\u{1e57}', SC_Lower), ('\u{1e58}', '\u{1e58}', SC_Upper),
        ('\u{1e59}', '\u{1e59}', SC_Lower), ('\u{1e5a}', '\u{1e5a}', SC_Upper), ('\u{1e5b}',
        '\u{1e5b}', SC_Lower), ('\u{1e5c}', '\u{1e5c}', SC_Upper), ('\u{1e5d}', '\u{1e5d}',
        SC_Lower), ('\u{1e5e}', '\u{1e5e}', SC_Upper), ('\u{1e5f}', '\u{1e5f}', SC_Lower),
        ('\u{1e60}', '\u{1e60}', SC_Upper), ('\u{1e61}', '\u{1e61}', SC_Lower), ('\u{1e62}',
        '\u{1e62}', SC_Upper), ('\u{1e63}', '\u{1e63}', SC_Lower), ('\u{1e64}', '\u{1e64}',
        SC_Upper), ('\u{1e65}', '\u{1e65}', SC_Lower), ('\u{1e66}', '\u{1e66}', SC_Upper),
        ('\u{1e67}', '\u{1e67}', SC_Lower), ('\u{1e68}', '\u{1e68}', SC_Upper), ('\u{1e69}',
        '\u{1e69}', SC_Lower), ('\u{1e6a}', '\u{1e6a}', SC_Upper), ('\u{1e6b}', '\u{1e6b}',
        SC_Lower), ('\u{1e6c}', '\u{1e6c}', SC_Upper), ('\u{1e6d}', '\u{1e6d}', SC_Lower),
        ('\u{1e6e}', '\u{1e6e}', SC_Upper), ('\u{1e6f}', '\u{1e6f}', SC_Lower), ('\u{1e70}',
        '\u{1e70}', SC_Upper), ('\u{1e71}', '\u{1e71}', SC_Lower), ('\u{1e72}', '\u{1e72}',
        SC_Upper), ('\u{1e73}', '\u{1e73}', SC_Lower), ('\u{1e74}', '\u{1e74}', SC_Upper),
        ('\u{1e75}', '\u{1e75}', SC_Lower), ('\u{1e76}', '\u{1e76}', SC_Upper), ('\u{1e77}',
        '\u{1e77}', SC_Lower), ('\u{1e78}', '\u{1e78}', SC_Upper), ('\u{1e79}', '\u{1e79}',
        SC_Lower), ('\u{1e7a}', '\u{1e7a}', SC_Upper), ('\u{1e7b}', '\u{1e7b}', SC_Lower),
        ('\u{1e7c}', '\u{1e7c}', SC_Upper), ('\u{1e7d}', '\u{1e7d}', SC_Lower), ('\u{1e7e}',
        '\u{1e7e}', SC_Upper), ('\u{1e7f}', '\u{1e7f}', SC_Lower), ('\u{1e80}', '\u{1e80}',
        SC_Upper), ('\u{1e81}', '\u{1e81}', SC_Lower), ('\u{1e82}', '\u{1e82}', SC_Upper),
        ('\u{1e83}', '\u{1e83}', SC_Lower), ('\u{1e84}', '\u{1e84}', SC_Upper), ('\u{1e85}',
        '\u{1e85}', SC_Lower), ('\u{1e86}', '\u{1e86}', SC_Upper), ('\u{1e87}', '\u{1e87}',
        SC_Lower), ('\u{1e88}', '\u{1e88}', SC_Upper), ('\u{1e89}', '\u{1e89}', SC_Lower),
        ('\u{1e8a}', '\u{1e8a}', SC_Upper), ('\u{1e8b}', '\u{1e8b}', SC_Lower), ('\u{1e8c}',
        '\u{1e8c}', SC_Upper), ('\u{1e8d}', '\u{1e8d}', SC_Lower), ('\u{1e8e}', '\u{1e8e}',
        SC_Upper), ('\u{1e8f}', '\u{1e8f}', SC_Lower), ('\u{1e90}', '\u{1e90}', SC_Upper),
        ('\u{1e91}', '\u{1e91}', SC_Lower), ('\u{1e92}', '\u{1e92}', SC_Upper), ('\u{1e93}',
        '\u{1e93}', SC_Lower), ('\u{1e94}', '\u{1e94}', SC_Upper), ('\u{1e95}', '\u{1e9d}',
        SC_Lower), ('\u{1e9e}', '\u{1e9e}', SC_Upper), ('\u{1e9f}', '\u{1e9f}', SC_Lower),
        ('\u{1ea0}', '\u{1ea0}', SC_Upper), ('\u{1ea1}', '\u{1ea1}', SC_Lower), ('\u{1ea2}',
        '\u{1ea2}', SC_Upper), ('\u{1ea3}', '\u{1ea3}', SC_Lower), ('\u{1ea4}', '\u{1ea4}',
        SC_Upper), ('\u{1ea5}', '\u{1ea5}', SC_Lower), ('\u{1ea6}', '\u{1ea6}', SC_Upper),
        ('\u{1ea7}', '\u{1ea7}', SC_Lower), ('\u{1ea8}', '\u{1ea8}', SC_Upper), ('\u{1ea9}',
        '\u{1ea9}', SC_Lower), ('\u{1eaa}', '\u{1eaa}', SC_Upper), ('\u{1eab}', '\u{1eab}',
        SC_Lower), ('\u{1eac}', '\u{1eac}', SC_Upper), ('\u{1ead}', '\u{1ead}', SC_Lower),
        ('\u{1eae}', '\u{1eae}', SC_Upper), ('\u{1eaf}', '\u{1eaf}', SC_Lower), ('\u{1eb0}',
        '\u{1eb0}', SC_Upper), ('\u{1eb1}', '\u{1eb1}', SC_Lower), ('\u{1eb2}', '\u{1eb2}',
        SC_Upper), ('\u{1eb3}', '\u{1eb3}', SC_Lower), ('\u{1eb4}', '\u{1eb4}', SC_Upper),
        ('\u{1eb5}', '\u{1eb5}', SC_Lower), ('\u{1eb6}', '\u{1eb6}', SC_Upper), ('\u{1eb7}',
        '\u{1eb7}', SC_Lower), ('\u{1eb8}', '\u{1eb8}', SC_Upper), ('\u{1eb9}', '\u{1eb9}',
        SC_Lower), ('\u{1eba}', '\u{1eba}', SC_Upper), ('\u{1ebb}', '\u{1ebb}', SC_Lower),
        ('\u{1ebc}', '\u{1ebc}', SC_Upper), ('\u{1ebd}', '\u{1ebd}', SC_Lower), ('\u{1ebe}',
        '\u{1ebe}', SC_Upper), ('\u{1ebf}', '\u{1ebf}', SC_Lower), ('\u{1ec0}', '\u{1ec0}',
        SC_Upper), ('\u{1ec1}', '\u{1ec1}', SC_Lower), ('\u{1ec2}', '\u{1ec2}', SC_Upper),
        ('\u{1ec3}', '\u{1ec3}', SC_Lower), ('\u{1ec4}', '\u{1ec4}', SC_Upper), ('\u{1ec5}',
        '\u{1ec5}', SC_Lower), ('\u{1ec6}', '\u{1ec6}', SC_Upper), ('\u{1ec7}', '\u{1ec7}',
        SC_Lower), ('\u{1ec8}', '\u{1ec8}', SC_Upper), ('\u{1ec9}', '\u{1ec9}', SC_Lower),
        ('\u{1eca}', '\u{1eca}', SC_Upper), ('\u{1ecb}', '\u{1ecb}', SC_Lower), ('\u{1ecc}',
        '\u{1ecc}', SC_Upper), ('\u{1ecd}', '\u{1ecd}', SC_Lower), ('\u{1ece}', '\u{1ece}',
        SC_Upper), ('\u{1ecf}', '\u{1ecf}', SC_Lower), ('\u{1ed0}', '\u{1ed0}', SC_Upper),
        ('\u{1ed1}', '\u{1ed1}', SC_Lower), ('\u{1ed2}', '\u{1ed2}', SC_Upper), ('\u{1ed3}',
        '\u{1ed3}', SC_Lower), ('\u{1ed4}', '\u{1ed4}', SC_Upper), ('\u{1ed5}', '\u{1ed5}',
        SC_Lower), ('\u{1ed6}', '\u{1ed6}', SC_Upper), ('\u{1ed7}', '\u{1ed7}', SC_Lower),
        ('\u{1ed8}', '\u{1ed8}', SC_Upper), ('\u{1ed9}', '\u{1ed9}', SC_Lower), ('\u{1eda}',
        '\u{1eda}', SC_Upper), ('\u{1edb}', '\u{1edb}', SC_Lower), ('\u{1edc}', '\u{1edc}',
        SC_Upper), ('\u{1edd}', '\u{1edd}', SC_Lower), ('\u{1ede}', '\u{1ede}', SC_Upper),
        ('\u{1edf}', '\u{1edf}', SC_Lower), ('\u{1ee0}', '\u{1ee0}', SC_Upper), ('\u{1ee1}',
        '\u{1ee1}', SC_Lower), ('\u{1ee2}', '\u{1ee2}', SC_Upper), ('\u{1ee3}', '\u{1ee3}',
        SC_Lower), ('\u{1ee4}', '\u{1ee4}', SC_Upper), ('\u{1ee5}', '\u{1ee5}', SC_Lower),
        ('\u{1ee6}', '\u{1ee6}', SC_Upper), ('\u{1ee7}', '\u{1ee7}', SC_Lower), ('\u{1ee8}',
        '\u{1ee8}', SC_Upper), ('\u{1ee9}', '\u{1ee9}', SC_Lower), ('\u{1eea}', '\u{1eea}',
        SC_Upper), ('\u{1eeb}', '\u{1eeb}', SC_Lower), ('\u{1eec}', '\u{1eec}', SC_Upper),
        ('\u{1eed}', '\u{1eed}', SC_Lower), ('\u{1eee}', '\u{1eee}', SC_Upper), ('\u{1eef}',
        '\u{1eef}', SC_Lower), ('\u{1ef0}', '\u{1ef0}', SC_Upper), ('\u{1ef1}', '\u{1ef1}',
        SC_Lower), ('\u{1ef2}', '\u{1ef2}', SC_Upper), ('\u{1ef3}', '\u{1ef3}', SC_Lower),
        ('\u{1ef4}', '\u{1ef4}', SC_Upper), ('\u{1ef5}', '\u{1ef5}', SC_Lower), ('\u{1ef6}',
        '\u{1ef6}', SC_Upper), ('\u{1ef7}', '\u{1ef7}', SC_Lower), ('\u{1ef8}', '\u{1ef8}',
        SC_Upper), ('\u{1ef9}', '\u{1ef9}', SC_Lower), ('\u{1efa}', '\u{1efa}', SC_Upper),
        ('\u{1efb}', '\u{1efb}', SC_Lower), ('\u{1efc}', '\u{1efc}', SC_Upper), ('\u{1efd}',
        '\u{1efd}', SC_Lower), ('\u{1efe}', '\u{1efe}', SC_Upper), ('\u{1eff}', '\u{1f07}',
        SC_Lower), ('\u{1f08}', '\u{1f0f}', SC_Upper), ('\u{1f10}', '\u{1f15}', SC_Lower),
        ('\u{1f18}', '\u{1f1d}', SC_Upper), ('\u{1f20}', '\u{1f27}', SC_Lower), ('\u{1f28}',
        '\u{1f2f}', SC_Upper), ('\u{1f30}', '\u{1f37}', SC_Lower), ('\u{1f38}', '\u{1f3f}',
        SC_Upper), ('\u{1f40}', '\u{1f45}', SC_Lower), ('\u{1f48}', '\u{1f4d}', SC_Upper),
        ('\u{1f50}', '\u{1f57}', SC_Lower), ('\u{1f59}', '\u{1f59}', SC_Upper), ('\u{1f5b}',
        '\u{1f5b}', SC_Upper), ('\u{1f5d}', '\u{1f5d}', SC_Upper), ('\u{1f5f}', '\u{1f5f}',
        SC_Upper), ('\u{1f60}', '\u{1f67}', SC_Lower), ('\u{1f68}', '\u{1f6f}', SC_Upper),
        ('\u{1f70}', '\u{1f7d}', SC_Lower), ('\u{1f80}', '\u{1f87}', SC_Lower), ('\u{1f88}',
        '\u{1f8f}', SC_Upper), ('\u{1f90}', '\u{1f97}', SC_Lower), ('\u{1f98}', '\u{1f9f}',
        SC_Upper), ('\u{1fa0}', '\u{1fa7}', SC_Lower), ('\u{1fa8}', '\u{1faf}', SC_Upper),
        ('\u{1fb0}', '\u{1fb4}', SC_Lower), ('\u{1fb6}', '\u{1fb7}', SC_Lower), ('\u{1fb8}',
        '\u{1fbc}', SC_Upper), ('\u{1fbe}', '\u{1fbe}', SC_Lower), ('\u{1fc2}', '\u{1fc4}',
        SC_Lower), ('\u{1fc6}', '\u{1fc7}', SC_Lower), ('\u{1fc8}', '\u{1fcc}', SC_Upper),
        ('\u{1fd0}', '\u{1fd3}', SC_Lower), ('\u{1fd6}', '\u{1fd7}', SC_Lower), ('\u{1fd8}',
        '\u{1fdb}', SC_Upper), ('\u{1fe0}', '\u{1fe7}', SC_Lower), ('\u{1fe8}', '\u{1fec}',
        SC_Upper), ('\u{1ff2}', '\u{1ff4}', SC_Lower), ('\u{1ff6}', '\u{1ff7}', SC_Lower),
        ('\u{1ff8}', '\u{1ffc}', SC_Upper), ('\u{2000}', '\u{200a}', SC_Sp), ('\u{200b}',
        ...
        '\u{30ff}', SC_OLetter), ('\u{3105}', '\u{312d}', SC_OLetter), ('\u{3131}', '\u{318e}',
        SC_OLetter), ('\u{31a0}', '\u{31ba}', SC_OLetter), ('\u{31f0}', '\u{31ff}', SC_OLetter),
        ('\u{3400}', '\u{4db5}', SC_OLetter), ('\u{4e00}', '\u{9fd5}', SC_OLetter), ('\u{a000}',
        ...
        SC_Upper), ('\u{a7b0}', '\u{a7b4}', SC_Upper), ('\u{a7b5}', '\u{a7b5}', SC_Lower),
        ('\u{a7b6}', '\u{a7b6}', SC_Upper), ('\u{a7b7}', '\u{a7b7}', SC_Lower), ('\u{a7f7}',
        ...
        ('\u{a8fb}', '\u{a8fb}', SC_OLetter), ('\u{a8fd}', '\u{a8fd}', SC_OLetter), ('\u{a900}',
        ...
        SC_Lower), ('\u{ab5c}', '\u{ab65}', SC_Lower), ('\u{ab70}', '\u{abbf}', SC_Lower),
        ...
        SC_SContinue), ('\u{ff0e}', '\u{ff0e}', SC_ATerm), ('\u{ff1a}', '\u{ff1a}', SC_SContinue),
        ('\u{ff1f}', '\u{ff1f}', SC_STerm), ('\u{ff21}', '\u{ff3a}', SC_Upper), ('\u{ff3b}',
        '\u{ff3b}', SC_Close), ('\u{ff3d}', '\u{ff3d}', SC_Close), ('\u{ff41}', '\u{ff5a}',
        SC_Lower), ('\u{ff5b}', '\u{ff5b}', SC_Close), ('\u{ff5d}', '\u{ff5d}', SC_Close),
        ('\u{ff5f}', '\u{ff60}', SC_Close), ('\u{ff61}', '\u{ff61}', SC_STerm), ('\u{ff62}',
        '\u{ff63}', SC_Close), ('\u{ff64}', '\u{ff64}', SC_SContinue), ('\u{ff66}', '\u{ff9d}',
        SC_OLetter), ('\u{ff9e}', '\u{ff9f}', SC_Extend), ('\u{ffa0}', '\u{ffbe}', SC_OLetter),
        ('\u{ffc2}', '\u{ffc7}', SC_OLetter), ('\u{ffca}', '\u{ffcf}', SC_OLetter), ('\u{ffd2}',
        '\u{ffd7}', SC_OLetter), ('\u{ffda}', '\u{ffdc}', SC_OLetter), ('\u{fff9}', '\u{fffb}',
        SC_Format), ('\u{10000}', '\u{1000b}', SC_OLetter), ('\u{1000d}', '\u{10026}', SC_OLetter),
        ...
        SC_OLetter), ('\u{10330}', '\u{1034a}', SC_OLetter), ('\u{10350}', '\u{10375}', SC_OLetter),
        ...
        '\u{10527}', SC_OLetter), ('\u{10530}', '\u{10563}', SC_OLetter), ('\u{10600}', '\u{10736}',
        SC_OLetter), ('\u{10740}', '\u{10755}', SC_OLetter), ('\u{10760}', '\u{10767}', SC_OLetter),
        ('\u{10800}', '\u{10805}', SC_OLetter), ('\u{10808}', '\u{10808}', SC_OLetter),
        ('\u{1080a}', '\u{10835}', SC_OLetter), ('\u{10837}', '\u{10838}', SC_OLetter),
        ...
        SC_OLetter), ('\u{10a15}', '\u{10a17}', SC_OLetter), ('\u{10a19}', '\u{10a33}', SC_OLetter),
        ...
        ('\u{10cc0}', '\u{10cf2}', SC_Lower), ('\u{11000}', '\u{11002}', SC_Extend), ('\u{11003}',
        '\u{11037}', SC_OLetter), ('\u{11038}', '\u{11046}', SC_Extend), ('\u{11047}', '\u{11048}',
        SC_STerm), ('\u{11066}', '\u{1106f}', SC_Numeric), ('\u{1107f}', '\u{11082}', SC_Extend),
        ('\u{11083}', '\u{110af}', SC_OLetter), ('\u{110b0}', '\u{110ba}', SC_Extend), ('\u{110bd}',
        '\u{110bd}', SC_Format), ('\u{110be}', '\u{110c1}', SC_STerm), ('\u{110d0}', '\u{110e8}',
        ...
        '\u{1113f}', SC_Numeric), ('\u{11141}', '\u{11143}', SC_STerm), ('\u{11150}', '\u{11172}',
        ...
        SC_STerm), ('\u{111ca}', '\u{111cc}', SC_Extend), ('\u{111cd}', '\u{111cd}', SC_STerm),
        ('\u{111d0}', '\u{111d9}', SC_Numeric), ('\u{111da}', '\u{111da}', SC_OLetter),
        ('\u{111dc}', '\u{111dc}', SC_OLetter), ('\u{111de}', '\u{111df}', SC_STerm), ('\u{11200}',
        '\u{11211}', SC_OLetter), ('\u{11213}', '\u{1122b}', SC_OLetter), ('\u{1122c}', '\u{11237}',
        SC_Extend), ('\u{11238}', '\u{11239}', SC_STerm), ('\u{1123b}', '\u{1123c}', SC_STerm),
        ('\u{1123e}', '\u{1123e}', SC_Extend), ('\u{11280}', '\u{11286}', SC_OLetter), ('\u{11288}',
        '\u{11288}', SC_OLetter), ('\u{1128a}', '\u{1128d}', SC_OLetter), ('\u{1128f}', '\u{1129d}',
        SC_OLetter), ('\u{1129f}', '\u{112a8}', SC_OLetter), ('\u{112a9}', '\u{112a9}', SC_STerm),
        ('\u{112b0}', '\u{112de}', SC_OLetter), ('\u{112df}', '\u{112ea}', SC_Extend), ('\u{112f0}',
        '\u{112f9}', SC_Numeric), ('\u{11300}', '\u{11303}', SC_Extend), ('\u{11305}', '\u{1130c}',
        SC_OLetter), ('\u{1130f}', '\u{11310}', SC_OLetter), ('\u{11313}', '\u{11328}', SC_OLetter),
        ...
        ('\u{118ff}', '\u{118ff}', SC_OLetter), ('\u{11ac0}', '\u{11af8}', SC_OLetter),
        ...
        ('\u{11ca9}', '\u{11cb6}', SC_Extend), ('\u{12000}', '\u{12399}', SC_OLetter), ('\u{12400}',
        ...
        SC_OLetter), ('\u{16f00}', '\u{16f44}', SC_OLetter), ('\u{16f50}', '\u{16f50}', SC_OLetter),
        ('\u{16f51}', '\u{16f7e}', SC_Extend), ('\u{16f8f}', '\u{16f92}', SC_Extend), ('\u{16f93}',
        '\u{16f9f}', SC_OLetter), ('\u{16fe0}', '\u{16fe0}', SC_OLetter), ('\u{17000}', '\u{187ec}',
        SC_OLetter), ('\u{18800}', '\u{18af2}', SC_OLetter), ('\u{1b000}', '\u{1b001}', SC_OLetter),
        ...
        ('\u{2b820}', '\u{2cea1}', SC_OLetter), ('\u{2f800}', '\u{2fa1d}', SC_OLetter),

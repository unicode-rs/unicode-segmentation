...
mod general_category {
    const N_table: &'static [(char, char)] = &[
        ...
        ('\u{11d50}', '\u{11d59}'), ('\u{11da0}', '\u{11da9}'), ('\u{12400}', '\u{1246e}'),
        ('\u{16a60}', '\u{16a69}'), ('\u{16b50}', '\u{16b59}'), ('\u{16b5b}', '\u{16b61}'),
        ('\u{16e80}', '\u{16e96}'), ('\u{1d2e0}', '\u{1d2f3}'), ('\u{1d360}', '\u{1d378}'),
        ('\u{1d7ce}', '\u{1d7ff}'), ('\u{1e8c7}', '\u{1e8cf}'), ('\u{1e950}', '\u{1e959}'),
...
mod derived_property {
    const Alphabetic_table: &'static [(char, char)] = &[
        ...
        ('\u{ea7}', '\u{ea7}'), ('\u{eaa}', '\u{eab}'), ('\u{ead}', '\u{eb9}'), ('\u{ebb}',
        ...
        '\u{1062}'), ('\u{1065}', '\u{1068}'), ('\u{106e}', '\u{1086}'), ('\u{108e}', '\u{108e}'),
        ('\u{109c}', '\u{109d}'), ('\u{10a0}', '\u{10c5}'), ('\u{10c7}', '\u{10c7}'), ('\u{10cd}',
        ...
        ('\u{135f}', '\u{135f}'), ('\u{1380}', '\u{138f}'), ('\u{13a0}', '\u{13f5}'), ('\u{13f8}',
        '\u{13fd}'), ('\u{1401}', '\u{166c}'), ('\u{166f}', '\u{167f}'), ('\u{1681}', '\u{169a}'),
        ('\u{16a0}', '\u{16ea}'), ('\u{16ee}', '\u{16f8}'), ('\u{1700}', '\u{170c}'), ('\u{170e}',
        '\u{1713}'), ('\u{1720}', '\u{1733}'), ('\u{1740}', '\u{1753}'), ('\u{1760}', '\u{176c}'),
        ('\u{176e}', '\u{1770}'), ('\u{1772}', '\u{1773}'), ('\u{1780}', '\u{17b3}'), ('\u{17b6}',
        '\u{17c8}'), ('\u{17d7}', '\u{17d7}'), ('\u{17dc}', '\u{17dc}'), ('\u{1820}', '\u{1878}'),
        ('\u{1880}', '\u{18aa}'), ('\u{18b0}', '\u{18f5}'), ('\u{1900}', '\u{191e}'), ('\u{1920}',
        '\u{192b}'), ('\u{1930}', '\u{1938}'), ('\u{1950}', '\u{196d}'), ('\u{1970}', '\u{1974}'),
        ('\u{1980}', '\u{19ab}'), ('\u{19b0}', '\u{19c9}'), ('\u{1a00}', '\u{1a1b}'), ('\u{1a20}',
        '\u{1a5e}'), ('\u{1a61}', '\u{1a74}'), ('\u{1aa7}', '\u{1aa7}'), ('\u{1b00}', '\u{1b33}'),
        ('\u{1b35}', '\u{1b43}'), ('\u{1b45}', '\u{1b4b}'), ('\u{1b80}', '\u{1ba9}'), ('\u{1bac}',
        '\u{1baf}'), ('\u{1bba}', '\u{1be5}'), ('\u{1be7}', '\u{1bf1}'), ('\u{1c00}', '\u{1c35}'),
        ('\u{1c4d}', '\u{1c4f}'), ('\u{1c5a}', '\u{1c7d}'), ('\u{1c80}', '\u{1c88}'), ('\u{1c90}',
        '\u{1cba}'), ('\u{1cbd}', '\u{1cbf}'), ('\u{1ce9}', '\u{1cec}'), ('\u{1cee}', '\u{1cf3}'),
        ...
        '\u{309f}'), ('\u{30a1}', '\u{30fa}'), ('\u{30fc}', '\u{30ff}'), ('\u{3105}', '\u{312f}'),
        ('\u{3131}', '\u{318e}'), ('\u{31a0}', '\u{31ba}'), ('\u{31f0}', '\u{31ff}'), ('\u{3400}',
        '\u{4db5}'), ('\u{4e00}', '\u{9fef}'), ('\u{a000}', '\u{a48c}'), ('\u{a4d0}', '\u{a4fd}'),
        ('\u{a500}', '\u{a60c}'), ('\u{a610}', '\u{a61f}'), ('\u{a62a}', '\u{a62b}'), ('\u{a640}',
        '\u{a66e}'), ('\u{a674}', '\u{a67b}'), ('\u{a67f}', '\u{a6ef}'), ('\u{a717}', '\u{a71f}'),
        ('\u{a722}', '\u{a788}'), ('\u{a78b}', '\u{a7b9}'), ('\u{a7f7}', '\u{a801}'), ('\u{a803}',
        '\u{a805}'), ('\u{a807}', '\u{a80a}'), ('\u{a80c}', '\u{a827}'), ('\u{a840}', '\u{a873}'),
        ('\u{a880}', '\u{a8c3}'), ('\u{a8c5}', '\u{a8c5}'), ('\u{a8f2}', '\u{a8f7}'), ('\u{a8fb}',
        '\u{a8fb}'), ('\u{a8fd}', '\u{a8fe}'), ('\u{a90a}', '\u{a92a}'), ('\u{a930}', '\u{a952}'),
        ...
        '\u{102d0}'), ('\u{10300}', '\u{1031f}'), ('\u{1032d}', '\u{1034a}'), ('\u{10350}',
        '\u{1037a}'), ('\u{10380}', '\u{1039d}'), ('\u{103a0}', '\u{103c3}'), ('\u{103c8}',
        '\u{103cf}'), ('\u{103d1}', '\u{103d5}'), ('\u{10400}', '\u{1049d}'), ('\u{104b0}',
        ...
        '\u{10a17}'), ('\u{10a19}', '\u{10a35}'), ('\u{10a60}', '\u{10a7c}'), ('\u{10a80}',
        ...
        '\u{10cf2}'), ('\u{10d00}', '\u{10d27}'), ('\u{10f00}', '\u{10f1c}'), ('\u{10f27}',
        '\u{10f27}'), ('\u{10f30}', '\u{10f45}'), ('\u{11000}', '\u{11045}'), ('\u{11082}',
        ...
        '\u{11441}'), ('\u{11443}', '\u{11445}'), ('\u{11447}', '\u{1144a}'), ('\u{11480}',
        ...
        '\u{116b5}'), ('\u{11700}', '\u{1171a}'), ('\u{1171d}', '\u{1172a}'), ('\u{11800}',
        '\u{11838}'), ('\u{118a0}', '\u{118df}'), ('\u{118ff}', '\u{118ff}'), ('\u{11a00}',
        '\u{11a32}'), ('\u{11a35}', '\u{11a3e}'), ('\u{11a50}', '\u{11a83}'), ('\u{11a86}',
        ...
        '\u{16b8f}'), ('\u{16e40}', '\u{16e7f}'), ('\u{16f00}', '\u{16f44}'), ('\u{16f50}',
        '\u{16f7e}'), ('\u{16f93}', '\u{16f9f}'), ('\u{16fe0}', '\u{16fe1}'), ('\u{17000}',
        '\u{187f1}'), ('\u{18800}', '\u{18af2}'), ('\u{1b000}', '\u{1b11e}'), ('\u{1b170}',
        ...
        '\u{1e024}'), ('\u{1e026}', '\u{1e02a}'), ('\u{1e800}', '\u{1e8c4}'), ('\u{1e900}',
        '\u{1e943}'), ('\u{1e947}', '\u{1e947}'), ('\u{1ee00}', '\u{1ee03}'), ('\u{1ee05}',
...
pub mod grapheme {
    ...
    const grapheme_cat_table: &'static [(char, char, GraphemeCat)] = &[
        ...
        ('\u{1cf7}', '\u{1cf7}', GC_SpacingMark), ('\u{1cf8}', '\u{1cf9}', GC_Extend), ('\u{1dc0}',
        '\u{1df9}', GC_Extend), ('\u{1dfb}', '\u{1dff}', GC_Extend), ('\u{200b}', '\u{200b}',
        GC_Control), ('\u{200c}', '\u{200c}', GC_Extend), ('\u{200d}', '\u{200d}', GC_ZWJ),
        ('\u{200e}', '\u{200f}', GC_Control), ('\u{2028}', '\u{202e}', GC_Control), ('\u{203c}',
        '\u{203c}', GC_Extended_Pictographic), ('\u{2049}', '\u{2049}', GC_Extended_Pictographic),
        ('\u{2060}', '\u{206f}', GC_Control), ('\u{20d0}', '\u{20f0}', GC_Extend), ('\u{2122}',
        '\u{2122}', GC_Extended_Pictographic), ('\u{2139}', '\u{2139}', GC_Extended_Pictographic),
        ('\u{2194}', '\u{2199}', GC_Extended_Pictographic), ('\u{21a9}', '\u{21aa}',
        GC_Extended_Pictographic), ('\u{231a}', '\u{231b}', GC_Extended_Pictographic), ('\u{2328}',
        '\u{2328}', GC_Extended_Pictographic), ('\u{2388}', '\u{2388}', GC_Extended_Pictographic),
        ('\u{23cf}', '\u{23cf}', GC_Extended_Pictographic), ('\u{23e9}', '\u{23f3}',
        GC_Extended_Pictographic), ('\u{23f8}', '\u{23fa}', GC_Extended_Pictographic), ('\u{24c2}',
        '\u{24c2}', GC_Extended_Pictographic), ('\u{25aa}', '\u{25ab}', GC_Extended_Pictographic),
        ('\u{25b6}', '\u{25b6}', GC_Extended_Pictographic), ('\u{25c0}', '\u{25c0}',
        GC_Extended_Pictographic), ('\u{25fb}', '\u{25fe}', GC_Extended_Pictographic), ('\u{2600}',
        '\u{2605}', GC_Extended_Pictographic), ('\u{2607}', '\u{2612}', GC_Extended_Pictographic),
        ('\u{2614}', '\u{2685}', GC_Extended_Pictographic), ('\u{2690}', '\u{2705}',
        GC_Extended_Pictographic), ('\u{2708}', '\u{2712}', GC_Extended_Pictographic), ('\u{2714}',
        '\u{2714}', GC_Extended_Pictographic), ('\u{2716}', '\u{2716}', GC_Extended_Pictographic),
        ('\u{271d}', '\u{271d}', GC_Extended_Pictographic), ('\u{2721}', '\u{2721}',
        GC_Extended_Pictographic), ('\u{2728}', '\u{2728}', GC_Extended_Pictographic), ('\u{2733}',
        '\u{2734}', GC_Extended_Pictographic), ('\u{2744}', '\u{2744}', GC_Extended_Pictographic),
        ('\u{2747}', '\u{2747}', GC_Extended_Pictographic), ('\u{274c}', '\u{274c}',
        GC_Extended_Pictographic), ('\u{274e}', '\u{274e}', GC_Extended_Pictographic), ('\u{2753}',
        '\u{2755}', GC_Extended_Pictographic), ('\u{2757}', '\u{2757}', GC_Extended_Pictographic),
        ('\u{2763}', '\u{2767}', GC_Extended_Pictographic), ('\u{2795}', '\u{2797}',
        GC_Extended_Pictographic), ('\u{27a1}', '\u{27a1}', GC_Extended_Pictographic), ('\u{27b0}',
        '\u{27b0}', GC_Extended_Pictographic), ('\u{27bf}', '\u{27bf}', GC_Extended_Pictographic),
        ('\u{2934}', '\u{2935}', GC_Extended_Pictographic), ('\u{2b05}', '\u{2b07}',
        GC_Extended_Pictographic), ('\u{2b1b}', '\u{2b1c}', GC_Extended_Pictographic), ('\u{2b50}',
        '\u{2b50}', GC_Extended_Pictographic), ('\u{2b55}', '\u{2b55}', GC_Extended_Pictographic),
        ('\u{2cef}', '\u{2cf1}', GC_Extend), ('\u{2d7f}', '\u{2d7f}', GC_Extend), ('\u{2de0}',
        '\u{2dff}', GC_Extend), ('\u{302a}', '\u{302f}', GC_Extend), ('\u{3030}', '\u{3030}',
        ...
        '\u{a9bb}', GC_SpacingMark), ('\u{a9bc}', '\u{a9bc}', GC_Extend), ('\u{a9bd}', '\u{a9c0}',
        ...
        ('\u{10f46}', '\u{10f50}', GC_Extend), ('\u{11000}', '\u{11000}', GC_SpacingMark),
        ('\u{11001}', '\u{11001}', GC_Extend), ('\u{11002}', '\u{11002}', GC_SpacingMark),
        ('\u{11038}', '\u{11046}', GC_Extend), ('\u{1107f}', '\u{11081}', GC_Extend), ('\u{11082}',
        '\u{11082}', GC_SpacingMark), ('\u{110b0}', '\u{110b2}', GC_SpacingMark), ('\u{110b3}',
        '\u{110b6}', GC_Extend), ('\u{110b7}', '\u{110b8}', GC_SpacingMark), ('\u{110b9}',
        '\u{110ba}', GC_Extend), ('\u{110bd}', '\u{110bd}', GC_Prepend), ('\u{110cd}', '\u{110cd}',
        GC_Prepend), ('\u{11100}', '\u{11102}', GC_Extend), ('\u{11127}', '\u{1112b}', GC_Extend),
        ('\u{1112c}', '\u{1112c}', GC_SpacingMark), ('\u{1112d}', '\u{11134}', GC_Extend),
        ('\u{11145}', '\u{11146}', GC_SpacingMark), ('\u{11173}', '\u{11173}', GC_Extend),
        ('\u{11180}', '\u{11181}', GC_Extend), ('\u{11182}', '\u{11182}', GC_SpacingMark),
        ('\u{111b3}', '\u{111b5}', GC_SpacingMark), ('\u{111b6}', '\u{111be}', GC_Extend),
        ('\u{111bf}', '\u{111c0}', GC_SpacingMark), ('\u{111c2}', '\u{111c3}', GC_Prepend),
        ('\u{111c9}', '\u{111cc}', GC_Extend), ('\u{1122c}', '\u{1122e}', GC_SpacingMark),
        ('\u{1122f}', '\u{11231}', GC_Extend), ('\u{11232}', '\u{11233}', GC_SpacingMark),
        ('\u{11234}', '\u{11234}', GC_Extend), ('\u{11235}', '\u{11235}', GC_SpacingMark),
        ('\u{11236}', '\u{11237}', GC_Extend), ('\u{1123e}', '\u{1123e}', GC_Extend), ('\u{112df}',
        ...
        GC_Extend), ('\u{11370}', '\u{11374}', GC_Extend), ('\u{11435}', '\u{11437}',
        ...
        GC_SpacingMark), ('\u{11839}', '\u{1183a}', GC_Extend), ('\u{11a01}', '\u{11a0a}',
        ...
        ('\u{11a86}', '\u{11a89}', GC_Prepend), ('\u{11a8a}', '\u{11a96}', GC_Extend), ('\u{11a97}',
        ...
        GC_SpacingMark), ('\u{16af0}', '\u{16af4}', GC_Extend), ('\u{16b30}', '\u{16b36}',
        GC_Extend), ('\u{16f51}', '\u{16f7e}', GC_SpacingMark), ('\u{16f8f}', '\u{16f92}',
        GC_Extend), ('\u{1bc9d}', '\u{1bc9e}', GC_Extend), ('\u{1bca0}', '\u{1bca3}', GC_Control),
        ...
        '\u{1e02a}', GC_Extend), ('\u{1e8d0}', '\u{1e8d6}', GC_Extend), ('\u{1e944}', '\u{1e94a}',
...
pub mod word {
    ...
    const word_cat_table: &'static [(char, char, WordCat)] = &[
        ...
        WC_Numeric), ('\u{eb1}', '\u{eb1}', WC_Extend), ('\u{eb4}', '\u{eb9}', WC_Extend),
        ('\u{ebb}', '\u{ebc}', WC_Extend), ('\u{ec8}', '\u{ecd}', WC_Extend), ('\u{ed0}', '\u{ed9}',
        ...
        WC_ALetter), ('\u{1ced}', '\u{1ced}', WC_Extend), ('\u{1cee}', '\u{1cf1}', WC_ALetter),
        ('\u{1cf2}', '\u{1cf4}', WC_Extend), ('\u{1cf5}', '\u{1cf6}', WC_ALetter), ('\u{1cf7}',
        '\u{1cf9}', WC_Extend), ('\u{1d00}', '\u{1dbf}', WC_ALetter), ('\u{1dc0}', '\u{1df9}',
        ...
        WC_Extend), ('\u{a717}', '\u{a7b9}', WC_ALetter), ('\u{a7f7}', '\u{a801}', WC_ALetter),
        ('\u{a802}', '\u{a802}', WC_Extend), ('\u{a803}', '\u{a805}', WC_ALetter), ('\u{a806}',
        '\u{a806}', WC_Extend), ('\u{a807}', '\u{a80a}', WC_ALetter), ('\u{a80b}', '\u{a80b}',
        WC_Extend), ('\u{a80c}', '\u{a822}', WC_ALetter), ('\u{a823}', '\u{a827}', WC_Extend),
        ('\u{a840}', '\u{a873}', WC_ALetter), ('\u{a880}', '\u{a881}', WC_Extend), ('\u{a882}',
        '\u{a8b3}', WC_ALetter), ('\u{a8b4}', '\u{a8c5}', WC_Extend), ('\u{a8d0}', '\u{a8d9}',
        WC_Numeric), ('\u{a8e0}', '\u{a8f1}', WC_Extend), ('\u{a8f2}', '\u{a8f7}', WC_ALetter),
        ('\u{a8fb}', '\u{a8fb}', WC_ALetter), ('\u{a8fd}', '\u{a8fe}', WC_ALetter), ('\u{a8ff}',
        '\u{a8ff}', WC_Extend), ('\u{a900}', '\u{a909}', WC_Numeric), ('\u{a90a}', '\u{a925}',
        WC_ALetter), ('\u{a926}', '\u{a92d}', WC_Extend), ('\u{a930}', '\u{a946}', WC_ALetter),
        ('\u{a947}', '\u{a953}', WC_Extend), ('\u{a960}', '\u{a97c}', WC_ALetter), ('\u{a980}',
        '\u{a983}', WC_Extend), ('\u{a984}', '\u{a9b2}', WC_ALetter), ('\u{a9b3}', '\u{a9c0}',
        WC_Extend), ('\u{a9cf}', '\u{a9cf}', WC_ALetter), ('\u{a9d0}', '\u{a9d9}', WC_Numeric),
        ('\u{a9e5}', '\u{a9e5}', WC_Extend), ('\u{a9f0}', '\u{a9f9}', WC_Numeric), ('\u{aa00}',
        '\u{aa28}', WC_ALetter), ('\u{aa29}', '\u{aa36}', WC_Extend), ('\u{aa40}', '\u{aa42}',
        WC_ALetter), ('\u{aa43}', '\u{aa43}', WC_Extend), ('\u{aa44}', '\u{aa4b}', WC_ALetter),
        ('\u{aa4c}', '\u{aa4d}', WC_Extend), ('\u{aa50}', '\u{aa59}', WC_Numeric), ('\u{aa7b}',
        '\u{aa7d}', WC_Extend), ('\u{aab0}', '\u{aab0}', WC_Extend), ('\u{aab2}', '\u{aab4}',
        WC_Extend), ('\u{aab7}', '\u{aab8}', WC_Extend), ('\u{aabe}', '\u{aabf}', WC_Extend),
        ('\u{aac1}', '\u{aac1}', WC_Extend), ('\u{aae0}', '\u{aaea}', WC_ALetter), ('\u{aaeb}',
        '\u{aaef}', WC_Extend), ('\u{aaf2}', '\u{aaf4}', WC_ALetter), ('\u{aaf5}', '\u{aaf6}',
        WC_Extend), ('\u{ab01}', '\u{ab06}', WC_ALetter), ('\u{ab09}', '\u{ab0e}', WC_ALetter),
        ('\u{ab11}', '\u{ab16}', WC_ALetter), ('\u{ab20}', '\u{ab26}', WC_ALetter), ('\u{ab28}',
        '\u{ab2e}', WC_ALetter), ('\u{ab30}', '\u{ab65}', WC_ALetter), ('\u{ab70}', '\u{abe2}',
        WC_ALetter), ('\u{abe3}', '\u{abea}', WC_Extend), ('\u{abec}', '\u{abed}', WC_Extend),
        ('\u{abf0}', '\u{abf9}', WC_Numeric), ('\u{ac00}', '\u{d7a3}', WC_ALetter), ('\u{d7b0}',
        '\u{d7c6}', WC_ALetter), ('\u{d7cb}', '\u{d7fb}', WC_ALetter), ('\u{fb00}', '\u{fb06}',
        WC_ALetter), ('\u{fb13}', '\u{fb17}', WC_ALetter), ('\u{fb1d}', '\u{fb1d}',
        WC_Hebrew_Letter), ('\u{fb1e}', '\u{fb1e}', WC_Extend), ('\u{fb1f}', '\u{fb28}',
        ...
        '\u{ff0c}', WC_MidNum), ('\u{ff0e}', '\u{ff0e}', WC_MidNumLet), ('\u{ff1a}', '\u{ff1a}',
        WC_MidLetter), ('\u{ff1b}', '\u{ff1b}', WC_MidNum), ('\u{ff21}', '\u{ff3a}', WC_ALetter),
        ('\u{ff3f}', '\u{ff3f}', WC_ExtendNumLet), ('\u{ff41}', '\u{ff5a}', WC_ALetter),
        ('\u{ff66}', '\u{ff9d}', WC_Katakana), ('\u{ff9e}', '\u{ff9f}', WC_Extend), ('\u{ffa0}',
        '\u{ffbe}', WC_ALetter), ('\u{ffc2}', '\u{ffc7}', WC_ALetter), ('\u{ffca}', '\u{ffcf}',
        WC_ALetter), ('\u{ffd2}', '\u{ffd7}', WC_ALetter), ('\u{ffda}', '\u{ffdc}', WC_ALetter),
        ('\u{fff9}', '\u{fffb}', WC_Format), ('\u{10000}', '\u{1000b}', WC_ALetter), ('\u{1000d}',
        '\u{10026}', WC_ALetter), ('\u{10028}', '\u{1003a}', WC_ALetter), ('\u{1003c}', '\u{1003d}',
        WC_ALetter), ('\u{1003f}', '\u{1004d}', WC_ALetter), ('\u{10050}', '\u{1005d}', WC_ALetter),
        ...
        ('\u{11000}', '\u{11002}', WC_Extend), ('\u{11003}', '\u{11037}', WC_ALetter), ('\u{11038}',
        '\u{11046}', WC_Extend), ('\u{11066}', '\u{1106f}', WC_Numeric), ('\u{1107f}', '\u{11082}',
        WC_Extend), ('\u{11083}', '\u{110af}', WC_ALetter), ('\u{110b0}', '\u{110ba}', WC_Extend),
        ('\u{110bd}', '\u{110bd}', WC_Format), ('\u{110cd}', '\u{110cd}', WC_Format), ('\u{110d0}',
        ...
        ('\u{11136}', '\u{1113f}', WC_Numeric), ('\u{11144}', '\u{11144}', WC_ALetter),
        ('\u{11145}', '\u{11146}', WC_Extend), ('\u{11150}', '\u{11172}', WC_ALetter), ('\u{11173}',
        '\u{11173}', WC_Extend), ('\u{11176}', '\u{11176}', WC_ALetter), ('\u{11180}', '\u{11182}',
        WC_Extend), ('\u{11183}', '\u{111b2}', WC_ALetter), ('\u{111b3}', '\u{111c0}', WC_Extend),
        ('\u{111c1}', '\u{111c4}', WC_ALetter), ('\u{111c9}', '\u{111cc}', WC_Extend), ('\u{111d0}',
        ...
        ('\u{1145e}', '\u{1145e}', WC_Extend), ('\u{11480}', '\u{114af}', WC_ALetter), ('\u{114b0}',
        '\u{114c3}', WC_Extend), ('\u{114c4}', '\u{114c5}', WC_ALetter), ('\u{114c7}', '\u{114c7}',
        WC_ALetter), ('\u{114d0}', '\u{114d9}', WC_Numeric), ('\u{11580}', '\u{115ae}', WC_ALetter),
        ...
        '\u{1172b}', WC_Extend), ('\u{11730}', '\u{11739}', WC_Numeric), ('\u{11800}', '\u{1182b}',
        WC_ALetter), ('\u{1182c}', '\u{1183a}', WC_Extend), ('\u{118a0}', '\u{118df}', WC_ALetter),
        ('\u{118e0}', '\u{118e9}', WC_Numeric), ('\u{118ff}', '\u{118ff}', WC_ALetter),
        ('\u{11a00}', '\u{11a00}', WC_ALetter), ('\u{11a01}', '\u{11a0a}', WC_Extend), ('\u{11a0b}',
        '\u{11a32}', WC_ALetter), ('\u{11a33}', '\u{11a39}', WC_Extend), ('\u{11a3a}', '\u{11a3a}',
        WC_ALetter), ('\u{11a3b}', '\u{11a3e}', WC_Extend), ('\u{11a47}', '\u{11a47}', WC_Extend),
        ('\u{11a50}', '\u{11a50}', WC_ALetter), ('\u{11a51}', '\u{11a5b}', WC_Extend), ('\u{11a5c}',
        '\u{11a83}', WC_ALetter), ('\u{11a86}', '\u{11a89}', WC_ALetter), ('\u{11a8a}', '\u{11a99}',
        WC_Extend), ('\u{11a9d}', '\u{11a9d}', WC_ALetter), ('\u{11ac0}', '\u{11af8}', WC_ALetter),
        ...
        ('\u{14400}', '\u{14646}', WC_ALetter), ('\u{16800}', '\u{16a38}', WC_ALetter),
        ...
        ('\u{16f00}', '\u{16f44}', WC_ALetter), ('\u{16f50}', '\u{16f50}', WC_ALetter),
        ('\u{16f51}', '\u{16f7e}', WC_Extend), ('\u{16f8f}', '\u{16f92}', WC_Extend), ('\u{16f93}',
        '\u{16f9f}', WC_ALetter), ('\u{16fe0}', '\u{16fe1}', WC_ALetter), ('\u{1b000}', '\u{1b000}',
        WC_Katakana), ('\u{1bc00}', '\u{1bc6a}', WC_ALetter), ('\u{1bc70}', '\u{1bc7c}',
        WC_ALetter), ('\u{1bc80}', '\u{1bc88}', WC_ALetter), ('\u{1bc90}', '\u{1bc99}', WC_ALetter),
        ('\u{1bc9d}', '\u{1bc9e}', WC_Extend), ('\u{1bca0}', '\u{1bca3}', WC_Format), ('\u{1d165}',
        '\u{1d169}', WC_Extend), ('\u{1d16d}', '\u{1d172}', WC_Extend), ('\u{1d173}', '\u{1d17a}',
        WC_Format), ('\u{1d17b}', '\u{1d182}', WC_Extend), ('\u{1d185}', '\u{1d18b}', WC_Extend),
        ('\u{1d1aa}', '\u{1d1ad}', WC_Extend), ('\u{1d242}', '\u{1d244}', WC_Extend), ('\u{1d400}',
        '\u{1d454}', WC_ALetter), ('\u{1d456}', '\u{1d49c}', WC_ALetter), ('\u{1d49e}', '\u{1d49f}',
        WC_ALetter), ('\u{1d4a2}', '\u{1d4a2}', WC_ALetter), ('\u{1d4a5}', '\u{1d4a6}', WC_ALetter),
        ...
        WC_Extend), ('\u{1daa1}', '\u{1daaf}', WC_Extend), ('\u{1e000}', '\u{1e006}', WC_Extend),
        ('\u{1e008}', '\u{1e018}', WC_Extend), ('\u{1e01b}', '\u{1e021}', WC_Extend), ('\u{1e023}',
        '\u{1e024}', WC_Extend), ('\u{1e026}', '\u{1e02a}', WC_Extend), ('\u{1e800}', '\u{1e8c4}',
        WC_ALetter), ('\u{1e8d0}', '\u{1e8d6}', WC_Extend), ('\u{1e900}', '\u{1e943}', WC_ALetter),
        ('\u{1e944}', '\u{1e94a}', WC_Extend), ('\u{1e950}', '\u{1e959}', WC_Numeric), ('\u{1ee00}',
        '\u{1ee03}', WC_ALetter), ('\u{1ee05}', '\u{1ee1f}', WC_ALetter), ('\u{1ee21}', '\u{1ee22}',
        WC_ALetter), ('\u{1ee24}', '\u{1ee24}', WC_ALetter), ('\u{1ee27}', '\u{1ee27}', WC_ALetter),
...
pub mod sentence {
    ...
    const sentence_cat_table: &'static [(char, char, SentenceCat)] = &[
        ...
        ('\u{e81}', '\u{e82}', SC_OLetter), ('\u{e84}', '\u{e84}', SC_OLetter), ('\u{e87}',
        '\u{e88}', SC_OLetter), ('\u{e8a}', '\u{e8a}', SC_OLetter), ('\u{e8d}', '\u{e8d}',
        SC_OLetter), ('\u{e94}', '\u{e97}', SC_OLetter), ('\u{e99}', '\u{e9f}', SC_OLetter),
        ('\u{ea1}', '\u{ea3}', SC_OLetter), ('\u{ea5}', '\u{ea5}', SC_OLetter), ('\u{ea7}',
        '\u{ea7}', SC_OLetter), ('\u{eaa}', '\u{eab}', SC_OLetter), ('\u{ead}', '\u{eb0}',
        SC_OLetter), ('\u{eb1}', '\u{eb1}', SC_Extend), ('\u{eb2}', '\u{eb3}', SC_OLetter),
        ('\u{eb4}', '\u{eb9}', SC_Extend), ('\u{ebb}', '\u{ebc}', SC_Extend), ('\u{ebd}', '\u{ebd}',
        SC_OLetter), ('\u{ec0}', '\u{ec4}', SC_OLetter), ('\u{ec6}', '\u{ec6}', SC_OLetter),
        ('\u{ec8}', '\u{ecd}', SC_Extend), ('\u{ed0}', '\u{ed9}', SC_Numeric), ('\u{edc}',
        '\u{edf}', SC_OLetter), ('\u{f00}', '\u{f00}', SC_OLetter), ('\u{f18}', '\u{f19}',
        SC_Extend), ('\u{f20}', '\u{f29}', SC_Numeric), ('\u{f35}', '\u{f35}', SC_Extend),
        ('\u{f37}', '\u{f37}', SC_Extend), ('\u{f39}', '\u{f39}', SC_Extend), ('\u{f3a}', '\u{f3d}',
        SC_Close), ('\u{f3e}', '\u{f3f}', SC_Extend), ('\u{f40}', '\u{f47}', SC_OLetter),
        ('\u{f49}', '\u{f6c}', SC_OLetter), ('\u{f71}', '\u{f84}', SC_Extend), ('\u{f86}',
        '\u{f87}', SC_Extend), ('\u{f88}', '\u{f8c}', SC_OLetter), ('\u{f8d}', '\u{f97}',
        SC_Extend), ('\u{f99}', '\u{fbc}', SC_Extend), ('\u{fc6}', '\u{fc6}', SC_Extend),
        ...
        '\u{10cd}', SC_Upper), ('\u{10d0}', '\u{10fa}', SC_Lower), ('\u{10fc}', '\u{10fc}',
        SC_OLetter), ('\u{10fd}', '\u{10ff}', SC_Lower), ('\u{1100}', '\u{1248}', SC_OLetter),
        ('\u{124a}', '\u{124d}', SC_OLetter), ('\u{1250}', '\u{1256}', SC_OLetter), ('\u{1258}',
        '\u{1258}', SC_OLetter), ('\u{125a}', '\u{125d}', SC_OLetter), ('\u{1260}', '\u{1288}',
        SC_OLetter), ('\u{128a}', '\u{128d}', SC_OLetter), ('\u{1290}', '\u{12b0}', SC_OLetter),
        ('\u{12b2}', '\u{12b5}', SC_OLetter), ('\u{12b8}', '\u{12be}', SC_OLetter), ('\u{12c0}',
        '\u{12c0}', SC_OLetter), ('\u{12c2}', '\u{12c5}', SC_OLetter), ('\u{12c8}', '\u{12d6}',
        SC_OLetter), ('\u{12d8}', '\u{1310}', SC_OLetter), ('\u{1312}', '\u{1315}', SC_OLetter),
        ('\u{1318}', '\u{135a}', SC_OLetter), ('\u{135d}', '\u{135f}', SC_Extend), ('\u{1362}',
        '\u{1362}', SC_STerm), ('\u{1367}', '\u{1368}', SC_STerm), ('\u{1380}', '\u{138f}',
        SC_OLetter), ('\u{13a0}', '\u{13f5}', SC_Upper), ('\u{13f8}', '\u{13fd}', SC_Lower),
        ('\u{1401}', '\u{166c}', SC_OLetter), ('\u{166e}', '\u{166e}', SC_STerm), ('\u{166f}',
        '\u{167f}', SC_OLetter), ('\u{1680}', '\u{1680}', SC_Sp), ('\u{1681}', '\u{169a}',
        SC_OLetter), ('\u{169b}', '\u{169c}', SC_Close), ('\u{16a0}', '\u{16ea}', SC_OLetter),
        ('\u{16ee}', '\u{16f8}', SC_OLetter), ('\u{1700}', '\u{170c}', SC_OLetter), ('\u{170e}',
        '\u{1711}', SC_OLetter), ('\u{1712}', '\u{1714}', SC_Extend), ('\u{1720}', '\u{1731}',
        SC_OLetter), ('\u{1732}', '\u{1734}', SC_Extend), ('\u{1735}', '\u{1736}', SC_STerm),
        ('\u{1740}', '\u{1751}', SC_OLetter), ('\u{1752}', '\u{1753}', SC_Extend), ('\u{1760}',
        '\u{176c}', SC_OLetter), ('\u{176e}', '\u{1770}', SC_OLetter), ('\u{1772}', '\u{1773}',
        SC_Extend), ('\u{1780}', '\u{17b3}', SC_OLetter), ('\u{17b4}', '\u{17d3}', SC_Extend),
        ('\u{17d7}', '\u{17d7}', SC_OLetter), ('\u{17dc}', '\u{17dc}', SC_OLetter), ('\u{17dd}',
        '\u{17dd}', SC_Extend), ('\u{17e0}', '\u{17e9}', SC_Numeric), ('\u{1802}', '\u{1802}',
        SC_SContinue), ('\u{1803}', '\u{1803}', SC_STerm), ('\u{1808}', '\u{1808}', SC_SContinue),
        ('\u{1809}', '\u{1809}', SC_STerm), ('\u{180b}', '\u{180d}', SC_Extend), ('\u{180e}',
        '\u{180e}', SC_Format), ('\u{1810}', '\u{1819}', SC_Numeric), ('\u{1820}', '\u{1878}',
        ...
        SC_OLetter), ('\u{19b0}', '\u{19c9}', SC_OLetter), ('\u{19d0}', '\u{19d9}', SC_Numeric),
        ...
        '\u{1aab}', SC_STerm), ('\u{1ab0}', '\u{1abe}', SC_Extend), ('\u{1b00}', '\u{1b04}',
        SC_Extend), ('\u{1b05}', '\u{1b33}', SC_OLetter), ('\u{1b34}', '\u{1b44}', SC_Extend),
        ('\u{1b45}', '\u{1b4b}', SC_OLetter), ('\u{1b50}', '\u{1b59}', SC_Numeric), ('\u{1b5a}',
        '\u{1b5b}', SC_STerm), ('\u{1b5e}', '\u{1b5f}', SC_STerm), ('\u{1b6b}', '\u{1b73}',
        SC_Extend), ('\u{1b80}', '\u{1b82}', SC_Extend), ('\u{1b83}', '\u{1ba0}', SC_OLetter),
        ('\u{1ba1}', '\u{1bad}', SC_Extend), ('\u{1bae}', '\u{1baf}', SC_OLetter), ('\u{1bb0}',
        '\u{1bb9}', SC_Numeric), ('\u{1bba}', '\u{1be5}', SC_OLetter), ('\u{1be6}', '\u{1bf3}',
        SC_Extend), ('\u{1c00}', '\u{1c23}', SC_OLetter), ('\u{1c24}', '\u{1c37}', SC_Extend),
        ('\u{1c3b}', '\u{1c3c}', SC_STerm), ('\u{1c40}', '\u{1c49}', SC_Numeric), ('\u{1c4d}',
        '\u{1c4f}', SC_OLetter), ('\u{1c50}', '\u{1c59}', SC_Numeric), ('\u{1c5a}', '\u{1c7d}',
        SC_OLetter), ('\u{1c7e}', '\u{1c7f}', SC_STerm), ('\u{1c80}', '\u{1c88}', SC_Lower),
        ('\u{1c90}', '\u{1cba}', SC_Upper), ('\u{1cbd}', '\u{1cbf}', SC_Upper), ('\u{1cd0}',
        '\u{1cd2}', SC_Extend), ('\u{1cd4}', '\u{1ce8}', SC_Extend), ('\u{1ce9}', '\u{1cec}',
        SC_OLetter), ('\u{1ced}', '\u{1ced}', SC_Extend), ('\u{1cee}', '\u{1cf1}', SC_OLetter),
        ('\u{1cf2}', '\u{1cf4}', SC_Extend), ('\u{1cf5}', '\u{1cf6}', SC_OLetter), ('\u{1cf7}',
        '\u{1cf9}', SC_Extend), ('\u{1d00}', '\u{1dbf}', SC_Lower), ('\u{1dc0}', '\u{1df9}',
        SC_Extend), ('\u{1dfb}', '\u{1dff}', SC_Extend), ('\u{1e00}', '\u{1e00}', SC_Upper),
        ('\u{1e01}', '\u{1e01}', SC_Lower), ('\u{1e02}', '\u{1e02}', SC_Upper), ('\u{1e03}',
        '\u{1e03}', SC_Lower), ('\u{1e04}', '\u{1e04}', SC_Upper), ('\u{1e05}', '\u{1e05}',
        SC_Lower), ('\u{1e06}', '\u{1e06}', SC_Upper), ('\u{1e07}', '\u{1e07}', SC_Lower),
        ('\u{1e08}', '\u{1e08}', SC_Upper), ('\u{1e09}', '\u{1e09}', SC_Lower), ('\u{1e0a}',
        '\u{1e0a}', SC_Upper), ('\u{1e0b}', '\u{1e0b}', SC_Lower), ('\u{1e0c}', '\u{1e0c}',
        SC_Upper), ('\u{1e0d}', '\u{1e0d}', SC_Lower), ('\u{1e0e}', '\u{1e0e}', SC_Upper),
        ('\u{1e0f}', '\u{1e0f}', SC_Lower), ('\u{1e10}', '\u{1e10}', SC_Upper), ('\u{1e11}',
        '\u{1e11}', SC_Lower), ('\u{1e12}', '\u{1e12}', SC_Upper), ('\u{1e13}', '\u{1e13}',
        SC_Lower), ('\u{1e14}', '\u{1e14}', SC_Upper), ('\u{1e15}', '\u{1e15}', SC_Lower),
        ('\u{1e16}', '\u{1e16}', SC_Upper), ('\u{1e17}', '\u{1e17}', SC_Lower), ('\u{1e18}',
        '\u{1e18}', SC_Upper), ('\u{1e19}', '\u{1e19}', SC_Lower), ('\u{1e1a}', '\u{1e1a}',
        SC_Upper), ('\u{1e1b}', '\u{1e1b}', SC_Lower), ('\u{1e1c}', '\u{1e1c}', SC_Upper),
        ('\u{1e1d}', '\u{1e1d}', SC_Lower), ('\u{1e1e}', '\u{1e1e}', SC_Upper), ('\u{1e1f}',
        '\u{1e1f}', SC_Lower), ('\u{1e20}', '\u{1e20}', SC_Upper), ('\u{1e21}', '\u{1e21}',
        SC_Lower), ('\u{1e22}', '\u{1e22}', SC_Upper), ('\u{1e23}', '\u{1e23}', SC_Lower),
        ('\u{1e24}', '\u{1e24}', SC_Upper), ('\u{1e25}', '\u{1e25}', SC_Lower), ('\u{1e26}',
        '\u{1e26}', SC_Upper), ('\u{1e27}', '\u{1e27}', SC_Lower), ('\u{1e28}', '\u{1e28}',
        SC_Upper), ('\u{1e29}', '\u{1e29}', SC_Lower), ('\u{1e2a}', '\u{1e2a}', SC_Upper),
        ('\u{1e2b}', '\u{1e2b}', SC_Lower), ('\u{1e2c}', '\u{1e2c}', SC_Upper), ('\u{1e2d}',
        '\u{1e2d}', SC_Lower), ('\u{1e2e}', '\u{1e2e}', SC_Upper), ('\u{1e2f}', '\u{1e2f}',
        SC_Lower), ('\u{1e30}', '\u{1e30}', SC_Upper), ('\u{1e31}', '\u{1e31}', SC_Lower),
        ('\u{1e32}', '\u{1e32}', SC_Upper), ('\u{1e33}', '\u{1e33}', SC_Lower), ('\u{1e34}',
        '\u{1e34}', SC_Upper), ('\u{1e35}', '\u{1e35}', SC_Lower), ('\u{1e36}', '\u{1e36}',
        SC_Upper), ('\u{1e37}', '\u{1e37}', SC_Lower), ('\u{1e38}', '\u{1e38}', SC_Upper),
        ('\u{1e39}', '\u{1e39}', SC_Lower), ('\u{1e3a}', '\u{1e3a}', SC_Upper), ('\u{1e3b}',
        '\u{1e3b}', SC_Lower), ('\u{1e3c}', '\u{1e3c}', SC_Upper), ('\u{1e3d}', '\u{1e3d}',
        SC_Lower), ('\u{1e3e}', '\u{1e3e}', SC_Upper), ('\u{1e3f}', '\u{1e3f}', SC_Lower),
        ('\u{1e40}', '\u{1e40}', SC_Upper), ('\u{1e41}', '\u{1e41}', SC_Lower), ('\u{1e42}',
        '\u{1e42}', SC_Upper), ('\u{1e43}', '\u{1e43}', SC_Lower), ('\u{1e44}', '\u{1e44}',
        SC_Upper), ('\u{1e45}', '\u{1e45}', SC_Lower), ('\u{1e46}', '\u{1e46}', SC_Upper),
        ('\u{1e47}', '\u{1e47}', SC_Lower), ('\u{1e48}', '\u{1e48}', SC_Upper), ('\u{1e49}',
        '\u{1e49}', SC_Lower), ('\u{1e4a}', '\u{1e4a}', SC_Upper), ('\u{1e4b}', '\u{1e4b}',
        SC_Lower), ('\u{1e4c}', '\u{1e4c}', SC_Upper), ('\u{1e4d}', '\u{1e4d}', SC_Lower),
        ('\u{1e4e}', '\u{1e4e}', SC_Upper), ('\u{1e4f}', '\u{1e4f}', SC_Lower), ('\u{1e50}',
        '\u{1e50}', SC_Upper), ('\u{1e51}', '\u{1e51}', SC_Lower), ('\u{1e52}', '\u{1e52}',
        SC_Upper), ('\u{1e53}', '\u{1e53}', SC_Lower), ('\u{1e54}', '\u{1e54}', SC_Upper),
        ('\u{1e55}', '\u{1e55}', SC_Lower), ('\u{1e56}', '\u{1e56}', SC_Upper), ('\u{1e57}',
        '\u{1e57}', SC_Lower), ('\u{1e58}', '\u{1e58}', SC_Upper), ('\u{1e59}', '\u{1e59}',
        SC_Lower), ('\u{1e5a}', '\u{1e5a}', SC_Upper), ('\u{1e5b}', '\u{1e5b}', SC_Lower),
        ('\u{1e5c}', '\u{1e5c}', SC_Upper), ('\u{1e5d}', '\u{1e5d}', SC_Lower), ('\u{1e5e}',
        '\u{1e5e}', SC_Upper), ('\u{1e5f}', '\u{1e5f}', SC_Lower), ('\u{1e60}', '\u{1e60}',
        SC_Upper), ('\u{1e61}', '\u{1e61}', SC_Lower), ('\u{1e62}', '\u{1e62}', SC_Upper),
        ('\u{1e63}', '\u{1e63}', SC_Lower), ('\u{1e64}', '\u{1e64}', SC_Upper), ('\u{1e65}',
        '\u{1e65}', SC_Lower), ('\u{1e66}', '\u{1e66}', SC_Upper), ('\u{1e67}', '\u{1e67}',
        SC_Lower), ('\u{1e68}', '\u{1e68}', SC_Upper), ('\u{1e69}', '\u{1e69}', SC_Lower),
        ('\u{1e6a}', '\u{1e6a}', SC_Upper), ('\u{1e6b}', '\u{1e6b}', SC_Lower), ('\u{1e6c}',
        '\u{1e6c}', SC_Upper), ('\u{1e6d}', '\u{1e6d}', SC_Lower), ('\u{1e6e}', '\u{1e6e}',
        SC_Upper), ('\u{1e6f}', '\u{1e6f}', SC_Lower), ('\u{1e70}', '\u{1e70}', SC_Upper),
        ('\u{1e71}', '\u{1e71}', SC_Lower), ('\u{1e72}', '\u{1e72}', SC_Upper), ('\u{1e73}',
        '\u{1e73}', SC_Lower), ('\u{1e74}', '\u{1e74}', SC_Upper), ('\u{1e75}', '\u{1e75}',
        SC_Lower), ('\u{1e76}', '\u{1e76}', SC_Upper), ('\u{1e77}', '\u{1e77}', SC_Lower),
        ('\u{1e78}', '\u{1e78}', SC_Upper), ('\u{1e79}', '\u{1e79}', SC_Lower), ('\u{1e7a}',
        '\u{1e7a}', SC_Upper), ('\u{1e7b}', '\u{1e7b}', SC_Lower), ('\u{1e7c}', '\u{1e7c}',
        SC_Upper), ('\u{1e7d}', '\u{1e7d}', SC_Lower), ('\u{1e7e}', '\u{1e7e}', SC_Upper),
        ('\u{1e7f}', '\u{1e7f}', SC_Lower), ('\u{1e80}', '\u{1e80}', SC_Upper), ('\u{1e81}',
        '\u{1e81}', SC_Lower), ('\u{1e82}', '\u{1e82}', SC_Upper), ('\u{1e83}', '\u{1e83}',
        SC_Lower), ('\u{1e84}', '\u{1e84}', SC_Upper), ('\u{1e85}', '\u{1e85}', SC_Lower),
        ('\u{1e86}', '\u{1e86}', SC_Upper), ('\u{1e87}', '\u{1e87}', SC_Lower), ('\u{1e88}',
        '\u{1e88}', SC_Upper), ('\u{1e89}', '\u{1e89}', SC_Lower), ('\u{1e8a}', '\u{1e8a}',
        SC_Upper), ('\u{1e8b}', '\u{1e8b}', SC_Lower), ('\u{1e8c}', '\u{1e8c}', SC_Upper),
        ('\u{1e8d}', '\u{1e8d}', SC_Lower), ('\u{1e8e}', '\u{1e8e}', SC_Upper), ('\u{1e8f}',
        '\u{1e8f}', SC_Lower), ('\u{1e90}', '\u{1e90}', SC_Upper), ('\u{1e91}', '\u{1e91}',
        SC_Lower), ('\u{1e92}', '\u{1e92}', SC_Upper), ('\u{1e93}', '\u{1e93}', SC_Lower),
        ('\u{1e94}', '\u{1e94}', SC_Upper), ('\u{1e95}', '\u{1e9d}', SC_Lower), ('\u{1e9e}',
        '\u{1e9e}', SC_Upper), ('\u{1e9f}', '\u{1e9f}', SC_Lower), ('\u{1ea0}', '\u{1ea0}',
        SC_Upper), ('\u{1ea1}', '\u{1ea1}', SC_Lower), ('\u{1ea2}', '\u{1ea2}', SC_Upper),
        ('\u{1ea3}', '\u{1ea3}', SC_Lower), ('\u{1ea4}', '\u{1ea4}', SC_Upper), ('\u{1ea5}',
        '\u{1ea5}', SC_Lower), ('\u{1ea6}', '\u{1ea6}', SC_Upper), ('\u{1ea7}', '\u{1ea7}',
        SC_Lower), ('\u{1ea8}', '\u{1ea8}', SC_Upper), ('\u{1ea9}', '\u{1ea9}', SC_Lower),
        ('\u{1eaa}', '\u{1eaa}', SC_Upper), ('\u{1eab}', '\u{1eab}', SC_Lower), ('\u{1eac}',
        '\u{1eac}', SC_Upper), ('\u{1ead}', '\u{1ead}', SC_Lower), ('\u{1eae}', '\u{1eae}',
        SC_Upper), ('\u{1eaf}', '\u{1eaf}', SC_Lower), ('\u{1eb0}', '\u{1eb0}', SC_Upper),
        ('\u{1eb1}', '\u{1eb1}', SC_Lower), ('\u{1eb2}', '\u{1eb2}', SC_Upper), ('\u{1eb3}',
        '\u{1eb3}', SC_Lower), ('\u{1eb4}', '\u{1eb4}', SC_Upper), ('\u{1eb5}', '\u{1eb5}',
        SC_Lower), ('\u{1eb6}', '\u{1eb6}', SC_Upper), ('\u{1eb7}', '\u{1eb7}', SC_Lower),
        ('\u{1eb8}', '\u{1eb8}', SC_Upper), ('\u{1eb9}', '\u{1eb9}', SC_Lower), ('\u{1eba}',
        '\u{1eba}', SC_Upper), ('\u{1ebb}', '\u{1ebb}', SC_Lower), ('\u{1ebc}', '\u{1ebc}',
        SC_Upper), ('\u{1ebd}', '\u{1ebd}', SC_Lower), ('\u{1ebe}', '\u{1ebe}', SC_Upper),
        ('\u{1ebf}', '\u{1ebf}', SC_Lower), ('\u{1ec0}', '\u{1ec0}', SC_Upper), ('\u{1ec1}',
        '\u{1ec1}', SC_Lower), ('\u{1ec2}', '\u{1ec2}', SC_Upper), ('\u{1ec3}', '\u{1ec3}',
        SC_Lower), ('\u{1ec4}', '\u{1ec4}', SC_Upper), ('\u{1ec5}', '\u{1ec5}', SC_Lower),
        ('\u{1ec6}', '\u{1ec6}', SC_Upper), ('\u{1ec7}', '\u{1ec7}', SC_Lower), ('\u{1ec8}',
        '\u{1ec8}', SC_Upper), ('\u{1ec9}', '\u{1ec9}', SC_Lower), ('\u{1eca}', '\u{1eca}',
        SC_Upper), ('\u{1ecb}', '\u{1ecb}', SC_Lower), ('\u{1ecc}', '\u{1ecc}', SC_Upper),
        ('\u{1ecd}', '\u{1ecd}', SC_Lower), ('\u{1ece}', '\u{1ece}', SC_Upper), ('\u{1ecf}',
        '\u{1ecf}', SC_Lower), ('\u{1ed0}', '\u{1ed0}', SC_Upper), ('\u{1ed1}', '\u{1ed1}',
        SC_Lower), ('\u{1ed2}', '\u{1ed2}', SC_Upper), ('\u{1ed3}', '\u{1ed3}', SC_Lower),
        ('\u{1ed4}', '\u{1ed4}', SC_Upper), ('\u{1ed5}', '\u{1ed5}', SC_Lower), ('\u{1ed6}',
        '\u{1ed6}', SC_Upper), ('\u{1ed7}', '\u{1ed7}', SC_Lower), ('\u{1ed8}', '\u{1ed8}',
        SC_Upper), ('\u{1ed9}', '\u{1ed9}', SC_Lower), ('\u{1eda}', '\u{1eda}', SC_Upper),
        ('\u{1edb}', '\u{1edb}', SC_Lower), ('\u{1edc}', '\u{1edc}', SC_Upper), ('\u{1edd}',
        '\u{1edd}', SC_Lower), ('\u{1ede}', '\u{1ede}', SC_Upper), ('\u{1edf}', '\u{1edf}',
        SC_Lower), ('\u{1ee0}', '\u{1ee0}', SC_Upper), ('\u{1ee1}', '\u{1ee1}', SC_Lower),
        ('\u{1ee2}', '\u{1ee2}', SC_Upper), ('\u{1ee3}', '\u{1ee3}', SC_Lower), ('\u{1ee4}',
        '\u{1ee4}', SC_Upper), ('\u{1ee5}', '\u{1ee5}', SC_Lower), ('\u{1ee6}', '\u{1ee6}',
        SC_Upper), ('\u{1ee7}', '\u{1ee7}', SC_Lower), ('\u{1ee8}', '\u{1ee8}', SC_Upper),
        ('\u{1ee9}', '\u{1ee9}', SC_Lower), ('\u{1eea}', '\u{1eea}', SC_Upper), ('\u{1eeb}',
        '\u{1eeb}', SC_Lower), ('\u{1eec}', '\u{1eec}', SC_Upper), ('\u{1eed}', '\u{1eed}',
        SC_Lower), ('\u{1eee}', '\u{1eee}', SC_Upper), ('\u{1eef}', '\u{1eef}', SC_Lower),
        ('\u{1ef0}', '\u{1ef0}', SC_Upper), ('\u{1ef1}', '\u{1ef1}', SC_Lower), ('\u{1ef2}',
        '\u{1ef2}', SC_Upper), ('\u{1ef3}', '\u{1ef3}', SC_Lower), ('\u{1ef4}', '\u{1ef4}',
        SC_Upper), ('\u{1ef5}', '\u{1ef5}', SC_Lower), ('\u{1ef6}', '\u{1ef6}', SC_Upper),
        ('\u{1ef7}', '\u{1ef7}', SC_Lower), ('\u{1ef8}', '\u{1ef8}', SC_Upper), ('\u{1ef9}',
        '\u{1ef9}', SC_Lower), ('\u{1efa}', '\u{1efa}', SC_Upper), ('\u{1efb}', '\u{1efb}',
        SC_Lower), ('\u{1efc}', '\u{1efc}', SC_Upper), ('\u{1efd}', '\u{1efd}', SC_Lower),
        ('\u{1efe}', '\u{1efe}', SC_Upper), ('\u{1eff}', '\u{1f07}', SC_Lower), ('\u{1f08}',
        '\u{1f0f}', SC_Upper), ('\u{1f10}', '\u{1f15}', SC_Lower), ('\u{1f18}', '\u{1f1d}',
        SC_Upper), ('\u{1f20}', '\u{1f27}', SC_Lower), ('\u{1f28}', '\u{1f2f}', SC_Upper),
        ('\u{1f30}', '\u{1f37}', SC_Lower), ('\u{1f38}', '\u{1f3f}', SC_Upper), ('\u{1f40}',
        '\u{1f45}', SC_Lower), ('\u{1f48}', '\u{1f4d}', SC_Upper), ('\u{1f50}', '\u{1f57}',
        SC_Lower), ('\u{1f59}', '\u{1f59}', SC_Upper), ('\u{1f5b}', '\u{1f5b}', SC_Upper),
        ('\u{1f5d}', '\u{1f5d}', SC_Upper), ('\u{1f5f}', '\u{1f5f}', SC_Upper), ('\u{1f60}',
        '\u{1f67}', SC_Lower), ('\u{1f68}', '\u{1f6f}', SC_Upper), ('\u{1f70}', '\u{1f7d}',
        SC_Lower), ('\u{1f80}', '\u{1f87}', SC_Lower), ('\u{1f88}', '\u{1f8f}', SC_Upper),
        ('\u{1f90}', '\u{1f97}', SC_Lower), ('\u{1f98}', '\u{1f9f}', SC_Upper), ('\u{1fa0}',
        '\u{1fa7}', SC_Lower), ('\u{1fa8}', '\u{1faf}', SC_Upper), ('\u{1fb0}', '\u{1fb4}',
        SC_Lower), ('\u{1fb6}', '\u{1fb7}', SC_Lower), ('\u{1fb8}', '\u{1fbc}', SC_Upper),
        ('\u{1fbe}', '\u{1fbe}', SC_Lower), ('\u{1fc2}', '\u{1fc4}', SC_Lower), ('\u{1fc6}',
        '\u{1fc7}', SC_Lower), ('\u{1fc8}', '\u{1fcc}', SC_Upper), ('\u{1fd0}', '\u{1fd3}',
        SC_Lower), ('\u{1fd6}', '\u{1fd7}', SC_Lower), ('\u{1fd8}', '\u{1fdb}', SC_Upper),
        ('\u{1fe0}', '\u{1fe7}', SC_Lower), ('\u{1fe8}', '\u{1fec}', SC_Upper), ('\u{1ff2}',
        '\u{1ff4}', SC_Lower), ('\u{1ff6}', '\u{1ff7}', SC_Lower), ('\u{1ff8}', '\u{1ffc}',
        SC_Upper), ('\u{2000}', '\u{200a}', SC_Sp), ('\u{200b}', '\u{200b}', SC_Format),
        ('\u{200c}', '\u{200d}', SC_Extend), ('\u{200e}', '\u{200f}', SC_Format), ('\u{2013}',
        '\u{2014}', SC_SContinue), ('\u{2018}', '\u{201f}', SC_Close), ('\u{2024}', '\u{2024}',
        SC_ATerm), ('\u{2028}', '\u{2029}', SC_Sep), ('\u{202a}', '\u{202e}', SC_Format),
        ('\u{202f}', '\u{202f}', SC_Sp), ('\u{2039}', '\u{203a}', SC_Close), ('\u{203c}',
        '\u{203d}', SC_STerm), ('\u{2045}', '\u{2046}', SC_Close), ('\u{2047}', '\u{2049}',
        SC_STerm), ('\u{205f}', '\u{205f}', SC_Sp), ('\u{2060}', '\u{2064}', SC_Format),
        ('\u{2066}', '\u{206f}', SC_Format), ('\u{2071}', '\u{2071}', SC_Lower), ('\u{207d}',
        '\u{207e}', SC_Close), ('\u{207f}', '\u{207f}', SC_Lower), ('\u{208d}', '\u{208e}',
        SC_Close), ('\u{2090}', '\u{209c}', SC_Lower), ('\u{20d0}', '\u{20f0}', SC_Extend),
        ('\u{2102}', '\u{2102}', SC_Upper), ('\u{2107}', '\u{2107}', SC_Upper), ('\u{210a}',
        '\u{210a}', SC_Lower), ('\u{210b}', '\u{210d}', SC_Upper), ('\u{210e}', '\u{210f}',
        SC_Lower), ('\u{2110}', '\u{2112}', SC_Upper), ('\u{2113}', '\u{2113}', SC_Lower),
        ('\u{2115}', '\u{2115}', SC_Upper), ('\u{2119}', '\u{211d}', SC_Upper), ('\u{2124}',
        '\u{2124}', SC_Upper), ('\u{2126}', '\u{2126}', SC_Upper), ('\u{2128}', '\u{2128}',
        SC_Upper), ('\u{212a}', '\u{212d}', SC_Upper), ('\u{212f}', '\u{212f}', SC_Lower),
        ('\u{2130}', '\u{2133}', SC_Upper), ('\u{2134}', '\u{2134}', SC_Lower), ('\u{2135}',
        '\u{2138}', SC_OLetter), ('\u{2139}', '\u{2139}', SC_Lower), ('\u{213c}', '\u{213d}',
        SC_Lower), ('\u{213e}', '\u{213f}', SC_Upper), ('\u{2145}', '\u{2145}', SC_Upper),
        ('\u{2146}', '\u{2149}', SC_Lower), ('\u{214e}', '\u{214e}', SC_Lower), ('\u{2160}',
        '\u{216f}', SC_Upper), ('\u{2170}', '\u{217f}', SC_Lower), ('\u{2180}', '\u{2182}',
        SC_OLetter), ('\u{2183}', '\u{2183}', SC_Upper), ('\u{2184}', '\u{2184}', SC_Lower),
        ('\u{2185}', '\u{2188}', SC_OLetter), ('\u{2308}', '\u{230b}', SC_Close), ('\u{2329}',
        '\u{232a}', SC_Close), ('\u{24b6}', '\u{24cf}', SC_Upper), ('\u{24d0}', '\u{24e9}',
        SC_Lower), ('\u{275b}', '\u{2760}', SC_Close), ('\u{2768}', '\u{2775}', SC_Close),
        ('\u{27c5}', '\u{27c6}', SC_Close), ('\u{27e6}', '\u{27ef}', SC_Close), ('\u{2983}',
        '\u{2998}', SC_Close), ('\u{29d8}', '\u{29db}', SC_Close), ('\u{29fc}', '\u{29fd}',
        SC_Close), ('\u{2c00}', '\u{2c2e}', SC_Upper), ('\u{2c30}', '\u{2c5e}', SC_Lower),
        ('\u{2c60}', '\u{2c60}', SC_Upper), ('\u{2c61}', '\u{2c61}', SC_Lower), ('\u{2c62}',
        '\u{2c64}', SC_Upper), ('\u{2c65}', '\u{2c66}', SC_Lower), ('\u{2c67}', '\u{2c67}',
        SC_Upper), ('\u{2c68}', '\u{2c68}', SC_Lower), ('\u{2c69}', '\u{2c69}', SC_Upper),
        ('\u{2c6a}', '\u{2c6a}', SC_Lower), ('\u{2c6b}', '\u{2c6b}', SC_Upper), ('\u{2c6c}',
        '\u{2c6c}', SC_Lower), ('\u{2c6d}', '\u{2c70}', SC_Upper), ('\u{2c71}', '\u{2c71}',
        SC_Lower), ('\u{2c72}', '\u{2c72}', SC_Upper), ('\u{2c73}', '\u{2c74}', SC_Lower),
        ('\u{2c75}', '\u{2c75}', SC_Upper), ('\u{2c76}', '\u{2c7d}', SC_Lower), ('\u{2c7e}',
        '\u{2c80}', SC_Upper), ('\u{2c81}', '\u{2c81}', SC_Lower), ('\u{2c82}', '\u{2c82}',
        SC_Upper), ('\u{2c83}', '\u{2c83}', SC_Lower), ('\u{2c84}', '\u{2c84}', SC_Upper),
        ('\u{2c85}', '\u{2c85}', SC_Lower), ('\u{2c86}', '\u{2c86}', SC_Upper), ('\u{2c87}',
        '\u{2c87}', SC_Lower), ('\u{2c88}', '\u{2c88}', SC_Upper), ('\u{2c89}', '\u{2c89}',
        SC_Lower), ('\u{2c8a}', '\u{2c8a}', SC_Upper), ('\u{2c8b}', '\u{2c8b}', SC_Lower),
        ('\u{2c8c}', '\u{2c8c}', SC_Upper), ('\u{2c8d}', '\u{2c8d}', SC_Lower), ('\u{2c8e}',
        '\u{2c8e}', SC_Upper), ('\u{2c8f}', '\u{2c8f}', SC_Lower), ('\u{2c90}', '\u{2c90}',
        SC_Upper), ('\u{2c91}', '\u{2c91}', SC_Lower), ('\u{2c92}', '\u{2c92}', SC_Upper),
        ('\u{2c93}', '\u{2c93}', SC_Lower), ('\u{2c94}', '\u{2c94}', SC_Upper), ('\u{2c95}',
        '\u{2c95}', SC_Lower), ('\u{2c96}', '\u{2c96}', SC_Upper), ('\u{2c97}', '\u{2c97}',
        SC_Lower), ('\u{2c98}', '\u{2c98}', SC_Upper), ('\u{2c99}', '\u{2c99}', SC_Lower),
        ('\u{2c9a}', '\u{2c9a}', SC_Upper), ('\u{2c9b}', '\u{2c9b}', SC_Lower), ('\u{2c9c}',
        '\u{2c9c}', SC_Upper), ('\u{2c9d}', '\u{2c9d}', SC_Lower), ('\u{2c9e}', '\u{2c9e}',
        SC_Upper), ('\u{2c9f}', '\u{2c9f}', SC_Lower), ('\u{2ca0}', '\u{2ca0}', SC_Upper),
        ('\u{2ca1}', '\u{2ca1}', SC_Lower), ('\u{2ca2}', '\u{2ca2}', SC_Upper), ('\u{2ca3}',
        '\u{2ca3}', SC_Lower), ('\u{2ca4}', '\u{2ca4}', SC_Upper), ('\u{2ca5}', '\u{2ca5}',
        SC_Lower), ('\u{2ca6}', '\u{2ca6}', SC_Upper), ('\u{2ca7}', '\u{2ca7}', SC_Lower),
        ('\u{2ca8}', '\u{2ca8}', SC_Upper), ('\u{2ca9}', '\u{2ca9}', SC_Lower), ('\u{2caa}',
        '\u{2caa}', SC_Upper), ('\u{2cab}', '\u{2cab}', SC_Lower), ('\u{2cac}', '\u{2cac}',
        SC_Upper), ('\u{2cad}', '\u{2cad}', SC_Lower), ('\u{2cae}', '\u{2cae}', SC_Upper),
        ('\u{2caf}', '\u{2caf}', SC_Lower), ('\u{2cb0}', '\u{2cb0}', SC_Upper), ('\u{2cb1}',
        '\u{2cb1}', SC_Lower), ('\u{2cb2}', '\u{2cb2}', SC_Upper), ('\u{2cb3}', '\u{2cb3}',
        SC_Lower), ('\u{2cb4}', '\u{2cb4}', SC_Upper), ('\u{2cb5}', '\u{2cb5}', SC_Lower),
        ('\u{2cb6}', '\u{2cb6}', SC_Upper), ('\u{2cb7}', '\u{2cb7}', SC_Lower), ('\u{2cb8}',
        '\u{2cb8}', SC_Upper), ('\u{2cb9}', '\u{2cb9}', SC_Lower), ('\u{2cba}', '\u{2cba}',
        SC_Upper), ('\u{2cbb}', '\u{2cbb}', SC_Lower), ('\u{2cbc}', '\u{2cbc}', SC_Upper),
        ('\u{2cbd}', '\u{2cbd}', SC_Lower), ('\u{2cbe}', '\u{2cbe}', SC_Upper), ('\u{2cbf}',
        '\u{2cbf}', SC_Lower), ('\u{2cc0}', '\u{2cc0}', SC_Upper), ('\u{2cc1}', '\u{2cc1}',
        SC_Lower), ('\u{2cc2}', '\u{2cc2}', SC_Upper), ('\u{2cc3}', '\u{2cc3}', SC_Lower),
        ('\u{2cc4}', '\u{2cc4}', SC_Upper), ('\u{2cc5}', '\u{2cc5}', SC_Lower), ('\u{2cc6}',
        '\u{2cc6}', SC_Upper), ('\u{2cc7}', '\u{2cc7}', SC_Lower), ('\u{2cc8}', '\u{2cc8}',
        SC_Upper), ('\u{2cc9}', '\u{2cc9}', SC_Lower), ('\u{2cca}', '\u{2cca}', SC_Upper),
        ('\u{2ccb}', '\u{2ccb}', SC_Lower), ('\u{2ccc}', '\u{2ccc}', SC_Upper), ('\u{2ccd}',
        '\u{2ccd}', SC_Lower), ('\u{2cce}', '\u{2cce}', SC_Upper), ('\u{2ccf}', '\u{2ccf}',
        SC_Lower), ('\u{2cd0}', '\u{2cd0}', SC_Upper), ('\u{2cd1}', '\u{2cd1}', SC_Lower),
        ('\u{2cd2}', '\u{2cd2}', SC_Upper), ('\u{2cd3}', '\u{2cd3}', SC_Lower), ('\u{2cd4}',
        '\u{2cd4}', SC_Upper), ('\u{2cd5}', '\u{2cd5}', SC_Lower), ('\u{2cd6}', '\u{2cd6}',
        SC_Upper), ('\u{2cd7}', '\u{2cd7}', SC_Lower), ('\u{2cd8}', '\u{2cd8}', SC_Upper),
        ('\u{2cd9}', '\u{2cd9}', SC_Lower), ('\u{2cda}', '\u{2cda}', SC_Upper), ('\u{2cdb}',
        '\u{2cdb}', SC_Lower), ('\u{2cdc}', '\u{2cdc}', SC_Upper), ('\u{2cdd}', '\u{2cdd}',
        SC_Lower), ('\u{2cde}', '\u{2cde}', SC_Upper), ('\u{2cdf}', '\u{2cdf}', SC_Lower),
        ('\u{2ce0}', '\u{2ce0}', SC_Upper), ('\u{2ce1}', '\u{2ce1}', SC_Lower), ('\u{2ce2}',
        '\u{2ce2}', SC_Upper), ('\u{2ce3}', '\u{2ce4}', SC_Lower), ('\u{2ceb}', '\u{2ceb}',
        SC_Upper), ('\u{2cec}', '\u{2cec}', SC_Lower), ('\u{2ced}', '\u{2ced}', SC_Upper),
        ('\u{2cee}', '\u{2cee}', SC_Lower), ('\u{2cef}', '\u{2cf1}', SC_Extend), ('\u{2cf2}',
        '\u{2cf2}', SC_Upper), ('\u{2cf3}', '\u{2cf3}', SC_Lower), ('\u{2d00}', '\u{2d25}',
        SC_Lower), ('\u{2d27}', '\u{2d27}', SC_Lower), ('\u{2d2d}', '\u{2d2d}', SC_Lower),
        ('\u{2d30}', '\u{2d67}', SC_OLetter), ('\u{2d6f}', '\u{2d6f}', SC_OLetter), ('\u{2d7f}',
        '\u{2d7f}', SC_Extend), ('\u{2d80}', '\u{2d96}', SC_OLetter), ('\u{2da0}', '\u{2da6}',
        SC_OLetter), ('\u{2da8}', '\u{2dae}', SC_OLetter), ('\u{2db0}', '\u{2db6}', SC_OLetter),
        ('\u{2db8}', '\u{2dbe}', SC_OLetter), ('\u{2dc0}', '\u{2dc6}', SC_OLetter), ('\u{2dc8}',
        '\u{2dce}', SC_OLetter), ('\u{2dd0}', '\u{2dd6}', SC_OLetter), ('\u{2dd8}', '\u{2dde}',
        SC_OLetter), ('\u{2de0}', '\u{2dff}', SC_Extend), ('\u{2e00}', '\u{2e0d}', SC_Close),
        ('\u{2e1c}', '\u{2e1d}', SC_Close), ('\u{2e20}', '\u{2e29}', SC_Close), ('\u{2e2e}',
        '\u{2e2e}', SC_STerm), ('\u{2e2f}', '\u{2e2f}', SC_OLetter), ('\u{2e3c}', '\u{2e3c}',
        SC_STerm), ('\u{2e42}', '\u{2e42}', SC_Close), ('\u{3000}', '\u{3000}', SC_Sp), ('\u{3001}',
        '\u{3001}', SC_SContinue), ('\u{3002}', '\u{3002}', SC_STerm), ('\u{3005}', '\u{3007}',
        SC_OLetter), ('\u{3008}', '\u{3011}', SC_Close), ('\u{3014}', '\u{301b}', SC_Close),
        ('\u{301d}', '\u{301f}', SC_Close), ('\u{3021}', '\u{3029}', SC_OLetter), ('\u{302a}',
        '\u{302f}', SC_Extend), ('\u{3031}', '\u{3035}', SC_OLetter), ('\u{3038}', '\u{303c}',
        SC_OLetter), ('\u{3041}', '\u{3096}', SC_OLetter), ('\u{3099}', '\u{309a}', SC_Extend),
        ('\u{309d}', '\u{309f}', SC_OLetter), ('\u{30a1}', '\u{30fa}', SC_OLetter), ('\u{30fc}',
        '\u{30ff}', SC_OLetter), ('\u{3105}', '\u{312f}', SC_OLetter), ('\u{3131}', '\u{318e}',
        SC_OLetter), ('\u{31a0}', '\u{31ba}', SC_OLetter), ('\u{31f0}', '\u{31ff}', SC_OLetter),
        ('\u{3400}', '\u{4db5}', SC_OLetter), ('\u{4e00}', '\u{9fef}', SC_OLetter), ('\u{a000}',
        ...
        SC_Lower), ('\u{a7f7}', '\u{a7f7}', SC_OLetter), ('\u{a7f8}', '\u{a7fa}', SC_Lower),
        ('\u{a7fb}', '\u{a801}', SC_OLetter), ('\u{a802}', '\u{a802}', SC_Extend), ('\u{a803}',
        '\u{a805}', SC_OLetter), ('\u{a806}', '\u{a806}', SC_Extend), ('\u{a807}', '\u{a80a}',
        SC_OLetter), ('\u{a80b}', '\u{a80b}', SC_Extend), ('\u{a80c}', '\u{a822}', SC_OLetter),
        ('\u{a823}', '\u{a827}', SC_Extend), ('\u{a840}', '\u{a873}', SC_OLetter), ('\u{a876}',
        '\u{a877}', SC_STerm), ('\u{a880}', '\u{a881}', SC_Extend), ('\u{a882}', '\u{a8b3}',
        SC_OLetter), ('\u{a8b4}', '\u{a8c5}', SC_Extend), ('\u{a8ce}', '\u{a8cf}', SC_STerm),
        ('\u{a8d0}', '\u{a8d9}', SC_Numeric), ('\u{a8e0}', '\u{a8f1}', SC_Extend), ('\u{a8f2}',
        '\u{a8f7}', SC_OLetter), ('\u{a8fb}', '\u{a8fb}', SC_OLetter), ('\u{a8fd}', '\u{a8fe}',
        SC_OLetter), ('\u{a8ff}', '\u{a8ff}', SC_Extend), ('\u{a900}', '\u{a909}', SC_Numeric),
        ('\u{a90a}', '\u{a925}', SC_OLetter), ('\u{a926}', '\u{a92d}', SC_Extend), ('\u{a92f}',
        '\u{a92f}', SC_STerm), ('\u{a930}', '\u{a946}', SC_OLetter), ('\u{a947}', '\u{a953}',
        SC_Extend), ('\u{a960}', '\u{a97c}', SC_OLetter), ('\u{a980}', '\u{a983}', SC_Extend),
        ('\u{a984}', '\u{a9b2}', SC_OLetter), ('\u{a9b3}', '\u{a9c0}', SC_Extend), ('\u{a9c8}',
        '\u{a9c9}', SC_STerm), ('\u{a9cf}', '\u{a9cf}', SC_OLetter), ('\u{a9d0}', '\u{a9d9}',
        SC_Numeric), ('\u{a9e0}', '\u{a9e4}', SC_OLetter), ('\u{a9e5}', '\u{a9e5}', SC_Extend),
        ('\u{a9e6}', '\u{a9ef}', SC_OLetter), ('\u{a9f0}', '\u{a9f9}', SC_Numeric), ('\u{a9fa}',
        '\u{a9fe}', SC_OLetter), ('\u{aa00}', '\u{aa28}', SC_OLetter), ('\u{aa29}', '\u{aa36}',
        SC_Extend), ('\u{aa40}', '\u{aa42}', SC_OLetter), ('\u{aa43}', '\u{aa43}', SC_Extend),
        ('\u{aa44}', '\u{aa4b}', SC_OLetter), ('\u{aa4c}', '\u{aa4d}', SC_Extend), ('\u{aa50}',
        '\u{aa59}', SC_Numeric), ('\u{aa5d}', '\u{aa5f}', SC_STerm), ('\u{aa60}', '\u{aa76}',
        SC_OLetter), ('\u{aa7a}', '\u{aa7a}', SC_OLetter), ('\u{aa7b}', '\u{aa7d}', SC_Extend),
        ('\u{aa7e}', '\u{aaaf}', SC_OLetter), ('\u{aab0}', '\u{aab0}', SC_Extend), ('\u{aab1}',
        '\u{aab1}', SC_OLetter), ('\u{aab2}', '\u{aab4}', SC_Extend), ('\u{aab5}', '\u{aab6}',
        SC_OLetter), ('\u{aab7}', '\u{aab8}', SC_Extend), ('\u{aab9}', '\u{aabd}', SC_OLetter),
        ('\u{aabe}', '\u{aabf}', SC_Extend), ('\u{aac0}', '\u{aac0}', SC_OLetter), ('\u{aac1}',
        '\u{aac1}', SC_Extend), ('\u{aac2}', '\u{aac2}', SC_OLetter), ('\u{aadb}', '\u{aadd}',
        SC_OLetter), ('\u{aae0}', '\u{aaea}', SC_OLetter), ('\u{aaeb}', '\u{aaef}', SC_Extend),
        ('\u{aaf0}', '\u{aaf1}', SC_STerm), ('\u{aaf2}', '\u{aaf4}', SC_OLetter), ('\u{aaf5}',
        '\u{aaf6}', SC_Extend), ('\u{ab01}', '\u{ab06}', SC_OLetter), ('\u{ab09}', '\u{ab0e}',
        SC_OLetter), ('\u{ab11}', '\u{ab16}', SC_OLetter), ('\u{ab20}', '\u{ab26}', SC_OLetter),
        ('\u{ab28}', '\u{ab2e}', SC_OLetter), ('\u{ab30}', '\u{ab5a}', SC_Lower), ('\u{ab5c}',
        '\u{ab65}', SC_Lower), ('\u{ab70}', '\u{abbf}', SC_Lower), ('\u{abc0}', '\u{abe2}',
        SC_OLetter), ('\u{abe3}', '\u{abea}', SC_Extend), ('\u{abeb}', '\u{abeb}', SC_STerm),
        ('\u{abec}', '\u{abed}', SC_Extend), ('\u{abf0}', '\u{abf9}', SC_Numeric), ('\u{ac00}',
        '\u{d7a3}', SC_OLetter), ('\u{d7b0}', '\u{d7c6}', SC_OLetter), ('\u{d7cb}', '\u{d7fb}',
        SC_OLetter), ('\u{f900}', '\u{fa6d}', SC_OLetter), ('\u{fa70}', '\u{fad9}', SC_OLetter),
        ('\u{fb00}', '\u{fb06}', SC_Lower), ('\u{fb13}', '\u{fb17}', SC_Lower), ('\u{fb1d}',
        '\u{fb1d}', SC_OLetter), ('\u{fb1e}', '\u{fb1e}', SC_Extend), ('\u{fb1f}', '\u{fb28}',
        SC_OLetter), ('\u{fb2a}', '\u{fb36}', SC_OLetter), ('\u{fb38}', '\u{fb3c}', SC_OLetter),
        ('\u{fb3e}', '\u{fb3e}', SC_OLetter), ('\u{fb40}', '\u{fb41}', SC_OLetter), ('\u{fb43}',
        '\u{fb44}', SC_OLetter), ('\u{fb46}', '\u{fbb1}', SC_OLetter), ('\u{fbd3}', '\u{fd3d}',
        SC_OLetter), ('\u{fd3e}', '\u{fd3f}', SC_Close), ('\u{fd50}', '\u{fd8f}', SC_OLetter),
        ('\u{fd92}', '\u{fdc7}', SC_OLetter), ('\u{fdf0}', '\u{fdfb}', SC_OLetter), ('\u{fe00}',
        '\u{fe0f}', SC_Extend), ('\u{fe10}', '\u{fe11}', SC_SContinue), ('\u{fe13}', '\u{fe13}',
        SC_SContinue), ('\u{fe17}', '\u{fe18}', SC_Close), ('\u{fe20}', '\u{fe2f}', SC_Extend),
        ('\u{fe31}', '\u{fe32}', SC_SContinue), ('\u{fe35}', '\u{fe44}', SC_Close), ('\u{fe47}',
        '\u{fe48}', SC_Close), ('\u{fe50}', '\u{fe51}', SC_SContinue), ('\u{fe52}', '\u{fe52}',
        SC_ATerm), ('\u{fe55}', '\u{fe55}', SC_SContinue), ('\u{fe56}', '\u{fe57}', SC_STerm),
        ('\u{fe58}', '\u{fe58}', SC_SContinue), ('\u{fe59}', '\u{fe5e}', SC_Close), ('\u{fe63}',
        '\u{fe63}', SC_SContinue), ('\u{fe70}', '\u{fe74}', SC_OLetter), ('\u{fe76}', '\u{fefc}',
        SC_OLetter), ('\u{feff}', '\u{feff}', SC_Format), ('\u{ff01}', '\u{ff01}', SC_STerm),
        ('\u{ff08}', '\u{ff09}', SC_Close), ('\u{ff0c}', '\u{ff0d}', SC_SContinue), ('\u{ff0e}',
        '\u{ff0e}', SC_ATerm), ('\u{ff1a}', '\u{ff1a}', SC_SContinue), ('\u{ff1f}', '\u{ff1f}',
        ...
        ('\u{10f46}', '\u{10f50}', SC_Extend), ('\u{10f55}', '\u{10f59}', SC_STerm), ('\u{11000}',
        '\u{11002}', SC_Extend), ('\u{11003}', '\u{11037}', SC_OLetter), ('\u{11038}', '\u{11046}',
        SC_Extend), ('\u{11047}', '\u{11048}', SC_STerm), ('\u{11066}', '\u{1106f}', SC_Numeric),
        ('\u{1107f}', '\u{11082}', SC_Extend), ('\u{11083}', '\u{110af}', SC_OLetter), ('\u{110b0}',
        '\u{110ba}', SC_Extend), ('\u{110bd}', '\u{110bd}', SC_Format), ('\u{110be}', '\u{110c1}',
        SC_STerm), ('\u{110cd}', '\u{110cd}', SC_Format), ('\u{110d0}', '\u{110e8}', SC_OLetter),
        ...
        ('\u{11145}', '\u{11146}', SC_Extend), ('\u{11150}', '\u{11172}', SC_OLetter), ('\u{11173}',
        '\u{11173}', SC_Extend), ('\u{11176}', '\u{11176}', SC_OLetter), ('\u{11180}', '\u{11182}',
        SC_Extend), ('\u{11183}', '\u{111b2}', SC_OLetter), ('\u{111b3}', '\u{111c0}', SC_Extend),
        ('\u{111c1}', '\u{111c4}', SC_OLetter), ('\u{111c5}', '\u{111c6}', SC_STerm), ('\u{111c9}',
        '\u{111cc}', SC_Extend), ('\u{111cd}', '\u{111cd}', SC_STerm), ('\u{111d0}', '\u{111d9}',
        ...
        '\u{11459}', SC_Numeric), ('\u{1145e}', '\u{1145e}', SC_Extend), ('\u{11480}', '\u{114af}',
        ...
        ('\u{118e0}', '\u{118e9}', SC_Numeric), ('\u{118ff}', '\u{118ff}', SC_OLetter),
        ('\u{11a00}', '\u{11a00}', SC_OLetter), ('\u{11a01}', '\u{11a0a}', SC_Extend), ('\u{11a0b}',
        '\u{11a32}', SC_OLetter), ('\u{11a33}', '\u{11a39}', SC_Extend), ('\u{11a3a}', '\u{11a3a}',
        SC_OLetter), ('\u{11a3b}', '\u{11a3e}', SC_Extend), ('\u{11a42}', '\u{11a43}', SC_STerm),
        ('\u{11a47}', '\u{11a47}', SC_Extend), ('\u{11a50}', '\u{11a50}', SC_OLetter), ('\u{11a51}',
        '\u{11a5b}', SC_Extend), ('\u{11a5c}', '\u{11a83}', SC_OLetter), ('\u{11a86}', '\u{11a89}',
        ...
        SC_OLetter), ('\u{14400}', '\u{14646}', SC_OLetter), ('\u{16800}', '\u{16a38}', SC_OLetter),
        ...
        ('\u{16e98}', '\u{16e98}', SC_STerm), ('\u{16f00}', '\u{16f44}', SC_OLetter), ('\u{16f50}',
        '\u{16f50}', SC_OLetter), ('\u{16f51}', '\u{16f7e}', SC_Extend), ('\u{16f8f}', '\u{16f92}',
        SC_Extend), ('\u{16f93}', '\u{16f9f}', SC_OLetter), ('\u{16fe0}', '\u{16fe1}', SC_OLetter),
        ('\u{17000}', '\u{187f1}', SC_OLetter), ('\u{18800}', '\u{18af2}', SC_OLetter),
        ('\u{1b000}', '\u{1b11e}', SC_OLetter), ('\u{1b170}', '\u{1b2fb}', SC_OLetter),
        ...
        SC_Extend), ('\u{1e800}', '\u{1e8c4}', SC_OLetter), ('\u{1e8d0}', '\u{1e8d6}', SC_Extend),
        ('\u{1e900}', '\u{1e921}', SC_Upper), ('\u{1e922}', '\u{1e943}', SC_Lower), ('\u{1e944}',
        '\u{1e94a}', SC_Extend), ('\u{1e950}', '\u{1e959}', SC_Numeric), ('\u{1ee00}', '\u{1ee03}',
        SC_OLetter), ('\u{1ee05}', '\u{1ee1f}', SC_OLetter), ('\u{1ee21}', '\u{1ee22}', SC_OLetter),
        ...
        '\u{1f189}', SC_Upper), ('\u{1f676}', '\u{1f678}', SC_Close), ('\u{20000}', '\u{2a6d6}',
        SC_OLetter), ('\u{2a700}', '\u{2b734}', SC_OLetter), ('\u{2b740}', '\u{2b81d}', SC_OLetter),
        ('\u{2b820}', '\u{2cea1}', SC_OLetter), ('\u{2ceb0}', '\u{2ebe0}', SC_OLetter),
        ('\u{2f800}', '\u{2fa1d}', SC_OLetter), ('\u{e0001}', '\u{e0001}', SC_Format), ('\u{e0020}',

...
mod derived_property {
    const Alphabetic_table: &'static [(char, char)] = &[
        ...
        ('\u{840}', '\u{858}'), ('\u{8a0}', '\u{8b2}'), ('\u{8e4}', '\u{8e9}'), ('\u{8f0}',
        ...
        ('\u{bd7}', '\u{bd7}'), ('\u{c00}', '\u{c03}'), ('\u{c05}', '\u{c0c}'), ('\u{c0e}',
        '\u{c10}'), ('\u{c12}', '\u{c28}'), ('\u{c2a}', '\u{c39}'), ('\u{c3d}', '\u{c44}'),
        ('\u{c46}', '\u{c48}'), ('\u{c4a}', '\u{c4c}'), ('\u{c55}', '\u{c56}'), ('\u{c58}',
        '\u{c59}'), ('\u{c60}', '\u{c63}'), ('\u{c81}', '\u{c83}'), ('\u{c85}', '\u{c8c}'),
        ('\u{c8e}', '\u{c90}'), ('\u{c92}', '\u{ca8}'), ('\u{caa}', '\u{cb3}'), ('\u{cb5}',
        '\u{cb9}'), ('\u{cbd}', '\u{cc4}'), ('\u{cc6}', '\u{cc8}'), ('\u{cca}', '\u{ccc}'),
        ('\u{cd5}', '\u{cd6}'), ('\u{cde}', '\u{cde}'), ('\u{ce0}', '\u{ce3}'), ('\u{cf1}',
        '\u{cf2}'), ('\u{d01}', '\u{d03}'), ('\u{d05}', '\u{d0c}'), ('\u{d0e}', '\u{d10}'),
        ('\u{d12}', '\u{d3a}'), ('\u{d3d}', '\u{d44}'), ('\u{d46}', '\u{d48}'), ('\u{d4a}',
        '\u{d4c}'), ('\u{d4e}', '\u{d4e}'), ('\u{d57}', '\u{d57}'), ('\u{d60}', '\u{d63}'),
        ('\u{d7a}', '\u{d7f}'), ('\u{d82}', '\u{d83}'), ('\u{d85}', '\u{d96}'), ('\u{d9a}',
        '\u{db1}'), ('\u{db3}', '\u{dbb}'), ('\u{dbd}', '\u{dbd}'), ('\u{dc0}', '\u{dc6}'),
        ('\u{dcf}', '\u{dd4}'), ('\u{dd6}', '\u{dd6}'), ('\u{dd8}', '\u{ddf}'), ('\u{df2}',
        '\u{df3}'), ('\u{e01}', '\u{e3a}'), ('\u{e40}', '\u{e46}'), ('\u{e4d}', '\u{e4d}'),
        ...
        '\u{eab}'), ('\u{ead}', '\u{eb9}'), ('\u{ebb}', '\u{ebd}'), ('\u{ec0}', '\u{ec4}'),
        ...
        '\u{1038}'), ('\u{103b}', '\u{103f}'), ('\u{1050}', '\u{1062}'), ('\u{1065}', '\u{1068}'),
        ('\u{106e}', '\u{1086}'), ('\u{108e}', '\u{108e}'), ('\u{109c}', '\u{109d}'), ('\u{10a0}',
        ...
        ('\u{1312}', '\u{1315}'), ('\u{1318}', '\u{135a}'), ('\u{135f}', '\u{135f}'), ('\u{1380}',
        '\u{138f}'), ('\u{13a0}', '\u{13f4}'), ('\u{1401}', '\u{166c}'), ('\u{166f}', '\u{167f}'),
        ('\u{1681}', '\u{169a}'), ('\u{16a0}', '\u{16ea}'), ('\u{16ee}', '\u{16f8}'), ('\u{1700}',
        '\u{170c}'), ('\u{170e}', '\u{1713}'), ('\u{1720}', '\u{1733}'), ('\u{1740}', '\u{1753}'),
        ('\u{1760}', '\u{176c}'), ('\u{176e}', '\u{1770}'), ('\u{1772}', '\u{1773}'), ('\u{1780}',
        '\u{17b3}'), ('\u{17b6}', '\u{17c8}'), ('\u{17d7}', '\u{17d7}'), ('\u{17dc}', '\u{17dc}'),
        ('\u{1820}', '\u{1877}'), ('\u{1880}', '\u{18aa}'), ('\u{18b0}', '\u{18f5}'), ('\u{1900}',
        '\u{191e}'), ('\u{1920}', '\u{192b}'), ('\u{1930}', '\u{1938}'), ('\u{1950}', '\u{196d}'),
        ('\u{1970}', '\u{1974}'), ('\u{1980}', '\u{19ab}'), ('\u{19b0}', '\u{19c9}'), ('\u{1a00}',
        '\u{1a1b}'), ('\u{1a20}', '\u{1a5e}'), ('\u{1a61}', '\u{1a74}'), ('\u{1aa7}', '\u{1aa7}'),
        ('\u{1b00}', '\u{1b33}'), ('\u{1b35}', '\u{1b43}'), ('\u{1b45}', '\u{1b4b}'), ('\u{1b80}',
        '\u{1ba9}'), ('\u{1bac}', '\u{1baf}'), ('\u{1bba}', '\u{1be5}'), ('\u{1be7}', '\u{1bf1}'),
        ('\u{1c00}', '\u{1c35}'), ('\u{1c4d}', '\u{1c4f}'), ('\u{1c5a}', '\u{1c7d}'), ('\u{1ce9}',
        ...
        '\u{a69d}'), ('\u{a69f}', '\u{a6ef}'), ('\u{a717}', '\u{a71f}'), ('\u{a722}', '\u{a788}'),
        ...
        '\u{a8fb}'), ('\u{a90a}', '\u{a92a}'), ('\u{a930}', '\u{a952}'), ('\u{a960}', '\u{a97c}'),
        ...
        '\u{10a33}'), ('\u{10a60}', '\u{10a7c}'), ('\u{10a80}', '\u{10a9c}'), ('\u{10ac0}',
        '\u{10ac7}'), ('\u{10ac9}', '\u{10ae4}'), ('\u{10b00}', '\u{10b35}'), ('\u{10b40}',
        '\u{10b55}'), ('\u{10b60}', '\u{10b72}'), ('\u{10b80}', '\u{10b91}'), ('\u{10c00}',
        '\u{10c48}'), ('\u{11000}', '\u{11045}'), ('\u{11082}', '\u{110b8}'), ('\u{110d0}',
        '\u{110e8}'), ('\u{11100}', '\u{11132}'), ('\u{11150}', '\u{11172}'), ('\u{11176}',
        '\u{11176}'), ('\u{11180}', '\u{111bf}'), ('\u{111c1}', '\u{111c4}'), ('\u{111da}',
        '\u{111da}'), ('\u{11200}', '\u{11211}'), ('\u{11213}', '\u{11234}'), ('\u{11237}',
        '\u{11237}'), ('\u{112b0}', '\u{112e8}'), ('\u{11301}', '\u{11303}'), ('\u{11305}',
        '\u{1130c}'), ('\u{1130f}', '\u{11310}'), ('\u{11313}', '\u{11328}'), ('\u{1132a}',
        '\u{11330}'), ('\u{11332}', '\u{11333}'), ('\u{11335}', '\u{11339}'), ('\u{1133d}',
        '\u{11344}'), ('\u{11347}', '\u{11348}'), ('\u{1134b}', '\u{1134c}'), ('\u{11357}',
        '\u{11357}'), ('\u{1135d}', '\u{11363}'), ('\u{11480}', '\u{114c1}'), ('\u{114c4}',
        '\u{114c5}'), ('\u{114c7}', '\u{114c7}'), ('\u{11580}', '\u{115b5}'), ('\u{115b8}',
        '\u{115be}'), ('\u{11600}', '\u{1163e}'), ('\u{11640}', '\u{11640}'), ('\u{11644}',
        '\u{11644}'), ('\u{11680}', '\u{116b5}'), ('\u{118a0}', '\u{118df}'), ('\u{118ff}',
        '\u{118ff}'), ('\u{11ac0}', '\u{11af8}'), ('\u{12000}', '\u{12398}'), ('\u{12400}',
        '\u{1246e}'), ('\u{13000}', '\u{1342e}'), ('\u{16800}', '\u{16a38}'), ('\u{16a40}',
        '\u{16a5e}'), ('\u{16ad0}', '\u{16aed}'), ('\u{16b00}', '\u{16b36}'), ('\u{16b40}',
        '\u{16b43}'), ('\u{16b63}', '\u{16b77}'), ('\u{16b7d}', '\u{16b8f}'), ('\u{16f00}',
        '\u{16f44}'), ('\u{16f50}', '\u{16f7e}'), ('\u{16f93}', '\u{16f9f}'), ('\u{1b000}',
...
pub mod grapheme {
    ...
    const grapheme_cat_table: &'static [(char, char, GraphemeCat)] = &[
        ...
        GC_Extend), ('\u{8e4}', '\u{902}', GC_Extend), ('\u{903}', '\u{903}', GC_SpacingMark),
        ...
        '\u{1a7f}', GC_Extend), ('\u{1ab0}', '\u{1abe}', GC_Extend), ('\u{1b00}', '\u{1b03}',
        GC_Extend), ('\u{1b04}', '\u{1b04}', GC_SpacingMark), ('\u{1b34}', '\u{1b34}', GC_Extend),
        ('\u{1b35}', '\u{1b35}', GC_SpacingMark), ('\u{1b36}', '\u{1b3a}', GC_Extend), ('\u{1b3b}',
...
pub mod word {
    ...
    const word_cat_table: &'static [(char, char, WordCat)] = &[
        ...
        ('\u{859}', '\u{85b}', WC_Extend), ('\u{8a0}', '\u{8b2}', WC_ALetter), ('\u{8e4}',
        '\u{903}', WC_Extend), ('\u{904}', '\u{939}', WC_ALetter), ('\u{93a}', '\u{93c}',
        WC_Extend), ('\u{93d}', '\u{93d}', WC_ALetter), ('\u{93e}', '\u{94f}', WC_Extend),
        ('\u{950}', '\u{950}', WC_ALetter), ('\u{951}', '\u{957}', WC_Extend), ('\u{958}',
        '\u{961}', WC_ALetter), ('\u{962}', '\u{963}', WC_Extend), ('\u{966}', '\u{96f}',
        WC_Numeric), ('\u{971}', '\u{980}', WC_ALetter), ('\u{981}', '\u{983}', WC_Extend),
        ('\u{985}', '\u{98c}', WC_ALetter), ('\u{98f}', '\u{990}', WC_ALetter), ('\u{993}',
        '\u{9a8}', WC_ALetter), ('\u{9aa}', '\u{9b0}', WC_ALetter), ('\u{9b2}', '\u{9b2}',
        WC_ALetter), ('\u{9b6}', '\u{9b9}', WC_ALetter), ('\u{9bc}', '\u{9bc}', WC_Extend),
        ('\u{9bd}', '\u{9bd}', WC_ALetter), ('\u{9be}', '\u{9c4}', WC_Extend), ('\u{9c7}',
        '\u{9c8}', WC_Extend), ('\u{9cb}', '\u{9cd}', WC_Extend), ('\u{9ce}', '\u{9ce}',
        WC_ALetter), ('\u{9d7}', '\u{9d7}', WC_Extend), ('\u{9dc}', '\u{9dd}', WC_ALetter),
        ('\u{9df}', '\u{9e1}', WC_ALetter), ('\u{9e2}', '\u{9e3}', WC_Extend), ('\u{9e6}',
        '\u{9ef}', WC_Numeric), ('\u{9f0}', '\u{9f1}', WC_ALetter), ('\u{a01}', '\u{a03}',
        WC_Extend), ('\u{a05}', '\u{a0a}', WC_ALetter), ('\u{a0f}', '\u{a10}', WC_ALetter),
        ('\u{a13}', '\u{a28}', WC_ALetter), ('\u{a2a}', '\u{a30}', WC_ALetter), ('\u{a32}',
        '\u{a33}', WC_ALetter), ('\u{a35}', '\u{a36}', WC_ALetter), ('\u{a38}', '\u{a39}',
        WC_ALetter), ('\u{a3c}', '\u{a3c}', WC_Extend), ('\u{a3e}', '\u{a42}', WC_Extend),
        ('\u{a47}', '\u{a48}', WC_Extend), ('\u{a4b}', '\u{a4d}', WC_Extend), ('\u{a51}', '\u{a51}',
        WC_Extend), ('\u{a59}', '\u{a5c}', WC_ALetter), ('\u{a5e}', '\u{a5e}', WC_ALetter),
        ('\u{a66}', '\u{a6f}', WC_Numeric), ('\u{a70}', '\u{a71}', WC_Extend), ('\u{a72}',
        '\u{a74}', WC_ALetter), ('\u{a75}', '\u{a75}', WC_Extend), ('\u{a81}', '\u{a83}',
        WC_Extend), ('\u{a85}', '\u{a8d}', WC_ALetter), ('\u{a8f}', '\u{a91}', WC_ALetter),
        ('\u{a93}', '\u{aa8}', WC_ALetter), ('\u{aaa}', '\u{ab0}', WC_ALetter), ('\u{ab2}',
        '\u{ab3}', WC_ALetter), ('\u{ab5}', '\u{ab9}', WC_ALetter), ('\u{abc}', '\u{abc}',
        WC_Extend), ('\u{abd}', '\u{abd}', WC_ALetter), ('\u{abe}', '\u{ac5}', WC_Extend),
        ('\u{ac7}', '\u{ac9}', WC_Extend), ('\u{acb}', '\u{acd}', WC_Extend), ('\u{ad0}', '\u{ad0}',
        WC_ALetter), ('\u{ae0}', '\u{ae1}', WC_ALetter), ('\u{ae2}', '\u{ae3}', WC_Extend),
        ('\u{ae6}', '\u{aef}', WC_Numeric), ('\u{b01}', '\u{b03}', WC_Extend), ('\u{b05}',
        '\u{b0c}', WC_ALetter), ('\u{b0f}', '\u{b10}', WC_ALetter), ('\u{b13}', '\u{b28}',
        WC_ALetter), ('\u{b2a}', '\u{b30}', WC_ALetter), ('\u{b32}', '\u{b33}', WC_ALetter),
        ('\u{b35}', '\u{b39}', WC_ALetter), ('\u{b3c}', '\u{b3c}', WC_Extend), ('\u{b3d}',
        '\u{b3d}', WC_ALetter), ('\u{b3e}', '\u{b44}', WC_Extend), ('\u{b47}', '\u{b48}',
        WC_Extend), ('\u{b4b}', '\u{b4d}', WC_Extend), ('\u{b56}', '\u{b57}', WC_Extend),
        ...
        '\u{bef}', WC_Numeric), ('\u{c00}', '\u{c03}', WC_Extend), ('\u{c05}', '\u{c0c}',
        ...
        WC_Numeric), ('\u{c81}', '\u{c83}', WC_Extend), ('\u{c85}', '\u{c8c}', WC_ALetter),
        ...
        '\u{cf2}', WC_ALetter), ('\u{d01}', '\u{d03}', WC_Extend), ('\u{d05}', '\u{d0c}',
        WC_ALetter), ('\u{d0e}', '\u{d10}', WC_ALetter), ('\u{d12}', '\u{d3a}', WC_ALetter),
        ('\u{d3d}', '\u{d3d}', WC_ALetter), ('\u{d3e}', '\u{d44}', WC_Extend), ('\u{d46}',
        '\u{d48}', WC_Extend), ('\u{d4a}', '\u{d4d}', WC_Extend), ('\u{d4e}', '\u{d4e}',
        ...
        '\u{dca}', WC_Extend), ('\u{dcf}', '\u{dd4}', WC_Extend), ('\u{dd6}', '\u{dd6}', WC_Extend),
        ('\u{dd8}', '\u{ddf}', WC_Extend), ('\u{de6}', '\u{def}', WC_Numeric), ('\u{df2}',
        '\u{df3}', WC_Extend), ('\u{e31}', '\u{e31}', WC_Extend), ('\u{e34}', '\u{e3a}', WC_Extend),
        ('\u{e47}', '\u{e4e}', WC_Extend), ('\u{e50}', '\u{e59}', WC_Numeric), ('\u{eb1}',
        '\u{eb1}', WC_Extend), ('\u{eb4}', '\u{eb9}', WC_Extend), ('\u{ebb}', '\u{ebc}', WC_Extend),
        ...
        '\u{16ea}', WC_ALetter), ('\u{16ee}', '\u{16f8}', WC_ALetter), ('\u{1700}', '\u{170c}',
        WC_ALetter), ('\u{170e}', '\u{1711}', WC_ALetter), ('\u{1712}', '\u{1714}', WC_Extend),
        ('\u{1720}', '\u{1731}', WC_ALetter), ('\u{1732}', '\u{1734}', WC_Extend), ('\u{1740}',
        '\u{1751}', WC_ALetter), ('\u{1752}', '\u{1753}', WC_Extend), ('\u{1760}', '\u{176c}',
        WC_ALetter), ('\u{176e}', '\u{1770}', WC_ALetter), ('\u{1772}', '\u{1773}', WC_Extend),
        ('\u{17b4}', '\u{17d3}', WC_Extend), ('\u{17dd}', '\u{17dd}', WC_Extend), ('\u{17e0}',
        '\u{17e9}', WC_Numeric), ('\u{180b}', '\u{180d}', WC_Extend), ('\u{180e}', '\u{180e}',
        WC_Format), ('\u{1810}', '\u{1819}', WC_Numeric), ('\u{1820}', '\u{1877}', WC_ALetter),
        ('\u{1880}', '\u{18a8}', WC_ALetter), ('\u{18a9}', '\u{18a9}', WC_Extend), ('\u{18aa}',
        '\u{18aa}', WC_ALetter), ('\u{18b0}', '\u{18f5}', WC_ALetter), ('\u{1900}', '\u{191e}',
        WC_ALetter), ('\u{1920}', '\u{192b}', WC_Extend), ('\u{1930}', '\u{193b}', WC_Extend),
        ('\u{1946}', '\u{194f}', WC_Numeric), ('\u{19b0}', '\u{19c0}', WC_Extend), ('\u{19c8}',
        '\u{19c9}', WC_Extend), ('\u{19d0}', '\u{19d9}', WC_Numeric), ('\u{1a00}', '\u{1a16}',
        WC_ALetter), ('\u{1a17}', '\u{1a1b}', WC_Extend), ('\u{1a55}', '\u{1a5e}', WC_Extend),
        ('\u{1a60}', '\u{1a7c}', WC_Extend), ('\u{1a7f}', '\u{1a7f}', WC_Extend), ('\u{1a80}',
        '\u{1a89}', WC_Numeric), ('\u{1a90}', '\u{1a99}', WC_Numeric), ('\u{1ab0}', '\u{1abe}',
        WC_Extend), ('\u{1b00}', '\u{1b04}', WC_Extend), ('\u{1b05}', '\u{1b33}', WC_ALetter),
        ('\u{1b34}', '\u{1b44}', WC_Extend), ('\u{1b45}', '\u{1b4b}', WC_ALetter), ('\u{1b50}',
        '\u{1b59}', WC_Numeric), ('\u{1b6b}', '\u{1b73}', WC_Extend), ('\u{1b80}', '\u{1b82}',
        WC_Extend), ('\u{1b83}', '\u{1ba0}', WC_ALetter), ('\u{1ba1}', '\u{1bad}', WC_Extend),
        ('\u{1bae}', '\u{1baf}', WC_ALetter), ('\u{1bb0}', '\u{1bb9}', WC_Numeric), ('\u{1bba}',
        '\u{1be5}', WC_ALetter), ('\u{1be6}', '\u{1bf3}', WC_Extend), ('\u{1c00}', '\u{1c23}',
        WC_ALetter), ('\u{1c24}', '\u{1c37}', WC_Extend), ('\u{1c40}', '\u{1c49}', WC_Numeric),
        ('\u{1c4d}', '\u{1c4f}', WC_ALetter), ('\u{1c50}', '\u{1c59}', WC_Numeric), ('\u{1c5a}',
        '\u{1c7d}', WC_ALetter), ('\u{1cd0}', '\u{1cd2}', WC_Extend), ('\u{1cd4}', '\u{1ce8}',
        WC_Extend), ('\u{1ce9}', '\u{1cec}', WC_ALetter), ('\u{1ced}', '\u{1ced}', WC_Extend),
        ('\u{1cee}', '\u{1cf1}', WC_ALetter), ('\u{1cf2}', '\u{1cf4}', WC_Extend), ('\u{1cf5}',
        '\u{1cf6}', WC_ALetter), ('\u{1cf8}', '\u{1cf9}', WC_Extend), ('\u{1d00}', '\u{1dbf}',
        WC_ALetter), ('\u{1dc0}', '\u{1df5}', WC_Extend), ('\u{1dfc}', '\u{1dff}', WC_Extend),
        ...
        WC_ALetter), ('\u{200c}', '\u{200d}', WC_Extend), ('\u{200e}', '\u{200f}', WC_Format),
        ('\u{2018}', '\u{2019}', WC_MidNumLet), ('\u{2024}', '\u{2024}', WC_MidNumLet), ('\u{2027}',
        '\u{2027}', WC_MidLetter), ('\u{2028}', '\u{2029}', WC_Newline), ('\u{202a}', '\u{202e}',
        WC_Format), ('\u{203f}', '\u{2040}', WC_ExtendNumLet), ('\u{2044}', '\u{2044}', WC_MidNum),
        ('\u{2054}', '\u{2054}', WC_ExtendNumLet), ('\u{2060}', '\u{2064}', WC_Format), ('\u{2066}',
        '\u{206f}', WC_Format), ('\u{2071}', '\u{2071}', WC_ALetter), ('\u{207f}', '\u{207f}',
        WC_ALetter), ('\u{2090}', '\u{209c}', WC_ALetter), ('\u{20d0}', '\u{20f0}', WC_Extend),
        ('\u{2102}', '\u{2102}', WC_ALetter), ('\u{2107}', '\u{2107}', WC_ALetter), ('\u{210a}',
        '\u{2113}', WC_ALetter), ('\u{2115}', '\u{2115}', WC_ALetter), ('\u{2119}', '\u{211d}',
        WC_ALetter), ('\u{2124}', '\u{2124}', WC_ALetter), ('\u{2126}', '\u{2126}', WC_ALetter),
        ('\u{2128}', '\u{2128}', WC_ALetter), ('\u{212a}', '\u{212d}', WC_ALetter), ('\u{212f}',
        '\u{2139}', WC_ALetter), ('\u{213c}', '\u{213f}', WC_ALetter), ('\u{2145}', '\u{2149}',
        WC_ALetter), ('\u{214e}', '\u{214e}', WC_ALetter), ('\u{2160}', '\u{2188}', WC_ALetter),
        ('\u{24b6}', '\u{24e9}', WC_ALetter), ('\u{2c00}', '\u{2c2e}', WC_ALetter), ('\u{2c30}',
        '\u{2c5e}', WC_ALetter), ('\u{2c60}', '\u{2ce4}', WC_ALetter), ('\u{2ceb}', '\u{2cee}',
        ...
        '\u{2e2f}', WC_ALetter), ('\u{3005}', '\u{3005}', WC_ALetter), ('\u{302a}', '\u{302f}',
        WC_Extend), ('\u{3031}', '\u{3035}', WC_Katakana), ('\u{303b}', '\u{303c}', WC_ALetter),
        ('\u{3099}', '\u{309a}', WC_Extend), ('\u{309b}', '\u{309c}', WC_Katakana), ('\u{30a0}',
        '\u{30fa}', WC_Katakana), ('\u{30fc}', '\u{30ff}', WC_Katakana), ('\u{3105}', '\u{312d}',
        WC_ALetter), ('\u{3131}', '\u{318e}', WC_ALetter), ('\u{31a0}', '\u{31ba}', WC_ALetter),
        ('\u{31f0}', '\u{31ff}', WC_Katakana), ('\u{32d0}', '\u{32fe}', WC_Katakana), ('\u{3300}',
        '\u{3357}', WC_Katakana), ('\u{a000}', '\u{a48c}', WC_ALetter), ('\u{a4d0}', '\u{a4fd}',
        WC_ALetter), ('\u{a500}', '\u{a60c}', WC_ALetter), ('\u{a610}', '\u{a61f}', WC_ALetter),
        ('\u{a620}', '\u{a629}', WC_Numeric), ('\u{a62a}', '\u{a62b}', WC_ALetter), ('\u{a640}',
        '\u{a66e}', WC_ALetter), ('\u{a66f}', '\u{a672}', WC_Extend), ('\u{a674}', '\u{a67d}',
        WC_Extend), ('\u{a67f}', '\u{a69d}', WC_ALetter), ('\u{a69f}', '\u{a69f}', WC_Extend),
        ('\u{a6a0}', '\u{a6ef}', WC_ALetter), ('\u{a6f0}', '\u{a6f1}', WC_Extend), ('\u{a717}',
        '\u{a71f}', WC_ALetter), ('\u{a722}', '\u{a788}', WC_ALetter), ('\u{a78b}', '\u{a78e}',
        WC_ALetter), ('\u{a790}', '\u{a7ad}', WC_ALetter), ('\u{a7b0}', '\u{a7b1}', WC_ALetter),
        ...
        '\u{a881}', WC_Extend), ('\u{a882}', '\u{a8b3}', WC_ALetter), ('\u{a8b4}', '\u{a8c4}',
        WC_Extend), ('\u{a8d0}', '\u{a8d9}', WC_Numeric), ('\u{a8e0}', '\u{a8f1}', WC_Extend),
        ('\u{a8f2}', '\u{a8f7}', WC_ALetter), ('\u{a8fb}', '\u{a8fb}', WC_ALetter), ('\u{a900}',
        ...
        '\u{ab5a}', WC_ALetter), ('\u{ab5c}', '\u{ab5f}', WC_ALetter), ('\u{ab64}', '\u{ab65}',
        WC_ALetter), ('\u{abc0}', '\u{abe2}', WC_ALetter), ('\u{abe3}', '\u{abea}', WC_Extend),
        ...
        ('\u{fe14}', '\u{fe14}', WC_MidNum), ('\u{fe20}', '\u{fe2d}', WC_Extend), ('\u{fe33}',
        ...
        WC_MidNumLet), ('\u{ff1a}', '\u{ff1a}', WC_MidLetter), ('\u{ff1b}', '\u{ff1b}', WC_MidNum),
        ...
        ('\u{10c00}', '\u{10c48}', WC_ALetter), ('\u{11000}', '\u{11002}', WC_Extend), ('\u{11003}',
        ...
        WC_Extend), ('\u{111c1}', '\u{111c4}', WC_ALetter), ('\u{111d0}', '\u{111d9}', WC_Numeric),
        ('\u{111da}', '\u{111da}', WC_ALetter), ('\u{11200}', '\u{11211}', WC_ALetter),
        ('\u{11213}', '\u{1122b}', WC_ALetter), ('\u{1122c}', '\u{11237}', WC_Extend), ('\u{112b0}',
        '\u{112de}', WC_ALetter), ('\u{112df}', '\u{112ea}', WC_Extend), ('\u{112f0}', '\u{112f9}',
        WC_Numeric), ('\u{11301}', '\u{11303}', WC_Extend), ('\u{11305}', '\u{1130c}', WC_ALetter),
        ...
        WC_Extend), ('\u{1134b}', '\u{1134d}', WC_Extend), ('\u{11357}', '\u{11357}', WC_Extend),
        ('\u{1135d}', '\u{11361}', WC_ALetter), ('\u{11362}', '\u{11363}', WC_Extend), ('\u{11366}',
        '\u{1136c}', WC_Extend), ('\u{11370}', '\u{11374}', WC_Extend), ('\u{11480}', '\u{114af}',
        WC_ALetter), ('\u{114b0}', '\u{114c3}', WC_Extend), ('\u{114c4}', '\u{114c5}', WC_ALetter),
        ('\u{114c7}', '\u{114c7}', WC_ALetter), ('\u{114d0}', '\u{114d9}', WC_Numeric),
        ('\u{11580}', '\u{115ae}', WC_ALetter), ('\u{115af}', '\u{115b5}', WC_Extend), ('\u{115b8}',
        '\u{115c0}', WC_Extend), ('\u{11600}', '\u{1162f}', WC_ALetter), ('\u{11630}', '\u{11640}',
        WC_Extend), ('\u{11644}', '\u{11644}', WC_ALetter), ('\u{11650}', '\u{11659}', WC_Numeric),
        ('\u{11680}', '\u{116aa}', WC_ALetter), ('\u{116ab}', '\u{116b7}', WC_Extend), ('\u{116c0}',
        '\u{116c9}', WC_Numeric), ('\u{118a0}', '\u{118df}', WC_ALetter), ('\u{118e0}', '\u{118e9}',
        WC_Numeric), ('\u{118ff}', '\u{118ff}', WC_ALetter), ('\u{11ac0}', '\u{11af8}', WC_ALetter),
        ('\u{12000}', '\u{12398}', WC_ALetter), ('\u{12400}', '\u{1246e}', WC_ALetter),
        ('\u{13000}', '\u{1342e}', WC_ALetter), ('\u{16800}', '\u{16a38}', WC_ALetter),
        ...
        '\u{16f92}', WC_Extend), ('\u{16f93}', '\u{16f9f}', WC_ALetter), ('\u{1b000}', '\u{1b000}',

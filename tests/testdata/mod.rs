...
#![allow(missing_docs, non_upper_case_globals, non_snake_case)]
    ...
    // http://www.unicode.org/Public/15.1.0/ucd/auxiliary/GraphemeBreakTest.txt
    pub const TEST_SAME: &[(&str, &[&str])] = &[
        ...
        "\u{ac01}"]), ("\u{20}\u{308}\u{ac01}", &["\u{20}\u{308}", "\u{ac01}"]), ("\u{20}\u{900}",
        &["\u{20}\u{900}"]), ("\u{20}\u{308}\u{900}", &["\u{20}\u{308}\u{900}"]), ("\u{20}\u{904}",
        ...
        &["\u{20}\u{300}"]), ("\u{20}\u{308}\u{300}", &["\u{20}\u{308}\u{300}"]), ("\u{20}\u{93c}",
        &["\u{20}\u{93c}"]), ("\u{20}\u{308}\u{93c}", &["\u{20}\u{308}\u{93c}"]), ("\u{20}\u{94d}",
        ...
        "\u{308}", "\u{1}"]), ("\u{d}\u{34f}", &["\u{d}", "\u{34f}"]), ("\u{d}\u{308}\u{34f}",
        &["\u{d}", "\u{308}\u{34f}"]), ("\u{d}\u{1f1e6}", &["\u{d}", "\u{1f1e6}"]),
        ...
        "\u{ac01}"]), ("\u{d}\u{900}", &["\u{d}", "\u{900}"]), ("\u{d}\u{308}\u{900}", &["\u{d}",
        "\u{308}\u{900}"]), ("\u{d}\u{903}", &["\u{d}", "\u{903}"]), ("\u{d}\u{904}", &["\u{d}",
        ...
        &["\u{d}", "\u{308}\u{300}"]), ("\u{d}\u{93c}", &["\u{d}", "\u{93c}"]),
        ("\u{d}\u{308}\u{93c}", &["\u{d}", "\u{308}\u{93c}"]), ("\u{d}\u{94d}", &["\u{d}",
        ...
        "\u{308}", "\u{1}"]), ("\u{a}\u{34f}", &["\u{a}", "\u{34f}"]), ("\u{a}\u{308}\u{34f}",
        &["\u{a}", "\u{308}\u{34f}"]), ("\u{a}\u{1f1e6}", &["\u{a}", "\u{1f1e6}"]),
        ...
        "\u{ac01}"]), ("\u{a}\u{900}", &["\u{a}", "\u{900}"]), ("\u{a}\u{308}\u{900}", &["\u{a}",
        "\u{308}\u{900}"]), ("\u{a}\u{903}", &["\u{a}", "\u{903}"]), ("\u{a}\u{904}", &["\u{a}",
        ...
        &["\u{a}", "\u{308}\u{300}"]), ("\u{a}\u{93c}", &["\u{a}", "\u{93c}"]),
        ("\u{a}\u{308}\u{93c}", &["\u{a}", "\u{308}\u{93c}"]), ("\u{a}\u{94d}", &["\u{a}",
        ...
        "\u{308}", "\u{1}"]), ("\u{1}\u{34f}", &["\u{1}", "\u{34f}"]), ("\u{1}\u{308}\u{34f}",
        &["\u{1}", "\u{308}\u{34f}"]), ("\u{1}\u{1f1e6}", &["\u{1}", "\u{1f1e6}"]),
        ...
        "\u{ac01}"]), ("\u{1}\u{900}", &["\u{1}", "\u{900}"]), ("\u{1}\u{308}\u{900}", &["\u{1}",
        "\u{308}\u{900}"]), ("\u{1}\u{903}", &["\u{1}", "\u{903}"]), ("\u{1}\u{904}", &["\u{1}",
        ...
        &["\u{1}", "\u{308}\u{300}"]), ("\u{1}\u{93c}", &["\u{1}", "\u{93c}"]),
        ("\u{1}\u{308}\u{93c}", &["\u{1}", "\u{308}\u{93c}"]), ("\u{1}\u{94d}", &["\u{1}",
        ...
        "\u{378}"]), ("\u{34f}\u{20}", &["\u{34f}", "\u{20}"]), ("\u{34f}\u{308}\u{20}",
        &["\u{34f}\u{308}", "\u{20}"]), ("\u{34f}\u{d}", &["\u{34f}", "\u{d}"]),
        ("\u{34f}\u{308}\u{d}", &["\u{34f}\u{308}", "\u{d}"]), ("\u{34f}\u{a}", &["\u{34f}",
        "\u{a}"]), ("\u{34f}\u{308}\u{a}", &["\u{34f}\u{308}", "\u{a}"]), ("\u{34f}\u{1}",
        &["\u{34f}", "\u{1}"]), ("\u{34f}\u{308}\u{1}", &["\u{34f}\u{308}", "\u{1}"]),
        ("\u{34f}\u{34f}", &["\u{34f}\u{34f}"]), ("\u{34f}\u{308}\u{34f}",
        &["\u{34f}\u{308}\u{34f}"]), ("\u{34f}\u{1f1e6}", &["\u{34f}", "\u{1f1e6}"]),
        ("\u{34f}\u{308}\u{1f1e6}", &["\u{34f}\u{308}", "\u{1f1e6}"]), ("\u{34f}\u{600}",
        &["\u{34f}", "\u{600}"]), ("\u{34f}\u{308}\u{600}", &["\u{34f}\u{308}", "\u{600}"]),
        ("\u{34f}\u{1100}", &["\u{34f}", "\u{1100}"]), ("\u{34f}\u{308}\u{1100}",
        ...
        ("\u{34f}\u{308}\u{ac01}", &["\u{34f}\u{308}", "\u{ac01}"]), ("\u{34f}\u{900}",
        &["\u{34f}\u{900}"]), ("\u{34f}\u{308}\u{900}", &["\u{34f}\u{308}\u{900}"]),
        ("\u{34f}\u{904}", &["\u{34f}", "\u{904}"]), ("\u{34f}\u{308}\u{904}", &["\u{34f}\u{308}",
        "\u{904}"]), ("\u{34f}\u{d4e}", &["\u{34f}", "\u{d4e}"]), ("\u{34f}\u{308}\u{d4e}",
        &["\u{34f}\u{308}", "\u{d4e}"]), ("\u{34f}\u{915}", &["\u{34f}", "\u{915}"]),
        ("\u{34f}\u{308}\u{915}", &["\u{34f}\u{308}", "\u{915}"]), ("\u{34f}\u{231a}", &["\u{34f}",
        "\u{231a}"]), ("\u{34f}\u{308}\u{231a}", &["\u{34f}\u{308}", "\u{231a}"]),
        ("\u{34f}\u{300}", &["\u{34f}\u{300}"]), ("\u{34f}\u{308}\u{300}",
        &["\u{34f}\u{308}\u{300}"]), ("\u{34f}\u{93c}", &["\u{34f}\u{93c}"]),
        ("\u{34f}\u{308}\u{93c}", &["\u{34f}\u{308}\u{93c}"]), ("\u{34f}\u{94d}",
        &["\u{34f}\u{94d}"]), ("\u{34f}\u{308}\u{94d}", &["\u{34f}\u{308}\u{94d}"]),
        ("\u{34f}\u{200d}", &["\u{34f}\u{200d}"]), ("\u{34f}\u{308}\u{200d}",
        &["\u{34f}\u{308}\u{200d}"]), ("\u{34f}\u{378}", &["\u{34f}", "\u{378}"]),
        ("\u{34f}\u{308}\u{378}", &["\u{34f}\u{308}", "\u{378}"]), ("\u{1f1e6}\u{20}",
        ...
        "\u{ac01}"]), ("\u{1f1e6}\u{900}", &["\u{1f1e6}\u{900}"]), ("\u{1f1e6}\u{308}\u{900}",
        &["\u{1f1e6}\u{308}\u{900}"]), ("\u{1f1e6}\u{904}", &["\u{1f1e6}", "\u{904}"]),
        ("\u{1f1e6}\u{308}\u{904}", &["\u{1f1e6}\u{308}", "\u{904}"]), ("\u{1f1e6}\u{d4e}",
        &["\u{1f1e6}", "\u{d4e}"]), ("\u{1f1e6}\u{308}\u{d4e}", &["\u{1f1e6}\u{308}", "\u{d4e}"]),
        ("\u{1f1e6}\u{915}", &["\u{1f1e6}", "\u{915}"]), ("\u{1f1e6}\u{308}\u{915}",
        &["\u{1f1e6}\u{308}", "\u{915}"]), ("\u{1f1e6}\u{231a}", &["\u{1f1e6}", "\u{231a}"]),
        ("\u{1f1e6}\u{308}\u{231a}", &["\u{1f1e6}\u{308}", "\u{231a}"]), ("\u{1f1e6}\u{300}",
        &["\u{1f1e6}\u{300}"]), ("\u{1f1e6}\u{308}\u{300}", &["\u{1f1e6}\u{308}\u{300}"]),
        ("\u{1f1e6}\u{93c}", &["\u{1f1e6}\u{93c}"]), ("\u{1f1e6}\u{308}\u{93c}",
        &["\u{1f1e6}\u{308}\u{93c}"]), ("\u{1f1e6}\u{94d}", &["\u{1f1e6}\u{94d}"]),
        ("\u{1f1e6}\u{308}\u{94d}", &["\u{1f1e6}\u{308}\u{94d}"]), ("\u{1f1e6}\u{200d}",
        &["\u{1f1e6}\u{200d}"]), ("\u{1f1e6}\u{308}\u{200d}", &["\u{1f1e6}\u{308}\u{200d}"]),
        ("\u{1f1e6}\u{378}", &["\u{1f1e6}", "\u{378}"]), ("\u{1f1e6}\u{308}\u{378}",
        &["\u{1f1e6}\u{308}", "\u{378}"]), ("\u{600}\u{308}\u{20}", &["\u{600}\u{308}", "\u{20}"]),
        ("\u{600}\u{d}", &["\u{600}", "\u{d}"]), ("\u{600}\u{308}\u{d}", &["\u{600}\u{308}",
        "\u{d}"]), ("\u{600}\u{a}", &["\u{600}", "\u{a}"]), ("\u{600}\u{308}\u{a}",
        &["\u{600}\u{308}", "\u{a}"]), ("\u{600}\u{1}", &["\u{600}", "\u{1}"]),
        ("\u{600}\u{308}\u{1}", &["\u{600}\u{308}", "\u{1}"]), ("\u{600}\u{34f}",
        &["\u{600}\u{34f}"]), ("\u{600}\u{308}\u{34f}", &["\u{600}\u{308}\u{34f}"]),
        ("\u{600}\u{308}\u{1f1e6}", &["\u{600}\u{308}", "\u{1f1e6}"]), ("\u{600}\u{308}\u{600}",
        &["\u{600}\u{308}", "\u{600}"]), ("\u{600}\u{308}\u{1100}", &["\u{600}\u{308}",
        "\u{1100}"]), ("\u{600}\u{308}\u{1160}", &["\u{600}\u{308}", "\u{1160}"]),
        ("\u{600}\u{308}\u{11a8}", &["\u{600}\u{308}", "\u{11a8}"]), ("\u{600}\u{308}\u{ac00}",
        &["\u{600}\u{308}", "\u{ac00}"]), ("\u{600}\u{308}\u{ac01}", &["\u{600}\u{308}",
        "\u{ac01}"]), ("\u{600}\u{900}", &["\u{600}\u{900}"]), ("\u{600}\u{308}\u{900}",
        &["\u{600}\u{308}\u{900}"]), ("\u{600}\u{308}\u{904}", &["\u{600}\u{308}", "\u{904}"]),
        ...
        &["\u{600}\u{308}\u{300}"]), ("\u{600}\u{93c}", &["\u{600}\u{93c}"]),
        ("\u{600}\u{308}\u{93c}", &["\u{600}\u{308}\u{93c}"]), ("\u{600}\u{94d}",
        ...
        "\u{1}"]), ("\u{a03}\u{308}\u{1}", &["\u{a03}\u{308}", "\u{1}"]), ("\u{a03}\u{34f}",
        &["\u{a03}\u{34f}"]), ("\u{a03}\u{308}\u{34f}", &["\u{a03}\u{308}\u{34f}"]),
        ...
        &["\u{a03}\u{308}", "\u{ac01}"]), ("\u{a03}\u{900}", &["\u{a03}\u{900}"]),
        ("\u{a03}\u{308}\u{900}", &["\u{a03}\u{308}\u{900}"]), ("\u{a03}\u{904}", &["\u{a03}",
        "\u{904}"]), ("\u{a03}\u{308}\u{904}", &["\u{a03}\u{308}", "\u{904}"]), ("\u{a03}\u{d4e}",
        &["\u{a03}", "\u{d4e}"]), ("\u{a03}\u{308}\u{d4e}", &["\u{a03}\u{308}", "\u{d4e}"]),
        ("\u{a03}\u{915}", &["\u{a03}", "\u{915}"]), ("\u{a03}\u{308}\u{915}", &["\u{a03}\u{308}",
        "\u{915}"]), ("\u{a03}\u{231a}", &["\u{a03}", "\u{231a}"]), ("\u{a03}\u{308}\u{231a}",
        &["\u{a03}\u{308}", "\u{231a}"]), ("\u{a03}\u{300}", &["\u{a03}\u{300}"]),
        ("\u{a03}\u{308}\u{300}", &["\u{a03}\u{308}\u{300}"]), ("\u{a03}\u{93c}",
        &["\u{a03}\u{93c}"]), ("\u{a03}\u{308}\u{93c}", &["\u{a03}\u{308}\u{93c}"]),
        ...
        &["\u{1100}\u{308}", "\u{ac01}"]), ("\u{1100}\u{900}", &["\u{1100}\u{900}"]),
        ("\u{1100}\u{308}\u{900}", &["\u{1100}\u{308}\u{900}"]), ("\u{1100}\u{904}", &["\u{1100}",
        "\u{904}"]), ("\u{1100}\u{308}\u{904}", &["\u{1100}\u{308}", "\u{904}"]),
        ("\u{1100}\u{d4e}", &["\u{1100}", "\u{d4e}"]), ("\u{1100}\u{308}\u{d4e}",
        &["\u{1100}\u{308}", "\u{d4e}"]), ("\u{1100}\u{915}", &["\u{1100}", "\u{915}"]),
        ("\u{1100}\u{308}\u{915}", &["\u{1100}\u{308}", "\u{915}"]), ("\u{1100}\u{231a}",
        &["\u{1100}", "\u{231a}"]), ("\u{1100}\u{308}\u{231a}", &["\u{1100}\u{308}", "\u{231a}"]),
        ("\u{1100}\u{300}", &["\u{1100}\u{300}"]), ("\u{1100}\u{308}\u{300}",
        &["\u{1100}\u{308}\u{300}"]), ("\u{1100}\u{93c}", &["\u{1100}\u{93c}"]),
        ("\u{1100}\u{308}\u{93c}", &["\u{1100}\u{308}\u{93c}"]), ("\u{1100}\u{94d}",
        ...
        &["\u{1160}\u{308}", "\u{ac01}"]), ("\u{1160}\u{900}", &["\u{1160}\u{900}"]),
        ("\u{1160}\u{308}\u{900}", &["\u{1160}\u{308}\u{900}"]), ("\u{1160}\u{904}", &["\u{1160}",
        "\u{904}"]), ("\u{1160}\u{308}\u{904}", &["\u{1160}\u{308}", "\u{904}"]),
        ...
        &["\u{1160}\u{308}\u{300}"]), ("\u{1160}\u{93c}", &["\u{1160}\u{93c}"]),
        ("\u{1160}\u{308}\u{93c}", &["\u{1160}\u{308}\u{93c}"]), ("\u{1160}\u{94d}",
        ...
        &["\u{11a8}\u{308}", "\u{ac01}"]), ("\u{11a8}\u{900}", &["\u{11a8}\u{900}"]),
        ("\u{11a8}\u{308}\u{900}", &["\u{11a8}\u{308}\u{900}"]), ("\u{11a8}\u{904}", &["\u{11a8}",
        "\u{904}"]), ("\u{11a8}\u{308}\u{904}", &["\u{11a8}\u{308}", "\u{904}"]),
        ("\u{11a8}\u{d4e}", &["\u{11a8}", "\u{d4e}"]), ("\u{11a8}\u{308}\u{d4e}",
        &["\u{11a8}\u{308}", "\u{d4e}"]), ("\u{11a8}\u{915}", &["\u{11a8}", "\u{915}"]),
        ("\u{11a8}\u{308}\u{915}", &["\u{11a8}\u{308}", "\u{915}"]), ("\u{11a8}\u{231a}",
        &["\u{11a8}", "\u{231a}"]), ("\u{11a8}\u{308}\u{231a}", &["\u{11a8}\u{308}", "\u{231a}"]),
        ("\u{11a8}\u{300}", &["\u{11a8}\u{300}"]), ("\u{11a8}\u{308}\u{300}",
        &["\u{11a8}\u{308}\u{300}"]), ("\u{11a8}\u{93c}", &["\u{11a8}\u{93c}"]),
        ("\u{11a8}\u{308}\u{93c}", &["\u{11a8}\u{308}\u{93c}"]), ("\u{11a8}\u{94d}",
        &["\u{11a8}\u{94d}"]), ("\u{11a8}\u{308}\u{94d}", &["\u{11a8}\u{308}\u{94d}"]),
        ...
        &["\u{ac00}\u{308}", "\u{ac01}"]), ("\u{ac00}\u{900}", &["\u{ac00}\u{900}"]),
        ("\u{ac00}\u{308}\u{900}", &["\u{ac00}\u{308}\u{900}"]), ("\u{ac00}\u{904}", &["\u{ac00}",
        "\u{904}"]), ("\u{ac00}\u{308}\u{904}", &["\u{ac00}\u{308}", "\u{904}"]),
        ...
        &["\u{ac00}\u{308}\u{300}"]), ("\u{ac00}\u{93c}", &["\u{ac00}\u{93c}"]),
        ("\u{ac00}\u{308}\u{93c}", &["\u{ac00}\u{308}\u{93c}"]), ("\u{ac00}\u{94d}",
        ...
        &["\u{ac01}\u{308}", "\u{ac01}"]), ("\u{ac01}\u{900}", &["\u{ac01}\u{900}"]),
        ("\u{ac01}\u{308}\u{900}", &["\u{ac01}\u{308}\u{900}"]), ("\u{ac01}\u{904}", &["\u{ac01}",
        "\u{904}"]), ("\u{ac01}\u{308}\u{904}", &["\u{ac01}\u{308}", "\u{904}"]),
        ("\u{ac01}\u{d4e}", &["\u{ac01}", "\u{d4e}"]), ("\u{ac01}\u{308}\u{d4e}",
        &["\u{ac01}\u{308}", "\u{d4e}"]), ("\u{ac01}\u{915}", &["\u{ac01}", "\u{915}"]),
        ("\u{ac01}\u{308}\u{915}", &["\u{ac01}\u{308}", "\u{915}"]), ("\u{ac01}\u{231a}",
        &["\u{ac01}", "\u{231a}"]), ("\u{ac01}\u{308}\u{231a}", &["\u{ac01}\u{308}", "\u{231a}"]),
        ("\u{ac01}\u{300}", &["\u{ac01}\u{300}"]), ("\u{ac01}\u{308}\u{300}",
        &["\u{ac01}\u{308}\u{300}"]), ("\u{ac01}\u{93c}", &["\u{ac01}\u{93c}"]),
        ("\u{ac01}\u{308}\u{93c}", &["\u{ac01}\u{308}\u{93c}"]), ("\u{ac01}\u{94d}",
        &["\u{ac01}\u{94d}"]), ("\u{ac01}\u{308}\u{94d}", &["\u{ac01}\u{308}\u{94d}"]),
        ("\u{ac01}\u{200d}", &["\u{ac01}\u{200d}"]), ("\u{ac01}\u{308}\u{200d}",
        &["\u{ac01}\u{308}\u{200d}"]), ("\u{ac01}\u{378}", &["\u{ac01}", "\u{378}"]),
        ("\u{ac01}\u{308}\u{378}", &["\u{ac01}\u{308}", "\u{378}"]), ("\u{900}\u{20}", &["\u{900}",
        "\u{20}"]), ("\u{900}\u{308}\u{20}", &["\u{900}\u{308}", "\u{20}"]), ("\u{900}\u{d}",
        &["\u{900}", "\u{d}"]), ("\u{900}\u{308}\u{d}", &["\u{900}\u{308}", "\u{d}"]),
        ("\u{900}\u{a}", &["\u{900}", "\u{a}"]), ("\u{900}\u{308}\u{a}", &["\u{900}\u{308}",
        "\u{a}"]), ("\u{900}\u{1}", &["\u{900}", "\u{1}"]), ("\u{900}\u{308}\u{1}",
        &["\u{900}\u{308}", "\u{1}"]), ("\u{900}\u{34f}", &["\u{900}\u{34f}"]),
        ("\u{900}\u{308}\u{34f}", &["\u{900}\u{308}\u{34f}"]), ("\u{900}\u{1f1e6}", &["\u{900}",
        "\u{1f1e6}"]), ("\u{900}\u{308}\u{1f1e6}", &["\u{900}\u{308}", "\u{1f1e6}"]),
        ("\u{900}\u{600}", &["\u{900}", "\u{600}"]), ("\u{900}\u{308}\u{600}", &["\u{900}\u{308}",
        "\u{600}"]), ("\u{900}\u{1100}", &["\u{900}", "\u{1100}"]), ("\u{900}\u{308}\u{1100}",
        &["\u{900}\u{308}", "\u{1100}"]), ("\u{900}\u{1160}", &["\u{900}", "\u{1160}"]),
        ("\u{900}\u{308}\u{1160}", &["\u{900}\u{308}", "\u{1160}"]), ("\u{900}\u{11a8}",
        &["\u{900}", "\u{11a8}"]), ("\u{900}\u{308}\u{11a8}", &["\u{900}\u{308}", "\u{11a8}"]),
        ("\u{900}\u{ac00}", &["\u{900}", "\u{ac00}"]), ("\u{900}\u{308}\u{ac00}",
        &["\u{900}\u{308}", "\u{ac00}"]), ("\u{900}\u{ac01}", &["\u{900}", "\u{ac01}"]),
        ("\u{900}\u{308}\u{ac01}", &["\u{900}\u{308}", "\u{ac01}"]), ("\u{900}\u{900}",
        &["\u{900}\u{900}"]), ("\u{900}\u{308}\u{900}", &["\u{900}\u{308}\u{900}"]),
        ("\u{900}\u{904}", &["\u{900}", "\u{904}"]), ("\u{900}\u{308}\u{904}", &["\u{900}\u{308}",
        "\u{904}"]), ("\u{900}\u{d4e}", &["\u{900}", "\u{d4e}"]), ("\u{900}\u{308}\u{d4e}",
        &["\u{900}\u{308}", "\u{d4e}"]), ("\u{900}\u{915}", &["\u{900}", "\u{915}"]),
        ("\u{900}\u{308}\u{915}", &["\u{900}\u{308}", "\u{915}"]), ("\u{900}\u{231a}", &["\u{900}",
        "\u{231a}"]), ("\u{900}\u{308}\u{231a}", &["\u{900}\u{308}", "\u{231a}"]),
        ("\u{900}\u{300}", &["\u{900}\u{300}"]), ("\u{900}\u{308}\u{300}",
        &["\u{900}\u{308}\u{300}"]), ("\u{900}\u{93c}", &["\u{900}\u{93c}"]),
        ("\u{900}\u{308}\u{93c}", &["\u{900}\u{308}\u{93c}"]), ("\u{900}\u{94d}",
        &["\u{900}\u{94d}"]), ("\u{900}\u{308}\u{94d}", &["\u{900}\u{308}\u{94d}"]),
        ("\u{900}\u{200d}", &["\u{900}\u{200d}"]), ("\u{900}\u{308}\u{200d}",
        &["\u{900}\u{308}\u{200d}"]), ("\u{900}\u{378}", &["\u{900}", "\u{378}"]),
        ("\u{900}\u{308}\u{378}", &["\u{900}\u{308}", "\u{378}"]), ("\u{903}\u{20}", &["\u{903}",
        "\u{20}"]), ("\u{903}\u{308}\u{20}", &["\u{903}\u{308}", "\u{20}"]), ("\u{903}\u{d}",
        &["\u{903}", "\u{d}"]), ("\u{903}\u{308}\u{d}", &["\u{903}\u{308}", "\u{d}"]),
        ("\u{903}\u{a}", &["\u{903}", "\u{a}"]), ("\u{903}\u{308}\u{a}", &["\u{903}\u{308}",
        "\u{a}"]), ("\u{903}\u{1}", &["\u{903}", "\u{1}"]), ("\u{903}\u{308}\u{1}",
        &["\u{903}\u{308}", "\u{1}"]), ("\u{903}\u{34f}", &["\u{903}\u{34f}"]),
        ("\u{903}\u{308}\u{34f}", &["\u{903}\u{308}\u{34f}"]), ("\u{903}\u{1f1e6}", &["\u{903}",
        "\u{1f1e6}"]), ("\u{903}\u{308}\u{1f1e6}", &["\u{903}\u{308}", "\u{1f1e6}"]),
        ("\u{903}\u{600}", &["\u{903}", "\u{600}"]), ("\u{903}\u{308}\u{600}", &["\u{903}\u{308}",
        "\u{600}"]), ("\u{903}\u{1100}", &["\u{903}", "\u{1100}"]), ("\u{903}\u{308}\u{1100}",
        ...
        ("\u{903}\u{308}\u{ac01}", &["\u{903}\u{308}", "\u{ac01}"]), ("\u{903}\u{900}",
        &["\u{903}\u{900}"]), ("\u{903}\u{308}\u{900}", &["\u{903}\u{308}\u{900}"]),
        ("\u{903}\u{904}", &["\u{903}", "\u{904}"]), ("\u{903}\u{308}\u{904}", &["\u{903}\u{308}",
        "\u{904}"]), ("\u{903}\u{d4e}", &["\u{903}", "\u{d4e}"]), ("\u{903}\u{308}\u{d4e}",
        &["\u{903}\u{308}", "\u{d4e}"]), ("\u{903}\u{915}", &["\u{903}", "\u{915}"]),
        ("\u{903}\u{308}\u{915}", &["\u{903}\u{308}", "\u{915}"]), ("\u{903}\u{231a}", &["\u{903}",
        "\u{231a}"]), ("\u{903}\u{308}\u{231a}", &["\u{903}\u{308}", "\u{231a}"]),
        ("\u{903}\u{300}", &["\u{903}\u{300}"]), ("\u{903}\u{308}\u{300}",
        &["\u{903}\u{308}\u{300}"]), ("\u{903}\u{93c}", &["\u{903}\u{93c}"]),
        ("\u{903}\u{308}\u{93c}", &["\u{903}\u{308}\u{93c}"]), ("\u{903}\u{94d}",
        &["\u{903}\u{94d}"]), ("\u{903}\u{308}\u{94d}", &["\u{903}\u{308}\u{94d}"]),
        ("\u{903}\u{200d}", &["\u{903}\u{200d}"]), ("\u{903}\u{308}\u{200d}",
        &["\u{903}\u{308}\u{200d}"]), ("\u{903}\u{378}", &["\u{903}", "\u{378}"]),
        ("\u{903}\u{308}\u{378}", &["\u{903}\u{308}", "\u{378}"]), ("\u{904}\u{20}", &["\u{904}",
        "\u{20}"]), ("\u{904}\u{308}\u{20}", &["\u{904}\u{308}", "\u{20}"]), ("\u{904}\u{d}",
        &["\u{904}", "\u{d}"]), ("\u{904}\u{308}\u{d}", &["\u{904}\u{308}", "\u{d}"]),
        ("\u{904}\u{a}", &["\u{904}", "\u{a}"]), ("\u{904}\u{308}\u{a}", &["\u{904}\u{308}",
        "\u{a}"]), ("\u{904}\u{1}", &["\u{904}", "\u{1}"]), ("\u{904}\u{308}\u{1}",
        &["\u{904}\u{308}", "\u{1}"]), ("\u{904}\u{34f}", &["\u{904}\u{34f}"]),
        ("\u{904}\u{308}\u{34f}", &["\u{904}\u{308}\u{34f}"]), ("\u{904}\u{1f1e6}", &["\u{904}",
        "\u{1f1e6}"]), ("\u{904}\u{308}\u{1f1e6}", &["\u{904}\u{308}", "\u{1f1e6}"]),
        ("\u{904}\u{600}", &["\u{904}", "\u{600}"]), ("\u{904}\u{308}\u{600}", &["\u{904}\u{308}",
        "\u{600}"]), ("\u{904}\u{1100}", &["\u{904}", "\u{1100}"]), ("\u{904}\u{308}\u{1100}",
        &["\u{904}\u{308}", "\u{1100}"]), ("\u{904}\u{1160}", &["\u{904}", "\u{1160}"]),
        ("\u{904}\u{308}\u{1160}", &["\u{904}\u{308}", "\u{1160}"]), ("\u{904}\u{11a8}",
        &["\u{904}", "\u{11a8}"]), ("\u{904}\u{308}\u{11a8}", &["\u{904}\u{308}", "\u{11a8}"]),
        ("\u{904}\u{ac00}", &["\u{904}", "\u{ac00}"]), ("\u{904}\u{308}\u{ac00}",
        &["\u{904}\u{308}", "\u{ac00}"]), ("\u{904}\u{ac01}", &["\u{904}", "\u{ac01}"]),
        ("\u{904}\u{308}\u{ac01}", &["\u{904}\u{308}", "\u{ac01}"]), ("\u{904}\u{900}",
        &["\u{904}\u{900}"]), ("\u{904}\u{308}\u{900}", &["\u{904}\u{308}\u{900}"]),
        ("\u{904}\u{904}", &["\u{904}", "\u{904}"]), ("\u{904}\u{308}\u{904}", &["\u{904}\u{308}",
        "\u{904}"]), ("\u{904}\u{d4e}", &["\u{904}", "\u{d4e}"]), ("\u{904}\u{308}\u{d4e}",
        &["\u{904}\u{308}", "\u{d4e}"]), ("\u{904}\u{915}", &["\u{904}", "\u{915}"]),
        ("\u{904}\u{308}\u{915}", &["\u{904}\u{308}", "\u{915}"]), ("\u{904}\u{231a}", &["\u{904}",
        "\u{231a}"]), ("\u{904}\u{308}\u{231a}", &["\u{904}\u{308}", "\u{231a}"]),
        ("\u{904}\u{300}", &["\u{904}\u{300}"]), ("\u{904}\u{308}\u{300}",
        &["\u{904}\u{308}\u{300}"]), ("\u{904}\u{93c}", &["\u{904}\u{93c}"]),
        ("\u{904}\u{308}\u{93c}", &["\u{904}\u{308}\u{93c}"]), ("\u{904}\u{94d}",
        &["\u{904}\u{94d}"]), ("\u{904}\u{308}\u{94d}", &["\u{904}\u{308}\u{94d}"]),
        ("\u{904}\u{200d}", &["\u{904}\u{200d}"]), ("\u{904}\u{308}\u{200d}",
        &["\u{904}\u{308}\u{200d}"]), ("\u{904}\u{378}", &["\u{904}", "\u{378}"]),
        ("\u{904}\u{308}\u{378}", &["\u{904}\u{308}", "\u{378}"]), ("\u{d4e}\u{308}\u{20}",
        &["\u{d4e}\u{308}", "\u{20}"]), ("\u{d4e}\u{d}", &["\u{d4e}", "\u{d}"]),
        ("\u{d4e}\u{308}\u{d}", &["\u{d4e}\u{308}", "\u{d}"]), ("\u{d4e}\u{a}", &["\u{d4e}",
        "\u{a}"]), ("\u{d4e}\u{308}\u{a}", &["\u{d4e}\u{308}", "\u{a}"]), ("\u{d4e}\u{1}",
        &["\u{d4e}", "\u{1}"]), ("\u{d4e}\u{308}\u{1}", &["\u{d4e}\u{308}", "\u{1}"]),
        ("\u{d4e}\u{34f}", &["\u{d4e}\u{34f}"]), ("\u{d4e}\u{308}\u{34f}",
        &["\u{d4e}\u{308}\u{34f}"]), ("\u{d4e}\u{308}\u{1f1e6}", &["\u{d4e}\u{308}", "\u{1f1e6}"]),
        ...
        &["\u{d4e}\u{308}", "\u{ac01}"]), ("\u{d4e}\u{900}", &["\u{d4e}\u{900}"]),
        ("\u{d4e}\u{308}\u{900}", &["\u{d4e}\u{308}\u{900}"]), ("\u{d4e}\u{308}\u{904}",
        &["\u{d4e}\u{308}", "\u{904}"]), ("\u{d4e}\u{308}\u{d4e}", &["\u{d4e}\u{308}", "\u{d4e}"]),
        ("\u{d4e}\u{308}\u{915}", &["\u{d4e}\u{308}", "\u{915}"]), ("\u{d4e}\u{308}\u{231a}",
        &["\u{d4e}\u{308}", "\u{231a}"]), ("\u{d4e}\u{300}", &["\u{d4e}\u{300}"]),
        ("\u{d4e}\u{308}\u{300}", &["\u{d4e}\u{308}\u{300}"]), ("\u{d4e}\u{93c}",
        &["\u{d4e}\u{93c}"]), ("\u{d4e}\u{308}\u{93c}", &["\u{d4e}\u{308}\u{93c}"]),
        ("\u{d4e}\u{94d}", &["\u{d4e}\u{94d}"]), ("\u{d4e}\u{308}\u{94d}",
        &["\u{d4e}\u{308}\u{94d}"]), ("\u{d4e}\u{200d}", &["\u{d4e}\u{200d}"]),
        ("\u{d4e}\u{308}\u{200d}", &["\u{d4e}\u{308}\u{200d}"]), ("\u{d4e}\u{308}\u{378}",
        &["\u{d4e}\u{308}", "\u{378}"]), ("\u{915}\u{20}", &["\u{915}", "\u{20}"]),
        ("\u{915}\u{308}\u{20}", &["\u{915}\u{308}", "\u{20}"]), ("\u{915}\u{d}", &["\u{915}",
        "\u{d}"]), ("\u{915}\u{308}\u{d}", &["\u{915}\u{308}", "\u{d}"]), ("\u{915}\u{a}",
        &["\u{915}", "\u{a}"]), ("\u{915}\u{308}\u{a}", &["\u{915}\u{308}", "\u{a}"]),
        ("\u{915}\u{1}", &["\u{915}", "\u{1}"]), ("\u{915}\u{308}\u{1}", &["\u{915}\u{308}",
        "\u{1}"]), ("\u{915}\u{34f}", &["\u{915}\u{34f}"]), ("\u{915}\u{308}\u{34f}",
        &["\u{915}\u{308}\u{34f}"]), ("\u{915}\u{1f1e6}", &["\u{915}", "\u{1f1e6}"]),
        ("\u{915}\u{308}\u{1f1e6}", &["\u{915}\u{308}", "\u{1f1e6}"]), ("\u{915}\u{600}",
        &["\u{915}", "\u{600}"]), ("\u{915}\u{308}\u{600}", &["\u{915}\u{308}", "\u{600}"]),
        ...
        ("\u{915}\u{308}\u{ac01}", &["\u{915}\u{308}", "\u{ac01}"]), ("\u{915}\u{900}",
        &["\u{915}\u{900}"]), ("\u{915}\u{308}\u{900}", &["\u{915}\u{308}\u{900}"]),
        ("\u{915}\u{904}", &["\u{915}", "\u{904}"]), ("\u{915}\u{308}\u{904}", &["\u{915}\u{308}",
        "\u{904}"]), ("\u{915}\u{d4e}", &["\u{915}", "\u{d4e}"]), ("\u{915}\u{308}\u{d4e}",
        &["\u{915}\u{308}", "\u{d4e}"]), ("\u{915}\u{915}", &["\u{915}", "\u{915}"]),
        ("\u{915}\u{308}\u{915}", &["\u{915}\u{308}", "\u{915}"]), ("\u{915}\u{231a}", &["\u{915}",
        "\u{231a}"]), ("\u{915}\u{308}\u{231a}", &["\u{915}\u{308}", "\u{231a}"]),
        ("\u{915}\u{300}", &["\u{915}\u{300}"]), ("\u{915}\u{308}\u{300}",
        &["\u{915}\u{308}\u{300}"]), ("\u{915}\u{93c}", &["\u{915}\u{93c}"]),
        ("\u{915}\u{308}\u{93c}", &["\u{915}\u{308}\u{93c}"]), ("\u{915}\u{94d}",
        &["\u{915}\u{94d}"]), ("\u{915}\u{308}\u{94d}", &["\u{915}\u{308}\u{94d}"]),
        ("\u{915}\u{200d}", &["\u{915}\u{200d}"]), ("\u{915}\u{308}\u{200d}",
        &["\u{915}\u{308}\u{200d}"]), ("\u{915}\u{378}", &["\u{915}", "\u{378}"]),
        ("\u{915}\u{308}\u{378}", &["\u{915}\u{308}", "\u{378}"]), ("\u{231a}\u{20}", &["\u{231a}",
        "\u{20}"]), ("\u{231a}\u{308}\u{20}", &["\u{231a}\u{308}", "\u{20}"]), ("\u{231a}\u{d}",
        &["\u{231a}", "\u{d}"]), ("\u{231a}\u{308}\u{d}", &["\u{231a}\u{308}", "\u{d}"]),
        ("\u{231a}\u{a}", &["\u{231a}", "\u{a}"]), ("\u{231a}\u{308}\u{a}", &["\u{231a}\u{308}",
        "\u{a}"]), ("\u{231a}\u{1}", &["\u{231a}", "\u{1}"]), ("\u{231a}\u{308}\u{1}",
        &["\u{231a}\u{308}", "\u{1}"]), ("\u{231a}\u{34f}", &["\u{231a}\u{34f}"]),
        ("\u{231a}\u{308}\u{34f}", &["\u{231a}\u{308}\u{34f}"]), ("\u{231a}\u{1f1e6}", &["\u{231a}",
        "\u{1f1e6}"]), ("\u{231a}\u{308}\u{1f1e6}", &["\u{231a}\u{308}", "\u{1f1e6}"]),
        ("\u{231a}\u{600}", &["\u{231a}", "\u{600}"]), ("\u{231a}\u{308}\u{600}",
        &["\u{231a}\u{308}", "\u{600}"]), ("\u{231a}\u{1100}", &["\u{231a}", "\u{1100}"]),
        ("\u{231a}\u{308}\u{1100}", &["\u{231a}\u{308}", "\u{1100}"]), ("\u{231a}\u{1160}",
        &["\u{231a}", "\u{1160}"]), ("\u{231a}\u{308}\u{1160}", &["\u{231a}\u{308}", "\u{1160}"]),
        ("\u{231a}\u{11a8}", &["\u{231a}", "\u{11a8}"]), ("\u{231a}\u{308}\u{11a8}",
        &["\u{231a}\u{308}", "\u{11a8}"]), ("\u{231a}\u{ac00}", &["\u{231a}", "\u{ac00}"]),
        ("\u{231a}\u{308}\u{ac00}", &["\u{231a}\u{308}", "\u{ac00}"]), ("\u{231a}\u{ac01}",
        &["\u{231a}", "\u{ac01}"]), ("\u{231a}\u{308}\u{ac01}", &["\u{231a}\u{308}", "\u{ac01}"]),
        ("\u{231a}\u{900}", &["\u{231a}\u{900}"]), ("\u{231a}\u{308}\u{900}",
        &["\u{231a}\u{308}\u{900}"]), ("\u{231a}\u{904}", &["\u{231a}", "\u{904}"]),
        ...
        ("\u{231a}\u{93c}", &["\u{231a}\u{93c}"]), ("\u{231a}\u{308}\u{93c}",
        &["\u{231a}\u{308}\u{93c}"]), ("\u{231a}\u{94d}", &["\u{231a}\u{94d}"]),
        ...
        "\u{1}"]), ("\u{300}\u{34f}", &["\u{300}\u{34f}"]), ("\u{300}\u{308}\u{34f}",
        &["\u{300}\u{308}\u{34f}"]), ("\u{300}\u{1f1e6}", &["\u{300}", "\u{1f1e6}"]),
        ...
        ("\u{300}\u{308}\u{ac01}", &["\u{300}\u{308}", "\u{ac01}"]), ("\u{300}\u{900}",
        &["\u{300}\u{900}"]), ("\u{300}\u{308}\u{900}", &["\u{300}\u{308}\u{900}"]),
        ("\u{300}\u{904}", &["\u{300}", "\u{904}"]), ("\u{300}\u{308}\u{904}", &["\u{300}\u{308}",
        "\u{904}"]), ("\u{300}\u{d4e}", &["\u{300}", "\u{d4e}"]), ("\u{300}\u{308}\u{d4e}",
        &["\u{300}\u{308}", "\u{d4e}"]), ("\u{300}\u{915}", &["\u{300}", "\u{915}"]),
        ("\u{300}\u{308}\u{915}", &["\u{300}\u{308}", "\u{915}"]), ("\u{300}\u{231a}", &["\u{300}",
        "\u{231a}"]), ("\u{300}\u{308}\u{231a}", &["\u{300}\u{308}", "\u{231a}"]),
        ("\u{300}\u{300}", &["\u{300}\u{300}"]), ("\u{300}\u{308}\u{300}",
        &["\u{300}\u{308}\u{300}"]), ("\u{300}\u{93c}", &["\u{300}\u{93c}"]),
        ("\u{300}\u{308}\u{93c}", &["\u{300}\u{308}\u{93c}"]), ("\u{300}\u{94d}",
        &["\u{300}\u{94d}"]), ("\u{300}\u{308}\u{94d}", &["\u{300}\u{308}\u{94d}"]),
        ("\u{300}\u{200d}", &["\u{300}\u{200d}"]), ("\u{300}\u{308}\u{200d}",
        &["\u{300}\u{308}\u{200d}"]), ("\u{300}\u{378}", &["\u{300}", "\u{378}"]),
        ("\u{300}\u{308}\u{378}", &["\u{300}\u{308}", "\u{378}"]), ("\u{93c}\u{20}", &["\u{93c}",
        "\u{20}"]), ("\u{93c}\u{308}\u{20}", &["\u{93c}\u{308}", "\u{20}"]), ("\u{93c}\u{d}",
        &["\u{93c}", "\u{d}"]), ("\u{93c}\u{308}\u{d}", &["\u{93c}\u{308}", "\u{d}"]),
        ("\u{93c}\u{a}", &["\u{93c}", "\u{a}"]), ("\u{93c}\u{308}\u{a}", &["\u{93c}\u{308}",
        "\u{a}"]), ("\u{93c}\u{1}", &["\u{93c}", "\u{1}"]), ("\u{93c}\u{308}\u{1}",
        &["\u{93c}\u{308}", "\u{1}"]), ("\u{93c}\u{34f}", &["\u{93c}\u{34f}"]),
        ("\u{93c}\u{308}\u{34f}", &["\u{93c}\u{308}\u{34f}"]), ("\u{93c}\u{1f1e6}", &["\u{93c}",
        "\u{1f1e6}"]), ("\u{93c}\u{308}\u{1f1e6}", &["\u{93c}\u{308}", "\u{1f1e6}"]),
        ("\u{93c}\u{600}", &["\u{93c}", "\u{600}"]), ("\u{93c}\u{308}\u{600}", &["\u{93c}\u{308}",
        "\u{600}"]), ("\u{93c}\u{1100}", &["\u{93c}", "\u{1100}"]), ("\u{93c}\u{308}\u{1100}",
        &["\u{93c}\u{308}", "\u{1100}"]), ("\u{93c}\u{1160}", &["\u{93c}", "\u{1160}"]),
        ("\u{93c}\u{308}\u{1160}", &["\u{93c}\u{308}", "\u{1160}"]), ("\u{93c}\u{11a8}",
        &["\u{93c}", "\u{11a8}"]), ("\u{93c}\u{308}\u{11a8}", &["\u{93c}\u{308}", "\u{11a8}"]),
        ("\u{93c}\u{ac00}", &["\u{93c}", "\u{ac00}"]), ("\u{93c}\u{308}\u{ac00}",
        &["\u{93c}\u{308}", "\u{ac00}"]), ("\u{93c}\u{ac01}", &["\u{93c}", "\u{ac01}"]),
        ("\u{93c}\u{308}\u{ac01}", &["\u{93c}\u{308}", "\u{ac01}"]), ("\u{93c}\u{900}",
        &["\u{93c}\u{900}"]), ("\u{93c}\u{308}\u{900}", &["\u{93c}\u{308}\u{900}"]),
        ("\u{93c}\u{904}", &["\u{93c}", "\u{904}"]), ("\u{93c}\u{308}\u{904}", &["\u{93c}\u{308}",
        "\u{904}"]), ("\u{93c}\u{d4e}", &["\u{93c}", "\u{d4e}"]), ("\u{93c}\u{308}\u{d4e}",
        &["\u{93c}\u{308}", "\u{d4e}"]), ("\u{93c}\u{915}", &["\u{93c}", "\u{915}"]),
        ("\u{93c}\u{308}\u{915}", &["\u{93c}\u{308}", "\u{915}"]), ("\u{93c}\u{231a}", &["\u{93c}",
        "\u{231a}"]), ("\u{93c}\u{308}\u{231a}", &["\u{93c}\u{308}", "\u{231a}"]),
        ("\u{93c}\u{300}", &["\u{93c}\u{300}"]), ("\u{93c}\u{308}\u{300}",
        &["\u{93c}\u{308}\u{300}"]), ("\u{93c}\u{93c}", &["\u{93c}\u{93c}"]),
        ("\u{93c}\u{308}\u{93c}", &["\u{93c}\u{308}\u{93c}"]), ("\u{93c}\u{94d}",
        &["\u{93c}\u{94d}"]), ("\u{93c}\u{308}\u{94d}", &["\u{93c}\u{308}\u{94d}"]),
        ("\u{93c}\u{200d}", &["\u{93c}\u{200d}"]), ("\u{93c}\u{308}\u{200d}",
        &["\u{93c}\u{308}\u{200d}"]), ("\u{93c}\u{378}", &["\u{93c}", "\u{378}"]),
        ("\u{93c}\u{308}\u{378}", &["\u{93c}\u{308}", "\u{378}"]), ("\u{94d}\u{20}", &["\u{94d}",
        "\u{20}"]), ("\u{94d}\u{308}\u{20}", &["\u{94d}\u{308}", "\u{20}"]), ("\u{94d}\u{d}",
        &["\u{94d}", "\u{d}"]), ("\u{94d}\u{308}\u{d}", &["\u{94d}\u{308}", "\u{d}"]),
        ("\u{94d}\u{a}", &["\u{94d}", "\u{a}"]), ("\u{94d}\u{308}\u{a}", &["\u{94d}\u{308}",
        "\u{a}"]), ("\u{94d}\u{1}", &["\u{94d}", "\u{1}"]), ("\u{94d}\u{308}\u{1}",
        &["\u{94d}\u{308}", "\u{1}"]), ("\u{94d}\u{34f}", &["\u{94d}\u{34f}"]),
        ("\u{94d}\u{308}\u{34f}", &["\u{94d}\u{308}\u{34f}"]), ("\u{94d}\u{1f1e6}", &["\u{94d}",
        "\u{1f1e6}"]), ("\u{94d}\u{308}\u{1f1e6}", &["\u{94d}\u{308}", "\u{1f1e6}"]),
        ("\u{94d}\u{600}", &["\u{94d}", "\u{600}"]), ("\u{94d}\u{308}\u{600}", &["\u{94d}\u{308}",
        "\u{600}"]), ("\u{94d}\u{1100}", &["\u{94d}", "\u{1100}"]), ("\u{94d}\u{308}\u{1100}",
        ...
        ("\u{94d}\u{308}\u{ac01}", &["\u{94d}\u{308}", "\u{ac01}"]), ("\u{94d}\u{900}",
        &["\u{94d}\u{900}"]), ("\u{94d}\u{308}\u{900}", &["\u{94d}\u{308}\u{900}"]),
        ("\u{94d}\u{904}", &["\u{94d}", "\u{904}"]), ("\u{94d}\u{308}\u{904}", &["\u{94d}\u{308}",
        "\u{904}"]), ("\u{94d}\u{d4e}", &["\u{94d}", "\u{d4e}"]), ("\u{94d}\u{308}\u{d4e}",
        &["\u{94d}\u{308}", "\u{d4e}"]), ("\u{94d}\u{915}", &["\u{94d}", "\u{915}"]),
        ("\u{94d}\u{308}\u{915}", &["\u{94d}\u{308}", "\u{915}"]), ("\u{94d}\u{231a}", &["\u{94d}",
        "\u{231a}"]), ("\u{94d}\u{308}\u{231a}", &["\u{94d}\u{308}", "\u{231a}"]),
        ("\u{94d}\u{300}", &["\u{94d}\u{300}"]), ("\u{94d}\u{308}\u{300}",
        &["\u{94d}\u{308}\u{300}"]), ("\u{94d}\u{93c}", &["\u{94d}\u{93c}"]),
        ("\u{94d}\u{308}\u{93c}", &["\u{94d}\u{308}\u{93c}"]), ("\u{94d}\u{94d}",
        &["\u{94d}\u{94d}"]), ("\u{94d}\u{308}\u{94d}", &["\u{94d}\u{308}\u{94d}"]),
        ("\u{94d}\u{200d}", &["\u{94d}\u{200d}"]), ("\u{94d}\u{308}\u{200d}",
        &["\u{94d}\u{308}\u{200d}"]), ("\u{94d}\u{378}", &["\u{94d}", "\u{378}"]),
        ("\u{94d}\u{308}\u{378}", &["\u{94d}\u{308}", "\u{378}"]), ("\u{200d}\u{20}", &["\u{200d}",
        "\u{20}"]), ("\u{200d}\u{308}\u{20}", &["\u{200d}\u{308}", "\u{20}"]), ("\u{200d}\u{d}",
        &["\u{200d}", "\u{d}"]), ("\u{200d}\u{308}\u{d}", &["\u{200d}\u{308}", "\u{d}"]),
        ("\u{200d}\u{a}", &["\u{200d}", "\u{a}"]), ("\u{200d}\u{308}\u{a}", &["\u{200d}\u{308}",
        "\u{a}"]), ("\u{200d}\u{1}", &["\u{200d}", "\u{1}"]), ("\u{200d}\u{308}\u{1}",
        &["\u{200d}\u{308}", "\u{1}"]), ("\u{200d}\u{34f}", &["\u{200d}\u{34f}"]),
        ("\u{200d}\u{308}\u{34f}", &["\u{200d}\u{308}\u{34f}"]), ("\u{200d}\u{1f1e6}", &["\u{200d}",
        "\u{1f1e6}"]), ("\u{200d}\u{308}\u{1f1e6}", &["\u{200d}\u{308}", "\u{1f1e6}"]),
        ...
        &["\u{200d}\u{308}\u{900}"]), ("\u{200d}\u{904}", &["\u{200d}", "\u{904}"]),
        ...
        ("\u{200d}\u{93c}", &["\u{200d}\u{93c}"]), ("\u{200d}\u{308}\u{93c}",
        &["\u{200d}\u{308}\u{93c}"]), ("\u{200d}\u{94d}", &["\u{200d}\u{94d}"]),
        ...
        "\u{1}"]), ("\u{378}\u{34f}", &["\u{378}\u{34f}"]), ("\u{378}\u{308}\u{34f}",
        &["\u{378}\u{308}\u{34f}"]), ("\u{378}\u{1f1e6}", &["\u{378}", "\u{1f1e6}"]),
        ...
        ("\u{378}\u{308}\u{ac01}", &["\u{378}\u{308}", "\u{ac01}"]), ("\u{378}\u{900}",
        &["\u{378}\u{900}"]), ("\u{378}\u{308}\u{900}", &["\u{378}\u{308}\u{900}"]),
        ("\u{378}\u{904}", &["\u{378}", "\u{904}"]), ("\u{378}\u{308}\u{904}", &["\u{378}\u{308}",
        "\u{904}"]), ("\u{378}\u{d4e}", &["\u{378}", "\u{d4e}"]), ("\u{378}\u{308}\u{d4e}",
        &["\u{378}\u{308}", "\u{d4e}"]), ("\u{378}\u{915}", &["\u{378}", "\u{915}"]),
        ("\u{378}\u{308}\u{915}", &["\u{378}\u{308}", "\u{915}"]), ("\u{378}\u{231a}", &["\u{378}",
        "\u{231a}"]), ("\u{378}\u{308}\u{231a}", &["\u{378}\u{308}", "\u{231a}"]),
        ("\u{378}\u{300}", &["\u{378}\u{300}"]), ("\u{378}\u{308}\u{300}",
        &["\u{378}\u{308}\u{300}"]), ("\u{378}\u{93c}", &["\u{378}\u{93c}"]),
        ("\u{378}\u{308}\u{93c}", &["\u{378}\u{308}\u{93c}"]), ("\u{378}\u{94d}",
        &["\u{378}\u{94d}"]), ("\u{378}\u{308}\u{94d}", &["\u{378}\u{308}\u{94d}"]),
        ("\u{378}\u{200d}", &["\u{378}\u{200d}"]), ("\u{378}\u{308}\u{200d}",
        &["\u{378}\u{308}\u{200d}"]), ("\u{378}\u{378}", &["\u{378}", "\u{378}"]),
        ...
        "\u{924}"]), ("\u{915}\u{94d}\u{924}", &["\u{915}\u{94d}\u{924}"]),
        ...
        ("\u{915}\u{94d}\u{61}", &["\u{915}\u{94d}", "\u{61}"]), ("\u{61}\u{94d}\u{924}",
        &["\u{61}\u{94d}", "\u{924}"]), ("\u{3f}\u{94d}\u{924}", &["\u{3f}\u{94d}", "\u{924}"]),
        ("\u{915}\u{94d}\u{94d}\u{924}", &["\u{915}\u{94d}\u{94d}\u{924}"])
    ];
    ...
    pub const TEST_DIFF: &[(&str, &[&str], &[&str])] = &[
        ...
        &["\u{1}", "\u{308}\u{903}"], &["\u{1}", "\u{308}", "\u{903}"]), ("\u{34f}\u{a03}",
        &["\u{34f}\u{a03}"], &["\u{34f}", "\u{a03}"]), ("\u{34f}\u{308}\u{a03}",
        &["\u{34f}\u{308}\u{a03}"], &["\u{34f}\u{308}", "\u{a03}"]), ("\u{34f}\u{903}",
        &["\u{34f}\u{903}"], &["\u{34f}", "\u{903}"]), ("\u{34f}\u{308}\u{903}",
        &["\u{34f}\u{308}\u{903}"], &["\u{34f}\u{308}", "\u{903}"]), ("\u{1f1e6}\u{a03}",
        ...
        ("\u{900}\u{a03}", &["\u{900}\u{a03}"], &["\u{900}", "\u{a03}"]), ("\u{900}\u{308}\u{a03}",
        &["\u{900}\u{308}\u{a03}"], &["\u{900}\u{308}", "\u{a03}"]), ("\u{900}\u{903}",
        &["\u{900}\u{903}"], &["\u{900}", "\u{903}"]), ("\u{900}\u{308}\u{903}",
        &["\u{900}\u{308}\u{903}"], &["\u{900}\u{308}", "\u{903}"]), ("\u{903}\u{a03}",
        &["\u{903}\u{a03}"], &["\u{903}", "\u{a03}"]), ("\u{903}\u{308}\u{a03}",
        ...
        &["\u{300}\u{308}\u{903}"], &["\u{300}\u{308}", "\u{903}"]), ("\u{93c}\u{a03}",
        &["\u{93c}\u{a03}"], &["\u{93c}", "\u{a03}"]), ("\u{93c}\u{308}\u{a03}",
        &["\u{93c}\u{308}\u{a03}"], &["\u{93c}\u{308}", "\u{a03}"]), ("\u{93c}\u{903}",
        &["\u{93c}\u{903}"], &["\u{93c}", "\u{903}"]), ("\u{93c}\u{308}\u{903}",
        &["\u{93c}\u{308}\u{903}"], &["\u{93c}\u{308}", "\u{903}"]), ("\u{94d}\u{a03}",
    ...
    // official Unicode test data
    // http://www.unicode.org/Public/15.1.0/ucd/auxiliary/WordBreakTest.txt
    ...
    // official Unicode test data
    // http://www.unicode.org/Public/15.1.0/ucd/auxiliary/SentenceBreakTest.txt
